...
class ProVersionActivity$11 implements ProductDetailsResponseListener
{
    final /* synthetic */ ProVersionActivity this$0;
    
    ProVersionActivity$11(final ProVersionActivity this$0) {
        this.this$0 = this$0;
    }
    ...
    public void onProductDetailsResponse(final BillingResult billingResult, final List list) {
        if (billingResult.getResponseCode() == 0 && list != null) {
            for (final ProductDetails productDetails : list) {
                ...
                this.this$0.runOnUiThread((Runnable)new ProVersionActivity$11$$ExternalSyntheticLambda0(this, productDetails));
            }
        }
    }
}
