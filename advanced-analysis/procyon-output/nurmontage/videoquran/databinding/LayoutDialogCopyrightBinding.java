...
public final class LayoutDialogCopyrightBinding implements ViewBinding
{
    ...
    private LayoutDialogCopyrightBinding(final LinearLayout rootView, final ImageButton dialogNo, final TextCustumFontBold dialogTitle, final TextCustumFont tvMsj) {
    ...
    public static LayoutDialogCopyrightBinding bind(final View view) {
    ...
    public static LayoutDialogCopyrightBinding inflate(final LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }
    
    public static LayoutDialogCopyrightBinding inflate(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final boolean b) {
        final View inflate = layoutInflater.inflate(R$layout.layout_dialog_copyright, viewGroup, false);
        if (b) {
