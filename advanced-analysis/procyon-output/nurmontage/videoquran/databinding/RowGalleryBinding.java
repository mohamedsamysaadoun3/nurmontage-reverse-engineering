...
public final class RowGalleryBinding implements ViewBinding
{
    ...
    private RowGalleryBinding(final FrameLayout rootView, final ImageButton btnDeleted, final SquareImageView img, final TextCustumFont tvTime) {
    ...
    public static RowGalleryBinding bind(final View view) {
    ...
    public static RowGalleryBinding inflate(final LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }
    
    public static RowGalleryBinding inflate(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final boolean b) {
        final View inflate = layoutInflater.inflate(R$layout.row_gallery, viewGroup, false);
        if (b) {
