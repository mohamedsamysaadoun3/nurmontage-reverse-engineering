...
class ProVersionActivityDone$7 implements ProductDetailsResponseListener
{
    final /* synthetic */ ProVersionActivityDone this$0;
    
    ProVersionActivityDone$7(final ProVersionActivityDone this$0) {
        this.this$0 = this$0;
    }
    ...
    public void onProductDetailsResponse(final BillingResult billingResult, final List list) {
        if (billingResult.getResponseCode() == 0 && list != null) {
            for (final ProductDetails productDetails : list) {
                ...
                this.this$0.runOnUiThread((Runnable)new ProVersionActivityDone$7$$ExternalSyntheticLambda0(this, productDetails));
            }
        }
    }
}
