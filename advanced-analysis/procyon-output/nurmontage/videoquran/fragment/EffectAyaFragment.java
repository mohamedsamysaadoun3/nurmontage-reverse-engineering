...
public class EffectAyaFragment extends Fragment
{
    ...
    public EffectAyaFragment(final Transition transition, final Resources resources, final EffectAyaFragment$ITransition iTransition, final EntityQuranTimeline entityQuranTimeline) {
        this.tab_selected = 0;
    ...
    public static EffectAyaFragment get(final Transition transition, final Resources resources, final EffectAyaFragment$ITransition effectAyaFragment$ITransition, final EntityQuranTimeline entityQuranTimeline) {
        final Class<EffectAyaFragment> clazz = EffectAyaFragment.class;
        monitorenter(clazz);
        final Class<EffectAyaFragment> clazz2 = EffectAyaFragment.class;
        try {
            synchronized (clazz2) {
                if (EffectAyaFragment.instance == null) {
                    EffectAyaFragment.instance = new EffectAyaFragment(transition, resources, effectAyaFragment$ITransition, entityQuranTimeline);
                }
                return EffectAyaFragment.instance;
            }
        }
        finally {
            monitorexit(clazz);
    ...
    private List getOutTransition() {
        final ArrayList<TransitionEntityAdabters$TransitionItem> list = new ArrayList<TransitionEntityAdabters$TransitionItem>();
        list.add(new TransitionEntityAdabters$TransitionItem(TransitionType.FADE_OUT.getValue(), R$drawable.ic_linear_gradient, 0));
        list.add(new TransitionEntityAdabters$TransitionItem(TransitionType.SLIDE_TO_RIGHT.getValue(), R$drawable.ic_btn_back, 180));
        list.add(new TransitionEntityAdabters$TransitionItem(TransitionType.SLIDE_TO_LEFT.getValue(), R$drawable.ic_btn_back, 0));
        return list;
    }
    ...
    public List getInTransition() {
        final ArrayList<TransitionEntityAdabters$TransitionItem> list = new ArrayList<TransitionEntityAdabters$TransitionItem>();
        list.add(new TransitionEntityAdabters$TransitionItem(TransitionType.FADE_IN.getValue(), R$drawable.ic_linear_gradient, 0));
        list.add(new TransitionEntityAdabters$TransitionItem(TransitionType.SLIDE_TO_RIGHT.getValue(), R$drawable.ic_btn_back, 180));
        list.add(new TransitionEntityAdabters$TransitionItem(TransitionType.SLIDE_TO_LEFT.getValue(), R$drawable.ic_btn_back, 0));
        return list;
    }
    ...
    public int getIndex(final List list, final String s) {
        for (int i = 0; i < list.size(); ++i) {
            if (s.equals(((TransitionEntityAdabters$TransitionItem)list.get(i)).getType())) {
                return i;
            }
        }
        return -1;
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        if (this.resources != null) {
            final EffectAyaFragment$ITransition iTransition = this.iTransition;
            if (iTransition != null) {
                ...
                tabLayout.addOnTabSelectedListener((TabLayout$OnTabSelectedListener)new EffectAyaFragment$1(this));
                ...
                this.seekBarDuration.setOnSeekBarChangeListener((SeekBar$OnSeekBarChangeListener)new EffectAyaFragment$2(this));
                ...
                this.btn_unEffect.setOnClickListener((View$OnClickListener)new EffectAyaFragment$3(this));
                ((View)root).findViewById(R$id.btn_close).setOnClickListener((View$OnClickListener)new EffectAyaFragment$4(this));
                ...
                this.btnApplyAll.setEnabled(false);
                this.btnApplyAll.setClickable(false);
                this.btnApplyAll.setOnClickListener((View$OnClickListener)new EffectAyaFragment$5(this));
                ((View)root).post((Runnable)new EffectAyaFragment$6(this));
            }
        }
        return (View)root;
    }
    ...
    public void onDestroyView() {
        ...
        EffectAyaFragment.instance = null;
        super.onDestroyView();
    }
