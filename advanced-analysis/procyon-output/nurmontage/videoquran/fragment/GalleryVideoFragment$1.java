...
class GalleryVideoFragment$1 implements Runnable
{
    final /* synthetic */ GalleryVideoFragment this$0;
    
    GalleryVideoFragment$1(final GalleryVideoFragment this$0) {
        this.this$0 = this$0;
    }
    ...
    public void run() {
        ...
        query.close();
        this.this$0.requireActivity().runOnUiThread((Runnable)new GalleryVideoFragment$1$1(this, list));
    }
}
