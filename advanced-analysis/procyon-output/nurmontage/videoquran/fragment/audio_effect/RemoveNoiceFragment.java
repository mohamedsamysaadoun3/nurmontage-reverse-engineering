...
public class RemoveNoiceFragment extends Fragment
{
    ...
    public RemoveNoiceFragment(final EditMediaFragment$IEditMediaCallback iEditMediaCallback, final EntityAudio entityAudio) {
    ...
    public static RemoveNoiceFragment getInstance(final EditMediaFragment$IEditMediaCallback editMediaFragment$IEditMediaCallback, final EntityAudio entityAudio) {
        if (RemoveNoiceFragment.instance == null) {
            RemoveNoiceFragment.instance = new RemoveNoiceFragment(editMediaFragment$IEditMediaCallback, entityAudio);
        }
        return RemoveNoiceFragment.instance;
    }
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        if (this.iEditMediaCallback != null) {
            if (this.entityAudio != null) {
                (this.btn_remove_noice = (SwitchCompat)((View)root).findViewById(R$id.btn_remove_noice)).setChecked(this.entityAudio.getEffectAudio().isRemoveNoice());
                this.btn_remove_noice.setOnCheckedChangeListener((CompoundButton$OnCheckedChangeListener)new RemoveNoiceFragment$1(this));
                ((View)root).findViewById(R$id.btn_appl_all).setOnClickListener((View$OnClickListener)new RemoveNoiceFragment$$ExternalSyntheticLambda0(this));
                ((View)root).findViewById(R$id.btn_done).setOnClickListener((View$OnClickListener)new RemoveNoiceFragment$$ExternalSyntheticLambda1(this));
                (this.btnPreview = (ImageButton)((View)root).findViewById(R$id.btn_play)).setOnClickListener((View$OnClickListener)new RemoveNoiceFragment$$ExternalSyntheticLambda2(this));
            }
        }
        return (View)root;
    }
    ...
    public void onDestroyView() {
        super.onDestroyView();
        RemoveNoiceFragment.instance = null;
        this.binding = null;
    }
