...
class EditMediaFragment$8 implements View$OnClickListener
{
    final /* synthetic */ EditMediaFragment this$0;
    final /* synthetic */ HorizontalScrollView val$scrollView;
    
    EditMediaFragment$8(final EditMediaFragment this$0, final HorizontalScrollView val$scrollView) {
        this.this$0 = this$0;
    ...
    public void onClick(final View view) {
        if (EditMediaFragment.-$$Nest$fgetiEditMediaCallback(this.this$0) != null) {
            ...
            EditMediaFragment.-$$Nest$fgetiEditMediaCallback(this.this$0).echoEffect();
        }
    }
}
