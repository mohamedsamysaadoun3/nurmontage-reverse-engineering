...
public class ColorBismilahFragment extends Fragment
{
    ...
    public ColorBismilahFragment() {
        this.iColor = new ColorBismilahFragment$2(this);
    }
    
    public ColorBismilahFragment(final EditBismilahEntityFragment$IBismilahEntityCallback iEditSName, final BismilahEntity entity_select, final Resources resources) {
        this.iColor = new ColorBismilahFragment$2(this);
    ...
    public static ColorBismilahFragment getInstance(final EditBismilahEntityFragment$IBismilahEntityCallback editBismilahEntityFragment$IBismilahEntityCallback, final BismilahEntity bismilahEntity, final Resources resources) {
        if (ColorBismilahFragment.instance == null) {
            ColorBismilahFragment.instance = new ColorBismilahFragment(editBismilahEntityFragment$IBismilahEntityCallback, bismilahEntity, resources);
        }
        return ColorBismilahFragment.instance;
    }
    ...
    private void setupPresetButtons(final View view) {
        ...
        for (int i = 0; i < n; ++i) {
            array[i].setOnClickListener((View$OnClickListener)new ColorBismilahFragment$$ExternalSyntheticLambda0(this, array, i, array2));
        }
        final BismilahEntity entity_select = this.entity_select;
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        if (this.iEditSName != null && this.entity_select != null) {
            if (this.resources != null) {
                ...
                ((View)root).findViewById(R$id.btn_done).setOnClickListener((View$OnClickListener)new ColorBismilahFragment$1(this));
            }
        }
        return (View)root;
    }
    ...
    public void onDestroyView() {
        this.binding = null;
        ColorBismilahFragment.instance = null;
        this.iColor = null;
        super.onDestroyView();
    }
