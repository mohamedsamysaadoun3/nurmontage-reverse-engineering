...
class EditMediaFragment$5 implements View$OnClickListener
{
    final /* synthetic */ EditMediaFragment this$0;
    final /* synthetic */ HorizontalScrollView val$scrollView;
    
    EditMediaFragment$5(final EditMediaFragment this$0, final HorizontalScrollView val$scrollView) {
        this.this$0 = this$0;
    ...
    public void onClick(final View view) {
        if (EditMediaFragment.-$$Nest$fgetiEditMediaCallback(this.this$0) != null) {
            ...
            EditMediaFragment.-$$Nest$fgetiEditMediaCallback(this.this$0).reverbEffect();
        }
    }
}
