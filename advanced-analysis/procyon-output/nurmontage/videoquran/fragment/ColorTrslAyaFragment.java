...
public class ColorTrslAyaFragment extends Fragment
{
    ...
    public ColorTrslAyaFragment() {
        this.iColor = new ColorTrslAyaFragment$2(this);
    }
    
    public ColorTrslAyaFragment(final EditTrslEntityFragment$IEditEntityCallback iEditEntityCallback, final TranslationQuranEntity entity_select, final Resources resources) {
        this.iColor = new ColorTrslAyaFragment$2(this);
    ...
    public static ColorTrslAyaFragment getInstance(final EditTrslEntityFragment$IEditEntityCallback editTrslEntityFragment$IEditEntityCallback, final TranslationQuranEntity translationQuranEntity, final Resources resources) {
        if (ColorTrslAyaFragment.instance == null) {
            ColorTrslAyaFragment.instance = new ColorTrslAyaFragment(editTrslEntityFragment$IEditEntityCallback, translationQuranEntity, resources);
        }
        return ColorTrslAyaFragment.instance;
    }
    ...
    private void setupPresetButtons(final View view) {
        ...
        for (int i = 0; i < n; ++i) {
            array[i].setOnClickListener((View$OnClickListener)new ColorTrslAyaFragment$$ExternalSyntheticLambda0(this, array, i, array2));
        }
        final TranslationQuranEntity entity_select = this.entity_select;
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        if (this.iEditEntityCallback != null && this.entity_select != null) {
            if (this.resources != null) {
                ...
                ((View)root).findViewById(R$id.tab_layout).setVisibility(8);
                this.setupPresetButtons((View)root);
                ((View)root).findViewById(R$id.btn_done).setOnClickListener((View$OnClickListener)new ColorTrslAyaFragment$1(this));
            }
        }
        return (View)root;
    }
    ...
    public void onDestroyView() {
        this.binding = null;
        ColorTrslAyaFragment.instance = null;
        this.iColor = null;
        super.onDestroyView();
    }
