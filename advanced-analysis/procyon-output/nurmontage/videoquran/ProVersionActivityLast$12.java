...
class ProVersionActivityLast$12 implements ProductDetailsResponseListener
{
    final /* synthetic */ ProVersionActivityLast this$0;
    
    ProVersionActivityLast$12(final ProVersionActivityLast this$0) {
        this.this$0 = this$0;
    }
    ...
    public void onProductDetailsResponse(final BillingResult billingResult, final List list) {
        if (billingResult.getResponseCode() == 0 && list != null) {
            for (final ProductDetails productDetails : list) {
                ...
                this.this$0.runOnUiThread((Runnable)new ProVersionActivityLast$12$$ExternalSyntheticLambda0(this, productDetails));
            }
        }
    }
}
