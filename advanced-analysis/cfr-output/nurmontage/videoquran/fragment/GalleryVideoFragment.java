...
extends Fragment {
    ...
    static /* bridge */ /* synthetic */ GalleryVideoAdabters cfr_renamed_202(GalleryVideoFragment galleryVideoFragment) {
        return galleryVideoFragment.adabters;
    }

    public GalleryVideoFragment() {
    }

    public GalleryVideoFragment(List list, File file, GalleryPickerVideo$IPicker galleryPickerVideo$IPicker) {
     ...
     */
    public static GalleryVideoFragment get(List object, File file, GalleryPickerVideo$IPicker galleryPickerVideo$IPicker) {
        Class<GalleryVideoFragment> clazz = GalleryVideoFragment.class;
        synchronized (clazz) {
            Class<GalleryVideoFragment> clazz2 = GalleryVideoFragment.class;
            synchronized (clazz2) {
                GalleryVideoFragment galleryVideoFragment = instance;
                if (galleryVideoFragment != null) return instance;
                instance = galleryVideoFragment = new GalleryVideoFragment((List)object, file, galleryPickerVideo$IPicker);
                return instance;
            }
        }
    }
    ...
    private void loadVideos(View object) {
        ...
        if (object != null) {
            ...
            object2 = new GalleryVideoFragment$1(this);
