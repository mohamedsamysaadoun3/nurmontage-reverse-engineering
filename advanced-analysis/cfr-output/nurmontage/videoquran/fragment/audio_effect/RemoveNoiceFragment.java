...
import hazem.nurmontage.videoquran.fragment.audio_effect.RemoveNoiceFragment$$ExternalSyntheticLambda0;
import hazem.nurmontage.videoquran.fragment.audio_effect.RemoveNoiceFragment$$ExternalSyntheticLambda1;
import hazem.nurmontage.videoquran.fragment.audio_effect.RemoveNoiceFragment$$ExternalSyntheticLambda2;
import hazem.nurmontage.videoquran.fragment.audio_effect.RemoveNoiceFragment$1;
import hazem.nurmontage.videoquran.model.EffectAudio;
import java.util.ArrayList;
import java.util.List;
import java.util.Locale;

public class RemoveNoiceFragment
extends Fragment {
    ...
    static /* bridge */ /* synthetic */ void cfr_renamed_210(RemoveNoiceFragment removeNoiceFragment, boolean bl) {
        removeNoiceFragment.apply(bl);
    }

    public RemoveNoiceFragment() {
    }

    public RemoveNoiceFragment(EditMediaFragment$IEditMediaCallback editMediaFragment$IEditMediaCallback, EntityAudio entityAudio) {
    ...
    private void apply(boolean bl) {
        ...
        ((EffectAudio)object).setRemoveNoice(n2 != 0);
        ...
        if ((object2 = this.iEditMediaCallback) != null) {
            if (bl) {
                Object object6 = EffectAudioType.NOICE;
    ...
    public static RemoveNoiceFragment getInstance(EditMediaFragment$IEditMediaCallback editMediaFragment$IEditMediaCallback, EntityAudio entityAudio) {
        RemoveNoiceFragment removeNoiceFragment = instance;
        if (removeNoiceFragment == null) {
            instance = removeNoiceFragment = new RemoveNoiceFragment(editMediaFragment$IEditMediaCallback, entityAudio);
        }
        return instance;
    }
    ...
    /* synthetic */ void cfr_renamed_242(View view) {
        this.apply(true);
    }

    /* synthetic */ void cfr_renamed_228(View view) {
        this.onDone();
    }

    /* synthetic */ void cfr_renamed_239(View view) {
        this.preview();
    }
