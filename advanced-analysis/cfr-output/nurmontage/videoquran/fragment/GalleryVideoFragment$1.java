...
import hazem.nurmontage.videoquran.fragment.GalleryVideoFragment$1$1;
import hazem.nurmontage.videoquran.model.VideoItem;
import java.util.ArrayList;

class GalleryVideoFragment$1
implements Runnable {
    final /* synthetic */ GalleryVideoFragment this$0;

    GalleryVideoFragment$1(GalleryVideoFragment galleryVideoFragment) {
        this.this$0 = galleryVideoFragment;
    }
    ...
    public void run() {
        ...
        while ((n = object.moveToNext()) != 0) {
            ...
            if ((object3 = ((GalleryVideoFragment)((Object)object3)).isContains((String)(object4 = ContentUris.withAppendedId((Uri)object4, (long)l).toString()))) == null) continue;
            ((VideoItem)object3).setSelect(bl);
            ((ArrayList)object2).add(object3);
        }
        object.close();
        fragmentActivity = this.this$0.requireActivity();
        object = new GalleryVideoFragment$1$1(this, (ArrayList)object2);
