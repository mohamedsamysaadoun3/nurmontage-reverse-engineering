...
import hazem.nurmontage.videoquran.EngineActivity$59$1$1;
import hazem.nurmontage.videoquran.EngineActivity$59$1$2;
import hazem.nurmontage.videoquran.entity_timeline.EntityAudio;

class EngineActivity$59$1
implements MediaPlayer.OnPreparedListener {
    final /* synthetic */ EngineActivity$59 this$1;

    EngineActivity$59$1(EngineActivity$59 engineActivity$59) {
        this.this$1 = engineActivity$59;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        if (object2 != null && (n2 = mediaPlayer.getDuration()) != (n = (object = this.this$1.val$entityAudio.getMediaPlayer()).getDuration())) {
            ...
            n = mediaPlayer.getDuration() * 1000;
            object2.setDuration(n);
            object2 = this.this$1.val$entityAudio;
            ...
            object = new EngineActivity$59$1$1(this);
            object2.runOnUiThread((Runnable)object);
        } else {
            object2 = this.this$1.this$0;
            object = new EngineActivity$59$1$2(this);
            object2.runOnUiThread((Runnable)object);
        }
