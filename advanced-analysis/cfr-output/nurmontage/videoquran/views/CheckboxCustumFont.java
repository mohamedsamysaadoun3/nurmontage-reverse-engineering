...
public class CheckboxCustumFont
extends AppCompatCheckBox {
    private Typeface typeface;

    public CheckboxCustumFont(Context context) {
        super(context);
        this.init(context);
    }

    public CheckboxCustumFont(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.init(context);
    }

    public CheckboxCustumFont(Context context, AttributeSet attributeSet, int n) {
