...
public final class ProVersionActivity$$ExternalSyntheticLambda2
implements PurchasesResponseListener {
    public final /* synthetic */ ProVersionActivity f$0;

    public /* synthetic */ ProVersionActivity$$ExternalSyntheticLambda2(ProVersionActivity proVersionActivity) {
        this.f$0 = proVersionActivity;
    }

    public final void onQueryPurchasesResponse(BillingResult billingResult, List list) {
        this.f$0.cfr_renamed_111(billingResult, list);
    }
}
