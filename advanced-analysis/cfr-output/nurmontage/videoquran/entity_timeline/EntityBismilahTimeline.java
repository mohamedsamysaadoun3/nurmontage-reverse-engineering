...
public class EntityBismilahTimeline
extends Entity {
    ...
    public EntityBismilahTimeline(BismilahEntity bismilahEntity, float f, float f2, float f3, float f4, float f5) {
        ...
        this.rectFLeft = bismilahEntity;
        f = this.rectFLeft.width();
        super(0.0f, 0.0f, f, f3);
        this.rectFRight = bismilahEntity;
