...
public final class ProVersionActivityLast$$ExternalSyntheticLambda4
implements PurchasesResponseListener {
    public final /* synthetic */ ProVersionActivityLast f$0;

    public /* synthetic */ ProVersionActivityLast$$ExternalSyntheticLambda4(ProVersionActivityLast proVersionActivityLast) {
        this.f$0 = proVersionActivityLast;
    }

    public final void onQueryPurchasesResponse(BillingResult billingResult, List list) {
        this.f$0.cfr_renamed_80(billingResult, list);
    }
}
