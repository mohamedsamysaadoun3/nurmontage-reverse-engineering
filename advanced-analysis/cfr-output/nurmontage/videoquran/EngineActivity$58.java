...
import hazem.nurmontage.videoquran.EngineActivity$58$1;
import hazem.nurmontage.videoquran.EngineActivity$58$2;
import hazem.nurmontage.videoquran.entity_timeline.EntityAudio;
import hazem.nurmontage.videoquran.model.EffectAudio;
import java.io.File;

class EngineActivity$58
implements FFmpegSessionCompleteCallback {
    ...
    EngineActivity$58(EngineActivity engineActivity, Uri uri, EntityAudio entityAudio, int n, EffectAudio effectAudio, File file) {
        this.this$0 = engineActivity;
        this.val$uri = uri;
        this.val$entityAudio = entityAudio;
        this.val$finalIndex = n;
        this.val$effectAudioSelect = effectAudio;
        this.val$file = file;
    }
...
lbl47:
            ...
            var1_1 = this.this$0;
            var1_1 = EngineActivity.cfr_renamed_144((EngineActivity)var1_1);
            var3_3 = new EngineActivity$58$1(this);
            ...
            try {
                ...
                v0.printStackTrace();
                var1_1 = this.this$0;
                var3_3 = new EngineActivity$58$2(this);
