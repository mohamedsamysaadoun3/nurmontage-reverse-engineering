...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m1658constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            obj = Result.m1658constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m1661exceptionOrNullimpl(obj) == null) {
            obj4 = obj;
        }
        baseContinuationImplClassName = (String) obj4;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            obj2 = Result.m1658constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            obj2 = Result.m1658constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m1661exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            for (StackTraceElement stackTraceElement : stackTrace) {
                if (isArtificial(stackTraceElement)) {
                    return TuplesKt.m675to(cause, stackTrace);
                }
            }
            return TuplesKt.m675to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m675to(e, new StackTraceElement[0]);
    }
