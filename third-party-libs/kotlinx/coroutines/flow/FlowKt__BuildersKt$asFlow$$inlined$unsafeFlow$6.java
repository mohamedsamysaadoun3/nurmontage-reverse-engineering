...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6<T> implements Flow<T> {
    ...
    @DebugMetadata(m684c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6", m685f = "Builders.kt", m686i = {0, 0}, m687l = {115}, m688m = "collect", m689n = {"$this$asFlow_u24lambda_u2d11", "$this$forEach$iv"}, m690s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6$1 */
    public static final class C22501 extends ContinuationImpl {
        int I$0;
        int I$1;
        Object L$0;
        Object L$1;
        ...
        public C22501(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        int i3;
        Object[] objArr;
        if (continuation instanceof C22501) {
            c22501 = (C22501) continuation;
            if ((c22501.label & Integer.MIN_VALUE) != 0) {
                c22501.label -= Integer.MIN_VALUE;
                Object obj = c22501.result;
                ...
                if (i != 0) {
                    ...
                    i2 = c22501.I$1;
                    i3 = c22501.I$0;
                    objArr = (Object[]) c22501.L$1;
                    FlowCollector flowCollector3 = (FlowCollector) c22501.L$0;
                    ResultKt.throwOnFailure(obj);
                    ...
                    if (i3 < i2) {
                        ...
                        c22501.L$0 = flowCollector2;
                        c22501.L$1 = objArr;
                        c22501.I$0 = i3;
                        c22501.I$1 = i2;
                        c22501.label = 1;
                        Object emit = flowCollector2.emit(obj2, c22501);
        ...
        c22501 = new C22501(continuation);
        Object obj3 = c22501.result;
