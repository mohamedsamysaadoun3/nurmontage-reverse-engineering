...
@DebugMetadata(m684c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", m685f = "Delay.kt", m686i = {}, m687l = {280}, m688m = "invokeSuspend", m689n = {}, m690s = {})
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class C22561<T> implements FlowCollector {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C22561(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$this_sample.collect(new C22561(producerScope), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
