...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4<T> implements Flow<T> {
    ...
    @DebugMetadata(m684c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4", m685f = "Builders.kt", m686i = {0}, m687l = {115}, m688m = "collect", m689n = {"$this$asFlow_u24lambda_u2d5"}, m690s = {"L$0"})
    ...
    public static final class C22481 extends ContinuationImpl {
        ...
        public C22481(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C22481) {
            ...
            if ((c22481.label & Integer.MIN_VALUE) != 0) {
                c22481.label -= Integer.MIN_VALUE;
                ...
                if (i != 0) {
                    ...
                    it = (Iterator) c22481.L$1;
                    FlowCollector flowCollector3 = (FlowCollector) c22481.L$0;
                    ResultKt.throwOnFailure(obj);
                    flowCollector2 = flowCollector3;
                }
                while (it.hasNext()) {
                    Object next = it.next();
                    c22481.L$0 = flowCollector2;
                    c22481.L$1 = it;
                    c22481.label = 1;
                    if (flowCollector2.emit(next, c22481) == coroutine_suspended) {
