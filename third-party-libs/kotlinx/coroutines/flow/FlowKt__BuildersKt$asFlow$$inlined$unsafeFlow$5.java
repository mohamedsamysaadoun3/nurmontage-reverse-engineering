...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5<T> implements Flow<T> {
    ...
    @DebugMetadata(m684c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5", m685f = "Builders.kt", m686i = {0}, m687l = {115}, m688m = "collect", m689n = {"$this$asFlow_u24lambda_u2d7"}, m690s = {"L$0"})
    ...
    public static final class C22491 extends ContinuationImpl {
        ...
        public C22491(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C22491) {
            ...
            if ((c22491.label & Integer.MIN_VALUE) != 0) {
                c22491.label -= Integer.MIN_VALUE;
                ...
                if (i != 0) {
                    ...
                    it = (Iterator) c22491.L$1;
                    FlowCollector flowCollector3 = (FlowCollector) c22491.L$0;
                    ResultKt.throwOnFailure(obj);
                    flowCollector2 = flowCollector3;
                }
                while (it.hasNext()) {
                    T next = it.next();
                    c22491.L$0 = flowCollector2;
                    c22491.L$1 = it;
                    c22491.label = 1;
                    if (flowCollector2.emit(next, c22491) == coroutine_suspended) {
