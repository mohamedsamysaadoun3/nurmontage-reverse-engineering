...
public final class FlowKt__ErrorsKt$retryWhen$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m684c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retryWhen$$inlined$unsafeFlow$1", m685f = "Errors.kt", m686i = {0, 0, 0, 0, 1, 1, 1, 1}, m687l = {117, 119}, m688m = "collect", m689n = {"this", "$this$retryWhen_u24lambda_u2d2", "attempt", "shallRetry", "this", "$this$retryWhen_u24lambda_u2d2", "cause", "attempt"}, m690s = {"L$0", "L$1", "J$0", "I$0", "L$0", "L$1", "L$2", "J$0"})
    ...
    public static final class C22631 extends ContinuationImpl {
        ...
        public C22631(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C22631) {
            ...
            if ((c22631.label & Integer.MIN_VALUE) != 0) {
                c22631.label -= Integer.MIN_VALUE;
                ...
                if (i != 0) {
                    ...
                    c22631.L$0 = flowKt__ErrorsKt$retryWhen$$inlined$unsafeFlow$1;
                    c22631.L$1 = flowCollector;
                    c22631.L$2 = null;
                    c22631.J$0 = j;
                    c22631.I$0 = 0;
                    c22631.label = 1;
                    catchImpl = FlowKt.catchImpl(flow, flowCollector, c22631);
                    if (catchImpl != coroutine_suspended) {
                    }
                } else if (i == 1) {
                    i2 = c22631.I$0;
                    j = c22631.J$0;
                    flowCollector2 = (FlowCollector) c22631.L$1;
                    flowKt__ErrorsKt$retryWhen$$inlined$unsafeFlow$12 = (FlowKt__ErrorsKt$retryWhen$$inlined$unsafeFlow$1) c22631.L$0;
                    ResultKt.throwOnFailure(obj);
                    th = (Throwable) obj;
                    if (th != null) {
                    }
                    ...
                    j = c22631.J$0;
                    Throwable th2 = (Throwable) c22631.L$2;
                    flowCollector2 = (FlowCollector) c22631.L$1;
                    flowKt__ErrorsKt$retryWhen$$inlined$unsafeFlow$12 = (FlowKt__ErrorsKt$retryWhen$$inlined$unsafeFlow$1) c22631.L$0;
                    ResultKt.throwOnFailure(obj);
                    if (!((Boolean) obj).booleanValue()) {
                        ...
                        if (i2 != 0) {
                            ...
                            c22631.I$0 = 0;
                            c22631.label = 1;
                            catchImpl = FlowKt.catchImpl(flow2, flowCollector, c22631);
                            if (catchImpl != coroutine_suspended) {
                            ...
                            if (th != null) {
                                ...
                                c22631.L$0 = flowKt__ErrorsKt$retryWhen$$inlined$unsafeFlow$12;
                                c22631.L$1 = flowCollector2;
                                c22631.L$2 = th;
                                c22631.J$0 = j;
                                c22631.label = 2;
                                InlineMarker.mark(6);
                                Object invoke = function4.invoke(flowCollector2, th, boxLong, c22631);
                                InlineMarker.mark(7);
