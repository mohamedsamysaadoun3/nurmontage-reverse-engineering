...
@Metadata(m667d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m668d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "inner", "Lkotlinx/coroutines/flow/Flow;", "emit", "(Lkotlinx/coroutines/flow/Flow;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m669k = 3, m670mv = {1, 6, 0}, m672xi = 48)
...
final class ChannelFlowMerge$collectTo$2<T> implements FlowCollector {
    ...
    */
    public final Object emit(Flow<? extends T> flow, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof ChannelFlowMerge$collectTo$2$emit$1) {
            ...
            if ((channelFlowMerge$collectTo$2$emit$1.label & Integer.MIN_VALUE) != 0) {
                ...
                BuildersKt__Builders_commonKt.launch$default(channelFlowMerge$collectTo$2.$scope, null, null, new C23051(flow, channelFlowMerge$collectTo$2.$collector, channelFlowMerge$collectTo$2.$semaphore, null), 3, null);
    ...
    @DebugMetadata(m684c = "kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1", m685f = "Merge.kt", m686i = {}, m687l = {69}, m688m = "invokeSuspend", m689n = {}, m690s = {})
    ...
    static final class C23051 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C23051(Flow<? extends T> flow, SendingCollector<T> sendingCollector, Semaphore semaphore, Continuation<? super C23051> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C23051(this.$inner, this.$collector, this.$semaphore, continuation);
        }
