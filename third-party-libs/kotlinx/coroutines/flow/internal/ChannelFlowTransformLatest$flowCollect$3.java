...
@Metadata(m667d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\u00020\u0004H\u008a@"}, m668d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "R", "Lkotlinx/coroutines/CoroutineScope;"}, m669k = 3, m670mv = {1, 6, 0}, m672xi = 48)
@DebugMetadata(m684c = "kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest$flowCollect$3", m685f = "Merge.kt", m686i = {}, m687l = {27}, m688m = "invokeSuspend", m689n = {}, m690s = {})
...
final class ChannelFlowTransformLatest$flowCollect$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.this$0.flow.collect(new C23061(objectRef, coroutineScope, this.this$0, this.$collector), this) == coroutine_suspended) {
    ...
    /* compiled from: Merge.kt */
    @Metadata(m667d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u00032\u0006\u0010\u0004\u001a\u0002H\u0002H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m668d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "R", "value", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m669k = 3, m670mv = {1, 6, 0}, m672xi = 48)
    /* renamed from: kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest$flowCollect$3$1 */
    static final class C23061<T> implements FlowCollector {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C23061(Ref.ObjectRef<Job> objectRef, CoroutineScope coroutineScope, ChannelFlowTransformLatest<T, R> channelFlowTransformLatest, FlowCollector<? super R> flowCollector) {
        ...
        */
        public final Object emit(T t, Continuation<? super Unit> continuation) {
            ...
            if (continuation instanceof ChannelFlowTransformLatest$flowCollect$3$1$emit$1) {
                ...
                if ((channelFlowTransformLatest$flowCollect$3$1$emit$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        c23061 = (C23061) channelFlowTransformLatest$flowCollect$3$1$emit$1.L$0;
                        ResultKt.throwOnFailure(obj);
                    }
                    Ref.ObjectRef<Job> objectRef = c23061.$previousFlow;
                    launch$default = BuildersKt__Builders_commonKt.launch$default(c23061.$$this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new AnonymousClass2(c23061.this$0, c23061.$collector, t, null), 1, null);
            ...
            Ref.ObjectRef<Job> objectRef2 = c23061.$previousFlow;
            launch$default = BuildersKt__Builders_commonKt.launch$default(c23061.$$this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new AnonymousClass2(c23061.this$0, c23061.$collector, t, null), 1, null);
        ...
        /* compiled from: Merge.kt */
        @Metadata(m667d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\u00020\u0004H\u008a@"}, m668d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "R", "Lkotlinx/coroutines/CoroutineScope;"}, m669k = 3, m670mv = {1, 6, 0}, m672xi = 48)
        @DebugMetadata(m684c = "kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest$flowCollect$3$1$2", m685f = "Merge.kt", m686i = {}, m687l = {34}, m688m = "invokeSuspend", m689n = {}, m690s = {})
