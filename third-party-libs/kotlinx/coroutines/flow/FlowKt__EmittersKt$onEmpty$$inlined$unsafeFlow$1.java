...
public final class FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m684c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1", m685f = "Emitters.kt", m686i = {0, 0, 0, 1}, m687l = {114, 122}, m688m = "collect", m689n = {"this", "$this$onEmpty_u24lambda_u2d3", "isEmpty", "collector"}, m690s = {"L$0", "L$1", "L$2", "L$0"})
    ...
    public static final class C22581 extends ContinuationImpl {
        ...
        public C22581(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        try {
            if (continuation instanceof C22581) {
                ...
                if ((c22581.label & Integer.MIN_VALUE) != 0) {
                    c22581.label -= Integer.MIN_VALUE;
                    ...
                    if (i != 0) {
                        ...
                        c22581.L$0 = this;
                        c22581.L$1 = flowCollector;
                        c22581.L$2 = booleanRef2;
                        c22581.label = 1;
                        if (flow.collect(flowKt__EmittersKt$onEmpty$1$1, c22581) == coroutine_suspended) {
                        ...
                        if (i != 1) {
                            ...
                            SafeCollector safeCollector = (SafeCollector) c22581.L$0;
                            ResultKt.throwOnFailure(obj);
                            flowCollector = safeCollector;
                            return Unit.INSTANCE;
                        }
                        booleanRef = (Ref.BooleanRef) c22581.L$2;
                        flowCollector2 = (FlowCollector) c22581.L$1;
                        flowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1 = (FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1) c22581.L$0;
                        ResultKt.throwOnFailure(obj);
                    }
                    if (booleanRef.element) {
                        SafeCollector safeCollector2 = new SafeCollector(flowCollector2, c22581.getContext());
                        Function2 function2 = flowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1.$action$inlined;
                        c22581.L$0 = safeCollector2;
                        c22581.L$1 = null;
                        c22581.L$2 = null;
                        c22581.label = 2;
                        InlineMarker.mark(6);
                        Object invoke = function2.invoke(safeCollector2, c22581);
                        InlineMarker.mark(7);
