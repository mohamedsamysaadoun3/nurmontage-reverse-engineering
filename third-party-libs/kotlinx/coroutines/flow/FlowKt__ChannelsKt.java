            ...
            if (continuation instanceof FlowKt__ChannelsKt$emitAllImpl$1) {
                ...
                if ((flowKt__ChannelsKt$emitAllImpl$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        obj = receiveChannel.mo3163receiveCatchingJP2dKIU(flowKt__ChannelsKt$emitAllImpl$1);
                        ...
                        flowCollector = z2;
                        r9 = flowCollector2;
                        if (!ChannelResult.m3178isClosedimpl(obj)) {
                        }
                    } else if (i == 2) {
                        ...
                        try {
                            ...
                            if (!ChannelResult.m3178isClosedimpl(obj)) {
                                Throwable m3174exceptionOrNullimpl = ChannelResult.m3174exceptionOrNullimpl(obj);
                            ...
                            Object m3176getOrThrowimpl = ChannelResult.m3176getOrThrowimpl(obj);
                            ...
                            Object emit = r9.emit(m3176getOrThrowimpl, flowKt__ChannelsKt$emitAllImpl$1);
                            z4 = flowCollector;
                            flowCollector4 = r9;
