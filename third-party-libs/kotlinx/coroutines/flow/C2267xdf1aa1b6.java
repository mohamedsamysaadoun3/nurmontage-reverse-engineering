...
public final class C2267xdf1aa1b6<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m684c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1", m685f = "Limit.kt", m686i = {0}, m687l = {142}, m688m = "emit", m689n = {"this"}, m690s = {"L$0"})
    ...
    public static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return C2267xdf1aa1b6.this.emit(null, this);
        }
    }

    public C2267xdf1aa1b6(Function3 function3, FlowCollector flowCollector) {
    ...
    */
    public Object emit(T t, Continuation<? super Unit> continuation) {
        ...
        Object obj;
        int i;
        C2267xdf1aa1b6<T> c2267xdf1aa1b6;
        if (continuation instanceof AnonymousClass1) {
            ...
            if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    c2267xdf1aa1b6 = (C2267xdf1aa1b6) anonymousClass1.L$0;
                    ResultKt.throwOnFailure(obj);
                }
                if (((Boolean) obj).booleanValue()) {
                    throw new AbortFlowException(c2267xdf1aa1b6);
                }
