...
public final class FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m684c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1", m685f = "Emitters.kt", m686i = {0, 0, 0}, m687l = {AppInfoTableDecoder.APPLICATION_INFORMATION_TABLE_ID, 120}, m688m = "collect", m689n = {"this", "$this$onStart_u24lambda_u2d1", "safeCollector"}, m690s = {"L$0", "L$1", "L$2"})
    ...
    public static final class C22591 extends ContinuationImpl {
        ...
        public C22591(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C22591) {
            ...
            if ((c22591.label & Integer.MIN_VALUE) != 0) {
                c22591.label -= Integer.MIN_VALUE;
                Object obj = c22591.result;
                coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                i = c22591.label;
                if (i != 0) {
                    ResultKt.throwOnFailure(obj);
                    SafeCollector safeCollector2 = new SafeCollector(flowCollector, c22591.getContext());
                    try {
                        Function2 function2 = this.$action$inlined;
                        c22591.L$0 = this;
                        c22591.L$1 = flowCollector;
                        c22591.L$2 = safeCollector2;
                        c22591.label = 1;
                        InlineMarker.mark(6);
                        Object invoke = function2.invoke(safeCollector2, c22591);
                        InlineMarker.mark(7);
                    ...
                    safeCollector = (SafeCollector) c22591.L$2;
                    flowCollector2 = (FlowCollector) c22591.L$1;
                    flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 = (FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1) c22591.L$0;
                    try {
                        ResultKt.throwOnFailure(obj);
                    } catch (Throwable th3) {
                        th = th3;
                ...
                c22591.L$2 = null;
                c22591.label = 2;
                if (flow.collect(flowCollector2, c22591) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return Unit.INSTANCE;
            }
