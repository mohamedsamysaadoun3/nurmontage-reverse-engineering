...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public void mo3211dispatch(CoroutineContext context, Runnable block) {
        try {
            ...
            DefaultExecutor.INSTANCE.mo3211dispatch(context, block);
        }
    }
