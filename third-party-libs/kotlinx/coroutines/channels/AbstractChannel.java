...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final Object mo3163receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
            ...
            if ((abstractChannel$receiveCatching$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                        return pollInternal instanceof Closed ? ChannelResult.INSTANCE.m3183closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.INSTANCE.m3185successJP2dKIU(pollInternal);
                    }
    ...
    public final Object mo3164tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m3184failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.INSTANCE.m3183closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.INSTANCE.m3185successJP2dKIU(pollInternal);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        Object m3202constructorimpl$default = InlineList.m3202constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.mo3210remove()) {
                    prevNode.helpRemove();
                } else {
                    m3202constructorimpl$default = InlineList.m3207plusFjFbRPM(m3202constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo3162onCancelIdempotentListww6eGU(m3202constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            if (i != 1) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m3170boximpl(z ? companion.m3183closedJP2dKIU(((Closed) obj).closeCause) : companion.m3185successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            }
        }
        if (i == 0) {
        ...
        if (i == 1 && selectInstance.trySelect()) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m3170boximpl(ChannelResult.INSTANCE.m3183closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m1658constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.INSTANCE;
                        cancellableContinuationImpl.resumeWith(Result.m1658constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m3170boximpl(ChannelResult.INSTANCE.m3185successJP2dKIU(value)) : value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                ChannelResult m3170boximpl = ChannelResult.m3170boximpl(ChannelResult.INSTANCE.m3183closedJP2dKIU(closed.closeCause));
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m1658constructorimpl(m3170boximpl));
            }
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E value) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m3170boximpl(ChannelResult.INSTANCE.m3185successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m3170boximpl(ChannelResult.INSTANCE.m3183closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    protected void mo3162onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
