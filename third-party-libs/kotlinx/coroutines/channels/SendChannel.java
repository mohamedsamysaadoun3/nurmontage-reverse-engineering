...
public interface SendChannel<E> {
    ...
    Object mo3165trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m3180isSuccessimpl(mo3165trySendJP2dKIU)) {
                return true;
            }
            Throwable m3174exceptionOrNullimpl = ChannelResult.m3174exceptionOrNullimpl(mo3165trySendJP2dKIU);
