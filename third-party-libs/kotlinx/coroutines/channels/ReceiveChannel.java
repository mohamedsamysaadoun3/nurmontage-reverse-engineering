...
public interface ReceiveChannel<E> {
    ...
    Object mo3163receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo3164tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo3164tryReceivePtdJZtk = receiveChannel.mo3164tryReceivePtdJZtk();
            if (ChannelResult.m3180isSuccessimpl(mo3164tryReceivePtdJZtk)) {
                return (E) ChannelResult.m3176getOrThrowimpl(mo3164tryReceivePtdJZtk);
            }
            Throwable m3174exceptionOrNullimpl = ChannelResult.m3174exceptionOrNullimpl(mo3164tryReceivePtdJZtk);
            if (m3174exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m3174exceptionOrNullimpl);
        }
            ...
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo3163receiveCatchingJP2dKIU = receiveChannel.mo3163receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                    ...
                    return ChannelResult.m3175getOrNullimpl(mo3163receiveCatchingJP2dKIU);
                }
            }
