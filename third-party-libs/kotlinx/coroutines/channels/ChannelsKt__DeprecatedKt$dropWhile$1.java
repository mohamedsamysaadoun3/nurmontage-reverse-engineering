...
@DebugMetadata(m684c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$dropWhile$1", m685f = "Deprecated.kt", m686i = {0, 1, 1, 2, 3, 4}, m687l = {181, 182, 183, 187, TsExtractor.TS_PACKET_SIZE}, m688m = "invokeSuspend", m689n = {"$this$produce", "$this$produce", "e", "$this$produce", "$this$produce", "$this$produce"}, m690s = {"L$0", "L$0", "L$2", "L$0", "L$0", "L$0"})
