...
public class ColorFilterTransformation extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f453ID = "jp.wasabeef.glide.transformations.ColorFilterTransformation.1";
    ...
    @Override // jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public int hashCode() {
        return f453ID.hashCode() + (this.color * 10);
    }

    @Override // jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        messageDigest.update((f453ID + this.color).getBytes(CHARSET));
    }
}
