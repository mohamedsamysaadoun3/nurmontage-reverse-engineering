...
public class RoundedCornersTransformation extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f461ID = "jp.wasabeef.glide.transformations.RoundedCornersTransformation.1";
    ...
    private void drawRoundRect(Canvas canvas, Paint paint, float width, float height) {
        ...
        float f = width - i;
        float f2 = height - i;
        switch (C22241.f462xab0e3596[this.cornerType.ordinal()]) {
            case 1:
                int i2 = this.margin;
    ...
    static /* synthetic */ class C22241 {
        ...
        static {
            ...
            try {
                f462xab0e3596[CornerType.TOP_LEFT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f462xab0e3596[CornerType.TOP_RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f462xab0e3596[CornerType.BOTTOM_LEFT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f462xab0e3596[CornerType.BOTTOM_RIGHT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f462xab0e3596[CornerType.TOP.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f462xab0e3596[CornerType.BOTTOM.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f462xab0e3596[CornerType.LEFT.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f462xab0e3596[CornerType.RIGHT.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f462xab0e3596[CornerType.OTHER_TOP_LEFT.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f462xab0e3596[CornerType.OTHER_TOP_RIGHT.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f462xab0e3596[CornerType.OTHER_BOTTOM_LEFT.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f462xab0e3596[CornerType.OTHER_BOTTOM_RIGHT.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f462xab0e3596[CornerType.DIAGONAL_FROM_TOP_LEFT.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f462xab0e3596[CornerType.DIAGONAL_FROM_TOP_RIGHT.ordinal()] = 15;
    ...
    @Override // jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public int hashCode() {
        return f461ID.hashCode() + (this.radius * 10000) + (this.diameter * 1000) + (this.margin * 100) + (this.cornerType.ordinal() * 10);
    }

    @Override // jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        messageDigest.update((f461ID + this.radius + this.diameter + this.margin + this.cornerType).getBytes(CHARSET));
    }
}
