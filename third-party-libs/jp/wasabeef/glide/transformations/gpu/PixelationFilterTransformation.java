...
public class PixelationFilterTransformation extends GPUFilterTransformation {
    ...
    /* renamed from: ID */
    private static final String f468ID = "jp.wasabeef.glide.transformations.gpu.PixelationFilterTransformation.1";
    ...
    @Override // jp.wasabeef.glide.transformations.gpu.GPUFilterTransformation, jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public int hashCode() {
        return f468ID.hashCode() + ((int) (this.pixel * 10.0f));
    }

    @Override // jp.wasabeef.glide.transformations.gpu.GPUFilterTransformation, jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        messageDigest.update((f468ID + this.pixel).getBytes(CHARSET));
    }
}
