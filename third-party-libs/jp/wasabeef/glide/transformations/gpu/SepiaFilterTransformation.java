...
public class SepiaFilterTransformation extends GPUFilterTransformation {
    ...
    /* renamed from: ID */
    private static final String f469ID = "jp.wasabeef.glide.transformations.gpu.SepiaFilterTransformation.1";
    ...
    @Override // jp.wasabeef.glide.transformations.gpu.GPUFilterTransformation, jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public int hashCode() {
        return f469ID.hashCode() + ((int) (this.intensity * 10.0f));
    }

    @Override // jp.wasabeef.glide.transformations.gpu.GPUFilterTransformation, jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        messageDigest.update((f469ID + this.intensity).getBytes(CHARSET));
    }
}
