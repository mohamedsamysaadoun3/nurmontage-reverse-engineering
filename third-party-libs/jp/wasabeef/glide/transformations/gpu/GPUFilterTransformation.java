...
public class GPUFilterTransformation extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f465ID = "jp.wasabeef.glide.transformations.gpu.GPUFilterTransformation.1";
    private static final byte[] ID_BYTES = f465ID.getBytes(CHARSET);
