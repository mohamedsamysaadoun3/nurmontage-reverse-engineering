...
public class SwirlFilterTransformation extends GPUFilterTransformation {
    ...
    /* renamed from: ID */
    private static final String f471ID = "jp.wasabeef.glide.transformations.gpu.SwirlFilterTransformation.1";
    ...
    @Override // jp.wasabeef.glide.transformations.gpu.GPUFilterTransformation, jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public int hashCode() {
        return f471ID.hashCode() + ((int) (this.radius * 1000.0f)) + ((int) (this.angle * 10.0f)) + this.center.hashCode();
    }

    @Override // jp.wasabeef.glide.transformations.gpu.GPUFilterTransformation, jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        messageDigest.update((f471ID + this.radius + this.angle + this.center.hashCode()).getBytes(CHARSET));
    }
}
