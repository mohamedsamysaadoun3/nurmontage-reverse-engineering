...
public class CropCircleWithBorderTransformation extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f455ID = "jp.wasabeef.glide.transformations.CropCircleWithBorderTransformation.1";
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        messageDigest.update((f455ID + this.borderSize + this.borderColor).getBytes(CHARSET));
    }
    ...
    @Override // jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public int hashCode() {
        return f455ID.hashCode() + (this.borderSize * 100) + this.borderColor + 10;
    }
}
