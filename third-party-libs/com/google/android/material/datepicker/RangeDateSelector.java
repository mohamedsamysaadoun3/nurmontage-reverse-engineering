...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public int getDefaultThemeResId(Context context) {
        ...
        if (Math.min(displayMetrics.widthPixels, displayMetrics.heightPixels) > resources.getDimensionPixelSize(C0904R.dimen.mtrl_calendar_maximum_default_fullscreen_minor_axis)) {
            i = C0904R.attr.materialCalendarTheme;
        } else {
            i = C0904R.attr.materialCalendarFullscreenTheme;
        }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        if (l == null && this.selectedEndItem == null) {
            return resources.getString(C0904R.string.mtrl_picker_range_header_unselected);
        }
        Long l2 = this.selectedEndItem;
        if (l2 == null) {
            return resources.getString(C0904R.string.mtrl_picker_range_header_only_start_selected, DateStrings.getDateString(this.selectedStartItem.longValue()));
        }
        if (l == null) {
            return resources.getString(C0904R.string.mtrl_picker_range_header_only_end_selected, DateStrings.getDateString(this.selectedEndItem.longValue()));
        }
        Pair<String, String> dateRangeString = DateStrings.getDateRangeString(l, l2);
        return resources.getString(C0904R.string.mtrl_picker_range_header_selected, dateRangeString.first, dateRangeString.second);
    }
    ...
    public String getSelectionContentDescription(Context context) {
        ...
        if (dateRangeString.first == null) {
            str = resources.getString(C0904R.string.mtrl_picker_announce_current_selection_none);
        } else {
            str = dateRangeString.first;
        }
        if (dateRangeString.second == null) {
            str2 = resources.getString(C0904R.string.mtrl_picker_announce_current_selection_none);
        } else {
            str2 = dateRangeString.second;
        }
        return resources.getString(C0904R.string.mtrl_picker_announce_current_range_selection, str, str2);
    }
    ...
    public int getDefaultTitleResId() {
        return C0904R.string.mtrl_picker_range_header_title;
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints calendarConstraints, final OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) {
        ...
        View inflate = layoutInflater.inflate(C0904R.layout.mtrl_picker_text_input_date_range, viewGroup, false);
        final TextInputLayout textInputLayout = (TextInputLayout) inflate.findViewById(C0904R.id.mtrl_picker_text_input_range_start);
        final TextInputLayout textInputLayout2 = (TextInputLayout) inflate.findViewById(C0904R.id.mtrl_picker_text_input_range_end);
        ...
        this.invalidRangeStartError = inflate.getResources().getString(C0904R.string.mtrl_picker_invalid_range);
