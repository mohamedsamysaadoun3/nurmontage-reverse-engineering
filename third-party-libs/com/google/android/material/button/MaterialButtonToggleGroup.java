...
public class MaterialButtonToggleGroup extends LinearLayout {
    private static final int DEF_STYLE_RES = C0904R.style.Widget_MaterialComponents_MaterialButtonToggleGroup;
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0904R.attr.materialButtonToggleGroupStyle);
    }
    ...
    */
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C0904R.styleable.MaterialButtonToggleGroup, i, i2, new int[0]);
        setSingleSelection(obtainStyledAttributes.getBoolean(C0904R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.defaultCheckId = obtainStyledAttributes.getResourceId(C0904R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
        this.selectionRequired = obtainStyledAttributes.getBoolean(C0904R.styleable.MaterialButtonToggleGroup_selectionRequired, false);
        setChildrenDrawingOrderEnabled(true);
        setEnabled(obtainStyledAttributes.getBoolean(C0904R.styleable.MaterialButtonToggleGroup_android_enabled, true));
