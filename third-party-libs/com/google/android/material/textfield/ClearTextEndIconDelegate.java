...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    /* synthetic */ void m343xfc81bd94(View view) {
    ...
    /* synthetic */ void m344x7ae2c173(View view, boolean z) {
    ...
    ClearTextEndIconDelegate(EndCompoundLayout endCompoundLayout) {
        ...
        this.onIconClickListener = new View.OnClickListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                ClearTextEndIconDelegate.this.m343xfc81bd94(view);
            }
        };
        this.onFocusChangeListener = new View.OnFocusChangeListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda1
            ...
            public final void onFocusChange(View view, boolean z) {
                ClearTextEndIconDelegate.this.m344x7ae2c173(view, z);
            }
        };
        this.animationFadeDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C0904R.attr.motionDurationShort3, 100);
        this.animationScaleDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C0904R.attr.motionDurationShort3, DEFAULT_ANIMATION_SCALE_DURATION);
        ...
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(endCompoundLayout.getContext(), C0904R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
    }
        ...
        if (editText != null) {
            editText.post(new Runnable() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda3
                ...
                public final void run() {
                    ClearTextEndIconDelegate.this.m345x26d8c5f4();
                }
            });
        }
    }
    ...
    /* synthetic */ void m345x26d8c5f4() {
        animateIcon(true);
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    int getIconDrawableResId() {
        return C0904R.drawable.mtrl_ic_cancel;
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    int getIconContentDescriptionResId() {
        return C0904R.string.clear_text_end_icon_content_description;
    }
    ...
    private ValueAnimator getAlphaAnimator(float... fArr) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ClearTextEndIconDelegate.this.m341xa5c23ba8(valueAnimator);
            }
        });
        return ofFloat;
    }
    ...
    /* synthetic */ void m341xa5c23ba8(ValueAnimator valueAnimator) {
    ...
    private ValueAnimator getScaleAnimator() {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda4
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ClearTextEndIconDelegate.this.m342x3819711b(valueAnimator);
            }
        });
        return ofFloat;
    }
    ...
    /* synthetic */ void m342x3819711b(ValueAnimator valueAnimator) {
