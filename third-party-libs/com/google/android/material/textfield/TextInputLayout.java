...
public class TextInputLayout extends LinearLayout {
    ...
    private static final int DEF_STYLE_RES = C0904R.style.Widget_Design_TextInputLayout;
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0904R.attr.textInputStyle);
    }
    ...
    */
    public TextInputLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, C0904R.styleable.TextInputLayout, i, i2, C0904R.styleable.TextInputLayout_counterTextAppearance, C0904R.styleable.TextInputLayout_counterOverflowTextAppearance, C0904R.styleable.TextInputLayout_errorTextAppearance, C0904R.styleable.TextInputLayout_helperTextTextAppearance, C0904R.styleable.TextInputLayout_hintTextAppearance);
        ...
        this.hintEnabled = obtainTintedStyledAttributes.getBoolean(C0904R.styleable.TextInputLayout_hintEnabled, true);
        setHint(obtainTintedStyledAttributes.getText(C0904R.styleable.TextInputLayout_android_hint));
        this.hintAnimationEnabled = obtainTintedStyledAttributes.getBoolean(C0904R.styleable.TextInputLayout_hintAnimationEnabled, true);
        this.expandedHintEnabled = obtainTintedStyledAttributes.getBoolean(C0904R.styleable.TextInputLayout_expandedHintEnabled, true);
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.TextInputLayout_android_minEms)) {
            setMinEms(obtainTintedStyledAttributes.getInt(C0904R.styleable.TextInputLayout_android_minEms, -1));
        } else if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.TextInputLayout_android_minWidth)) {
            setMinWidth(obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.TextInputLayout_android_minWidth, -1));
        }
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.TextInputLayout_android_maxEms)) {
            setMaxEms(obtainTintedStyledAttributes.getInt(C0904R.styleable.TextInputLayout_android_maxEms, -1));
        } else if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.TextInputLayout_android_maxWidth)) {
            setMaxWidth(obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.TextInputLayout_android_maxWidth, -1));
        }
        this.shapeAppearanceModel = ShapeAppearanceModel.builder(context2, attributeSet, i, i2).build();
        this.boxLabelCutoutPaddingPx = context2.getResources().getDimensionPixelOffset(C0904R.dimen.mtrl_textinput_box_label_cutout_padding);
        this.boxCollapsedPaddingTopPx = obtainTintedStyledAttributes.getDimensionPixelOffset(C0904R.styleable.TextInputLayout_boxCollapsedPaddingTop, 0);
        this.boxStrokeWidthDefaultPx = obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.TextInputLayout_boxStrokeWidth, context2.getResources().getDimensionPixelSize(C0904R.dimen.mtrl_textinput_box_stroke_width_default));
        this.boxStrokeWidthFocusedPx = obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.TextInputLayout_boxStrokeWidthFocused, context2.getResources().getDimensionPixelSize(C0904R.dimen.mtrl_textinput_box_stroke_width_focused));
        this.boxStrokeWidthPx = this.boxStrokeWidthDefaultPx;
        float dimension = obtainTintedStyledAttributes.getDimension(C0904R.styleable.TextInputLayout_boxCornerRadiusTopStart, -1.0f);
        float dimension2 = obtainTintedStyledAttributes.getDimension(C0904R.styleable.TextInputLayout_boxCornerRadiusTopEnd, -1.0f);
        float dimension3 = obtainTintedStyledAttributes.getDimension(C0904R.styleable.TextInputLayout_boxCornerRadiusBottomEnd, -1.0f);
        float dimension4 = obtainTintedStyledAttributes.getDimension(C0904R.styleable.TextInputLayout_boxCornerRadiusBottomStart, -1.0f);
        ...
        ColorStateList colorStateList = MaterialResources.getColorStateList(context2, obtainTintedStyledAttributes, C0904R.styleable.TextInputLayout_boxBackgroundColor);
        if (colorStateList != null) {
            ...
            if (colorStateList.isStateful()) {
                ...
                ColorStateList colorStateList2 = AppCompatResources.getColorStateList(context2, C0904R.color.mtrl_filled_background_color);
        ...
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList3 = obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.TextInputLayout_android_textColorHint);
            this.focusedTextColor = colorStateList3;
            this.defaultHintTextColor = colorStateList3;
        }
        ColorStateList colorStateList4 = MaterialResources.getColorStateList(context2, obtainTintedStyledAttributes, C0904R.styleable.TextInputLayout_boxStrokeColor);
        this.focusedStrokeColor = obtainTintedStyledAttributes.getColor(C0904R.styleable.TextInputLayout_boxStrokeColor, 0);
        this.defaultStrokeColor = ContextCompat.getColor(context2, C0904R.color.mtrl_textinput_default_box_stroke_color);
        this.disabledColor = ContextCompat.getColor(context2, C0904R.color.mtrl_textinput_disabled_color);
        this.hoveredStrokeColor = ContextCompat.getColor(context2, C0904R.color.mtrl_textinput_hovered_box_stroke_color);
        if (colorStateList4 != null) {
            setBoxStrokeColorStateList(colorStateList4);
        }
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.TextInputLayout_boxStrokeErrorColor)) {
            setBoxStrokeErrorColor(MaterialResources.getColorStateList(context2, obtainTintedStyledAttributes, C0904R.styleable.TextInputLayout_boxStrokeErrorColor));
        }
        if (obtainTintedStyledAttributes.getResourceId(C0904R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(obtainTintedStyledAttributes.getResourceId(C0904R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.cursorColor = obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.TextInputLayout_cursorColor);
        this.cursorErrorColor = obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.TextInputLayout_cursorErrorColor);
        int resourceId = obtainTintedStyledAttributes.getResourceId(C0904R.styleable.TextInputLayout_errorTextAppearance, 0);
        CharSequence text = obtainTintedStyledAttributes.getText(C0904R.styleable.TextInputLayout_errorContentDescription);
        int i3 = obtainTintedStyledAttributes.getInt(C0904R.styleable.TextInputLayout_errorAccessibilityLiveRegion, 1);
        boolean z = obtainTintedStyledAttributes.getBoolean(C0904R.styleable.TextInputLayout_errorEnabled, false);
        int resourceId2 = obtainTintedStyledAttributes.getResourceId(C0904R.styleable.TextInputLayout_helperTextTextAppearance, 0);
        boolean z2 = obtainTintedStyledAttributes.getBoolean(C0904R.styleable.TextInputLayout_helperTextEnabled, false);
        CharSequence text2 = obtainTintedStyledAttributes.getText(C0904R.styleable.TextInputLayout_helperText);
        int resourceId3 = obtainTintedStyledAttributes.getResourceId(C0904R.styleable.TextInputLayout_placeholderTextAppearance, 0);
        CharSequence text3 = obtainTintedStyledAttributes.getText(C0904R.styleable.TextInputLayout_placeholderText);
        boolean z3 = obtainTintedStyledAttributes.getBoolean(C0904R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(obtainTintedStyledAttributes.getInt(C0904R.styleable.TextInputLayout_counterMaxLength, -1));
        this.counterTextAppearance = obtainTintedStyledAttributes.getResourceId(C0904R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.counterOverflowTextAppearance = obtainTintedStyledAttributes.getResourceId(C0904R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        setBoxBackgroundMode(obtainTintedStyledAttributes.getInt(C0904R.styleable.TextInputLayout_boxBackgroundMode, 0));
        ...
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.TextInputLayout_errorTextColor)) {
            setErrorTextColor(obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.TextInputLayout_errorTextColor));
        }
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.TextInputLayout_helperTextTextColor)) {
            setHelperTextColor(obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.TextInputLayout_helperTextTextColor));
        }
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.TextInputLayout_hintTextColor)) {
            setHintTextColor(obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.TextInputLayout_hintTextColor));
        }
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.TextInputLayout_counterTextColor)) {
            setCounterTextColor(obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.TextInputLayout_counterTextColor));
        }
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.TextInputLayout_counterOverflowTextColor)) {
            setCounterOverflowTextColor(obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.TextInputLayout_counterOverflowTextColor));
        }
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.TextInputLayout_placeholderTextColor)) {
            setPlaceholderTextColor(obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.TextInputLayout_placeholderTextColor));
        }
        EndCompoundLayout endCompoundLayout = new EndCompoundLayout(this, obtainTintedStyledAttributes);
        this.endLayout = endCompoundLayout;
        boolean z4 = obtainTintedStyledAttributes.getBoolean(C0904R.styleable.TextInputLayout_android_enabled, true);
    ...
    private Drawable getEditTextBoxBackground() {
        ...
        int color = MaterialColors.getColor(this.editText, C0904R.attr.colorControlHighlight);
        int i = this.boxBackgroundMode;
        if (i == 2) {
    ...
    private static Drawable getOutlinedBoxBackgroundWithRipple(Context context, MaterialShapeDrawable materialShapeDrawable, int i, int[][] iArr) {
        int color = MaterialColors.getColor(context, C0904R.attr.colorSurface, LOG_TAG);
    ...
    private MaterialShapeDrawable getDropDownMaterialShapeDrawable(boolean z) {
        ...
        float dimensionPixelOffset2 = getResources().getDimensionPixelOffset(C0904R.dimen.mtrl_shape_corner_size_small_component);
        ...
        if (editText instanceof MaterialAutoCompleteTextView) {
            ...
            dimensionPixelOffset = getResources().getDimensionPixelOffset(C0904R.dimen.m3_comp_outlined_autocomplete_menu_container_elevation);
        }
        int dimensionPixelOffset3 = getResources().getDimensionPixelOffset(C0904R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
    ...
    private void updateBoxCollapsedPaddingTop() {
        if (this.boxBackgroundMode == 1) {
            if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C0904R.dimen.material_font_2_0_box_collapsed_padding_top);
            } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C0904R.dimen.material_font_1_3_box_collapsed_padding_top);
            }
        }
    }
    ...
    private void adjustFilledEditTextPaddingForLargeFont() {
        ...
        if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
            EditText editText = this.editText;
            ViewCompat.setPaddingRelative(editText, ViewCompat.getPaddingStart(editText), getResources().getDimensionPixelSize(C0904R.dimen.material_filled_edittext_font_2_0_padding_top), ViewCompat.getPaddingEnd(this.editText), getResources().getDimensionPixelSize(C0904R.dimen.material_filled_edittext_font_2_0_padding_bottom));
        } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
            EditText editText2 = this.editText;
            ViewCompat.setPaddingRelative(editText2, ViewCompat.getPaddingStart(editText2), getResources().getDimensionPixelSize(C0904R.dimen.material_filled_edittext_font_1_3_padding_top), ViewCompat.getPaddingEnd(this.editText), getResources().getDimensionPixelSize(C0904R.dimen.material_filled_edittext_font_1_3_padding_bottom));
        }
    }
    ...
    public void setCounterEnabled(boolean z) {
        if (this.counterEnabled != z) {
            if (z) {
                ...
                appCompatTextView.setId(C0904R.id.textinput_counter);
                ...
                MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) this.counterView.getLayoutParams(), getResources().getDimensionPixelOffset(C0904R.dimen.mtrl_textinput_counter_margin_start));
    ...
    void updateCounter(Editable editable) {
        ...
        if (i == -1) {
            ...
            this.counterView.setText(BidiFormatter.getInstance().unicodeWrap(getContext().getString(C0904R.string.character_counter_pattern, Integer.valueOf(countLength), Integer.valueOf(this.counterMaxLength))));
        }
    ...
    private static void updateCounterContentDescription(Context context, TextView textView, int i, int i2, boolean z) {
        int i3;
        if (z) {
            i3 = C0904R.string.character_counter_overflowed_content_description;
        } else {
            i3 = C0904R.string.character_counter_content_description;
        }
    ...
    public void setPlaceholderText(CharSequence charSequence) {
        if (this.placeholderTextView == null) {
            ...
            appCompatTextView.setId(C0904R.id.textinput_placeholder);
    ...
    private Fade createPlaceholderFadeTransition() {
        Fade fade = new Fade();
        fade.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0904R.attr.motionDurationShort2, DEFAULT_PLACEHOLDER_FADE_DURATION));
        fade.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0904R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR));
        return fade;
    }
    ...
    void setTextAppearanceCompatWithErrorFallback(TextView textView, int i) {
        ...
        TextViewCompat.setTextAppearance(textView, C0904R.style.TextAppearance_AppCompat_Caption);
        textView.setTextColor(ContextCompat.getColor(getContext(), C0904R.color.design_error));
    }
    ...
    private int calculateBoxBackgroundColor() {
        return this.boxBackgroundMode == 1 ? MaterialColors.layer(MaterialColors.getColor(this, C0904R.attr.colorSurface, 0), this.boxBackgroundColor) : this.boxBackgroundColor;
    }
    ...
    private void updateCursorColor() {
        ...
        if (colorStateList2 == null) {
            colorStateList2 = MaterialColors.getColorStateListOrNull(getContext(), C0904R.attr.colorControlActivated);
        }
        EditText editText = this.editText;
    ...
    void animateToExpansionFraction(float f) {
        ...
        if (this.animator == null) {
            ...
            valueAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0904R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
            this.animator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0904R.attr.motionDurationMedium4, LABEL_SCALE_ANIMATION_DURATION));
