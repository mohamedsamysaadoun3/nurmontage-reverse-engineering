...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.contentInterpolator = MotionUtils.resolveThemeInterpolator(context, C0904R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    }

    @Override // android.view.View
    protected void onFinishInflate() {
        super.onFinishInflate();
        this.messageView = (TextView) findViewById(C0904R.id.snackbar_text);
        this.actionView = (Button) findViewById(C0904R.id.snackbar_action);
    }
    ...
    void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C0904R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(C0904R.dimen.design_snackbar_padding_vertical_2lines);
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(C0904R.dimen.design_snackbar_padding_vertical);
