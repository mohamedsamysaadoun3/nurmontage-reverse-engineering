...
public final class BadgeState {
    ...
    BadgeState(Context context, int i, int i2, int i3, State state) {
        ...
        this.badgeRadius = generateTypedArray.getDimensionPixelSize(C0904R.styleable.Badge_badgeRadius, -1);
        this.horizontalInset = context.getResources().getDimensionPixelSize(C0904R.dimen.mtrl_badge_horizontal_edge_offset);
        this.horizontalInsetWithText = context.getResources().getDimensionPixelSize(C0904R.dimen.mtrl_badge_text_horizontal_edge_offset);
        this.badgeWithTextRadius = generateTypedArray.getDimensionPixelSize(C0904R.styleable.Badge_badgeWithTextRadius, -1);
        this.badgeWidth = generateTypedArray.getDimension(C0904R.styleable.Badge_badgeWidth, resources.getDimension(C0904R.dimen.m3_badge_size));
        this.badgeWithTextWidth = generateTypedArray.getDimension(C0904R.styleable.Badge_badgeWithTextWidth, resources.getDimension(C0904R.dimen.m3_badge_with_text_size));
        this.badgeHeight = generateTypedArray.getDimension(C0904R.styleable.Badge_badgeHeight, resources.getDimension(C0904R.dimen.m3_badge_size));
        this.badgeWithTextHeight = generateTypedArray.getDimension(C0904R.styleable.Badge_badgeWithTextHeight, resources.getDimension(C0904R.dimen.m3_badge_with_text_size));
        boolean z = true;
        this.offsetAlignmentMode = generateTypedArray.getInt(C0904R.styleable.Badge_offsetAlignmentMode, 1);
        state2.alpha = state.alpha == -2 ? 255 : state.alpha;
        if (state.number == -2) {
            if (generateTypedArray.hasValue(C0904R.styleable.Badge_number)) {
                state2.number = generateTypedArray.getInt(C0904R.styleable.Badge_number, 0);
            } else {
                state2.number = -1;
            }
        } else {
        ...
        if (state.text == null) {
            if (generateTypedArray.hasValue(C0904R.styleable.Badge_badgeText)) {
                state2.text = generateTypedArray.getString(C0904R.styleable.Badge_badgeText);
            }
        } else {
        ...
        if (state.contentDescriptionNumberless == null) {
            charSequence = context.getString(C0904R.string.mtrl_badge_numberless_content_description);
        } else {
        ...
        if (state.contentDescriptionQuantityStrings == 0) {
            i4 = C0904R.plurals.mtrl_badge_content_description;
        } else {
        ...
        if (state.contentDescriptionExceedsMaxBadgeNumberRes == 0) {
            i5 = C0904R.string.mtrl_exceed_max_badge_number_content_description;
        } else {
        ...
        if (state.maxCharacterCount == -2) {
            i6 = generateTypedArray.getInt(C0904R.styleable.Badge_maxCharacterCount, -2);
        } else {
            i6 = state.maxCharacterCount;
        }
        state2.maxCharacterCount = i6;
        if (state.maxNumber == -2) {
            i7 = generateTypedArray.getInt(C0904R.styleable.Badge_maxNumber, -2);
        } else {
            i7 = state.maxNumber;
        }
        state2.maxNumber = i7;
        if (state.badgeShapeAppearanceResId == null) {
            intValue = generateTypedArray.getResourceId(C0904R.styleable.Badge_badgeShapeAppearance, C0904R.style.ShapeAppearance_M3_Sys_Shape_Corner_Full);
        } else {
        ...
        if (state.badgeShapeAppearanceOverlayResId == null) {
            intValue2 = generateTypedArray.getResourceId(C0904R.styleable.Badge_badgeShapeAppearanceOverlay, 0);
        } else {
        ...
        if (state.badgeWithTextShapeAppearanceResId == null) {
            intValue3 = generateTypedArray.getResourceId(C0904R.styleable.Badge_badgeWithTextShapeAppearance, C0904R.style.ShapeAppearance_M3_Sys_Shape_Corner_Full);
        } else {
        ...
        if (state.badgeWithTextShapeAppearanceOverlayResId == null) {
            intValue4 = generateTypedArray.getResourceId(C0904R.styleable.Badge_badgeWithTextShapeAppearanceOverlay, 0);
        } else {
        ...
        if (state.backgroundColor == null) {
            intValue5 = readColorFromAttributes(context, generateTypedArray, C0904R.styleable.Badge_backgroundColor);
        } else {
        ...
        if (state.badgeTextAppearanceResId == null) {
            intValue6 = generateTypedArray.getResourceId(C0904R.styleable.Badge_badgeTextAppearance, C0904R.style.TextAppearance_MaterialComponents_Badge);
        } else {
            intValue6 = state.badgeTextAppearanceResId.intValue();
        }
        state2.badgeTextAppearanceResId = Integer.valueOf(intValue6);
        if (state.badgeTextColor == null) {
            if (generateTypedArray.hasValue(C0904R.styleable.Badge_badgeTextColor)) {
                state2.badgeTextColor = Integer.valueOf(readColorFromAttributes(context, generateTypedArray, C0904R.styleable.Badge_badgeTextColor));
            } else {
        ...
        if (state.badgeGravity == null) {
            intValue7 = generateTypedArray.getInt(C0904R.styleable.Badge_badgeGravity, 8388661);
        } else {
            intValue7 = state.badgeGravity.intValue();
        }
        state2.badgeGravity = Integer.valueOf(intValue7);
        if (state.badgeHorizontalPadding == null) {
            intValue8 = generateTypedArray.getDimensionPixelSize(C0904R.styleable.Badge_badgeWidePadding, resources.getDimensionPixelSize(C0904R.dimen.mtrl_badge_long_text_horizontal_padding));
        } else {
        ...
        if (state.badgeVerticalPadding == null) {
            intValue9 = generateTypedArray.getDimensionPixelSize(C0904R.styleable.Badge_badgeVerticalPadding, resources.getDimensionPixelSize(C0904R.dimen.m3_badge_with_text_vertical_padding));
        } else {
        ...
        if (state.horizontalOffsetWithoutText == null) {
            intValue10 = generateTypedArray.getDimensionPixelOffset(C0904R.styleable.Badge_horizontalOffset, 0);
        } else {
        ...
        if (state.verticalOffsetWithoutText == null) {
            intValue11 = generateTypedArray.getDimensionPixelOffset(C0904R.styleable.Badge_verticalOffset, 0);
        } else {
        ...
        if (state.horizontalOffsetWithText == null) {
            intValue12 = generateTypedArray.getDimensionPixelOffset(C0904R.styleable.Badge_horizontalOffsetWithText, state2.horizontalOffsetWithoutText.intValue());
        } else {
        ...
        if (state.verticalOffsetWithText == null) {
            intValue13 = generateTypedArray.getDimensionPixelOffset(C0904R.styleable.Badge_verticalOffsetWithText, state2.verticalOffsetWithoutText.intValue());
        } else {
        ...
        if (state.largeFontVerticalOffsetAdjustment == null) {
            intValue14 = generateTypedArray.getDimensionPixelOffset(C0904R.styleable.Badge_largeFontVerticalOffsetAdjustment, 0);
        } else {
        ...
        if (state.autoAdjustToWithinGrandparentBounds == null) {
            booleanValue = generateTypedArray.getBoolean(C0904R.styleable.Badge_autoAdjustToWithinGrandparentBounds, false);
        } else {
    ...
    private TypedArray generateTypedArray(Context context, int i, int i2, int i3) {
        ...
        return ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0904R.styleable.Badge, i2, i4 == 0 ? i3 : i4, new int[0]);
    }
