...
public class ChipGroup extends FlowLayout {
    private static final int DEF_STYLE_RES = C0904R.style.Widget_MaterialComponents_ChipGroup;
    ...
    public ChipGroup(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0904R.attr.chipGroupStyle);
    }
    ...
    */
    public ChipGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C0904R.styleable.ChipGroup, i, i2, new int[0]);
        int dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0904R.styleable.ChipGroup_chipSpacing, 0);
        setChipSpacingHorizontal(obtainStyledAttributes.getDimensionPixelOffset(C0904R.styleable.ChipGroup_chipSpacingHorizontal, dimensionPixelOffset));
        setChipSpacingVertical(obtainStyledAttributes.getDimensionPixelOffset(C0904R.styleable.ChipGroup_chipSpacingVertical, dimensionPixelOffset));
        setSingleLine(obtainStyledAttributes.getBoolean(C0904R.styleable.ChipGroup_singleLine, false));
        setSingleSelection(obtainStyledAttributes.getBoolean(C0904R.styleable.ChipGroup_singleSelection, false));
        setSelectionRequired(obtainStyledAttributes.getBoolean(C0904R.styleable.ChipGroup_selectionRequired, false));
        this.defaultCheckedId = obtainStyledAttributes.getResourceId(C0904R.styleable.ChipGroup_checkedChip, -1);
