...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C0904R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0904R.attr.switchStyle);
    }
    ...
    */
    public SwitchMaterial(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0904R.styleable.SwitchMaterial, i, i2, new int[0]);
        this.useMaterialThemeColors = obtainStyledAttributes.getBoolean(C0904R.styleable.SwitchMaterial_useMaterialThemeColors, false);
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C0904R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C0904R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C0904R.dimen.mtrl_switch_thumb_elevation);
    ...
    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.materialThemeColorsTrackTintList == null) {
            ...
            int color = MaterialColors.getColor(this, C0904R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C0904R.attr.colorControlActivated);
            int color3 = MaterialColors.getColor(this, C0904R.attr.colorOnSurface);
