...
public class ShapePath {
    ...
    public void lineTo(float f, float f2, float f3, float f4) {
        ...
        pathLineOperation2.f239x = f3;
        pathLineOperation2.f240y = f4;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f240y - this.startY, this.operation.f239x - this.startX), 0.0f);
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            ...
            double hypot = Math.hypot(this.operation1.f239x - this.startX, this.operation1.f240y - this.startY);
            double hypot2 = Math.hypot(this.operation2.f239x - this.operation1.f239x, this.operation2.f240y - this.operation1.f240y);
            ...
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.operation1.f239x, this.operation1.f240y);
            this.renderMatrix.preRotate(getStartAngle());
        ...
        float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f240y - this.startY) / (this.operation1.f239x - this.startX)));
        }

        float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f240y - this.operation1.f240y) / (this.operation2.f239x - this.operation1.f239x)));
        }
