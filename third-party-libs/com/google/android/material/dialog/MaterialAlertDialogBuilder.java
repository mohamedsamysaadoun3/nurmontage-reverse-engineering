...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    private static final int DEF_STYLE_ATTR = C0904R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C0904R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C0904R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C0904R.attr.colorSurface, getClass().getCanonicalName());
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(null, C0904R.styleable.MaterialAlertDialog, i2, i3);
        int color2 = obtainStyledAttributes.getColor(C0904R.styleable.MaterialAlertDialog_backgroundTint, color);
