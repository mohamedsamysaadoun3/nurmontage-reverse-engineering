...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this(MaterialAttributes.resolveBoolean(context, C0904R.attr.elevationOverlayEnabled, false), MaterialColors.getColor(context, C0904R.attr.elevationOverlayColor, 0), MaterialColors.getColor(context, C0904R.attr.elevationOverlayAccentColor, 0), MaterialColors.getColor(context, C0904R.attr.colorSurface, 0), context.getResources().getDisplayMetrics().density);
    }
