...
public class NavigationView extends ScrimInsetsFrameLayout implements MaterialBackHandler {
    ...
    private static final int DEF_STYLE_RES = C0904R.style.Widget_Design_NavigationView;
    ...
    public NavigationView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0904R.attr.navigationViewStyle);
    }
    ...
    */
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, C0904R.styleable.NavigationView, i, i4, new int[0]);
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.NavigationView_android_background)) {
            ViewCompat.setBackground(this, obtainTintedStyledAttributes.getDrawable(C0904R.styleable.NavigationView_android_background));
        }
        this.drawerLayoutCornerSize = obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.NavigationView_drawerLayoutCornerSize, 0);
        ...
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.NavigationView_elevation)) {
            setElevation(obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.NavigationView_elevation, 0));
        }
        setFitsSystemWindows(obtainTintedStyledAttributes.getBoolean(C0904R.styleable.NavigationView_android_fitsSystemWindows, false));
        this.maxWidth = obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.NavigationView_android_maxWidth, 0);
        ColorStateList colorStateList = obtainTintedStyledAttributes.hasValue(C0904R.styleable.NavigationView_subheaderColor) ? obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.NavigationView_subheaderColor) : null;
        int resourceId = obtainTintedStyledAttributes.hasValue(C0904R.styleable.NavigationView_subheaderTextAppearance) ? obtainTintedStyledAttributes.getResourceId(C0904R.styleable.NavigationView_subheaderTextAppearance, 0) : 0;
        if (resourceId == 0 && colorStateList == null) {
            colorStateList = createDefaultColorStateList(R.attr.textColorSecondary);
        }
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.NavigationView_itemIconTint)) {
            createDefaultColorStateList = obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.NavigationView_itemIconTint);
        } else {
            createDefaultColorStateList = createDefaultColorStateList(R.attr.textColorSecondary);
        }
        int resourceId2 = obtainTintedStyledAttributes.hasValue(C0904R.styleable.NavigationView_itemTextAppearance) ? obtainTintedStyledAttributes.getResourceId(C0904R.styleable.NavigationView_itemTextAppearance, 0) : 0;
        boolean z = obtainTintedStyledAttributes.getBoolean(C0904R.styleable.NavigationView_itemTextAppearanceActiveBoldEnabled, true);
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.NavigationView_itemIconSize)) {
            setItemIconSize(obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.NavigationView_itemIconSize, 0));
        }
        ColorStateList colorStateList2 = obtainTintedStyledAttributes.hasValue(C0904R.styleable.NavigationView_itemTextColor) ? obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.NavigationView_itemTextColor) : null;
        if (resourceId2 == 0 && colorStateList2 == null) {
            colorStateList2 = createDefaultColorStateList(R.attr.textColorPrimary);
        }
        Drawable drawable = obtainTintedStyledAttributes.getDrawable(C0904R.styleable.NavigationView_itemBackground);
        if (drawable == null && hasShapeAppearance(obtainTintedStyledAttributes)) {
            ...
            ColorStateList colorStateList3 = MaterialResources.getColorStateList(context2, obtainTintedStyledAttributes, C0904R.styleable.NavigationView_itemRippleColor);
        ...
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.NavigationView_itemHorizontalPadding)) {
            i2 = 0;
            setItemHorizontalPadding(obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.NavigationView_itemHorizontalPadding, 0));
        } else {
            i2 = 0;
        }
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.NavigationView_itemVerticalPadding)) {
            setItemVerticalPadding(obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.NavigationView_itemVerticalPadding, i2));
        }
        setDividerInsetStart(obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.NavigationView_dividerInsetStart, i2));
        setDividerInsetEnd(obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.NavigationView_dividerInsetEnd, i2));
        setSubheaderInsetStart(obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.NavigationView_subheaderInsetStart, i2));
        setSubheaderInsetEnd(obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.NavigationView_subheaderInsetEnd, i2));
        setTopInsetScrimEnabled(obtainTintedStyledAttributes.getBoolean(C0904R.styleable.NavigationView_topInsetScrimEnabled, this.topInsetScrimEnabled));
        setBottomInsetScrimEnabled(obtainTintedStyledAttributes.getBoolean(C0904R.styleable.NavigationView_bottomInsetScrimEnabled, this.bottomInsetScrimEnabled));
        int dimensionPixelSize = obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.NavigationView_itemIconPadding, i2);
        setItemMaxLines(obtainTintedStyledAttributes.getInt(C0904R.styleable.NavigationView_itemMaxLines, 1));
        ...
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.NavigationView_menu)) {
            i3 = 0;
            inflateMenu(obtainTintedStyledAttributes.getResourceId(C0904R.styleable.NavigationView_menu, 0));
        } else {
            i3 = 0;
        }
        if (obtainTintedStyledAttributes.hasValue(C0904R.styleable.NavigationView_headerLayout)) {
            inflateHeaderView(obtainTintedStyledAttributes.getResourceId(C0904R.styleable.NavigationView_headerLayout, i3));
        }
    ...
    private boolean hasShapeAppearance(TintTypedArray tintTypedArray) {
        return tintTypedArray.hasValue(C0904R.styleable.NavigationView_itemShapeAppearance) || tintTypedArray.hasValue(C0904R.styleable.NavigationView_itemShapeAppearanceOverlay);
    }
    ...
    private Drawable createDefaultItemBackground(TintTypedArray tintTypedArray) {
        return createDefaultItemDrawable(tintTypedArray, MaterialResources.getColorStateList(getContext(), tintTypedArray, C0904R.styleable.NavigationView_itemShapeFillColor));
    }

    private Drawable createDefaultItemDrawable(TintTypedArray tintTypedArray, ColorStateList colorStateList) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(ShapeAppearanceModel.builder(getContext(), tintTypedArray.getResourceId(C0904R.styleable.NavigationView_itemShapeAppearance, 0), tintTypedArray.getResourceId(C0904R.styleable.NavigationView_itemShapeAppearanceOverlay, 0)).build());
        materialShapeDrawable.setFillColor(colorStateList);
        return new InsetDrawable((Drawable) materialShapeDrawable, tintTypedArray.getDimensionPixelSize(C0904R.styleable.NavigationView_itemShapeInsetStart, 0), tintTypedArray.getDimensionPixelSize(C0904R.styleable.NavigationView_itemShapeInsetTop, 0), tintTypedArray.getDimensionPixelSize(C0904R.styleable.NavigationView_itemShapeInsetEnd, 0), tintTypedArray.getDimensionPixelSize(C0904R.styleable.NavigationView_itemShapeInsetBottom, 0));
    }
    ...
    private ColorStateList createDefaultColorStateList(int i) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0030R.attr.colorPrimary, typedValue, true)) {
            return null;
        }
