...
public class MaterialSwitch extends SwitchCompat {
    private static final int DEF_STYLE_RES = C0904R.style.Widget_Material3_CompoundButton_MaterialSwitch;
    private static final int[] STATE_SET_WITH_ICON = {C0904R.attr.state_with_icon};
    ...
    public MaterialSwitch(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0904R.attr.materialSwitchStyle);
    }
    ...
    */
    public MaterialSwitch(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, C0904R.styleable.MaterialSwitch, i, i2, new int[0]);
        this.thumbIconDrawable = obtainTintedStyledAttributes.getDrawable(C0904R.styleable.MaterialSwitch_thumbIcon);
        this.thumbIconSize = obtainTintedStyledAttributes.getDimensionPixelSize(C0904R.styleable.MaterialSwitch_thumbIconSize, -1);
        this.thumbIconTintList = obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.MaterialSwitch_thumbIconTint);
        this.thumbIconTintMode = ViewUtils.parseTintMode(obtainTintedStyledAttributes.getInt(C0904R.styleable.MaterialSwitch_thumbIconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.trackDecorationDrawable = obtainTintedStyledAttributes.getDrawable(C0904R.styleable.MaterialSwitch_trackDecoration);
        this.trackDecorationTintList = obtainTintedStyledAttributes.getColorStateList(C0904R.styleable.MaterialSwitch_trackDecorationTint);
        this.trackDecorationTintMode = ViewUtils.parseTintMode(obtainTintedStyledAttributes.getInt(C0904R.styleable.MaterialSwitch_trackDecorationTintMode, -1), PorterDuff.Mode.SRC_IN);
