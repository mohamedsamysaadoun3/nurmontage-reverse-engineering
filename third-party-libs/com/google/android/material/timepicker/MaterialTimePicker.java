...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C0904R.attr.materialTimePickerStyle, C0904R.style.Widget_MaterialComponents_TimePicker);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0904R.styleable.MaterialTimePicker, C0904R.attr.materialTimePickerStyle, C0904R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = obtainStyledAttributes.getResourceId(C0904R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = obtainStyledAttributes.getResourceId(C0904R.styleable.MaterialTimePicker_keyboardIcon, 0);
        int color = obtainStyledAttributes.getColor(C0904R.styleable.MaterialTimePicker_backgroundTint, 0);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(C0904R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView = (TimePickerView) viewGroup2.findViewById(C0904R.id.material_timepicker_view);
        this.timePickerView = timePickerView;
        timePickerView.setOnDoubleTapListener(this);
        this.textInputStub = (ViewStub) viewGroup2.findViewById(C0904R.id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) viewGroup2.findViewById(C0904R.id.material_timepicker_mode_button);
        TextView textView = (TextView) viewGroup2.findViewById(C0904R.id.header_title);
        ...
        Button button = (Button) viewGroup2.findViewById(C0904R.id.material_timepicker_ok_button);
        ...
        Button button2 = (Button) viewGroup2.findViewById(C0904R.id.material_timepicker_cancel_button);
        ...
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
            view.postDelayed(new Runnable() { // from class: com.google.android.material.timepicker.MaterialTimePicker$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    MaterialTimePicker.this.m355xac73da03();
                }
            }, 100L);
        }
    }
    ...
    private Pair<Integer, Integer> dataForMode(int i) {
        if (i == 0) {
            return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C0904R.string.material_timepicker_text_input_mode_description));
        }
        if (i == 1) {
            return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C0904R.string.material_timepicker_clock_mode_description));
        }
    ...
    private int getThemeResId() {
        ...
        TypedValue resolve = MaterialAttributes.resolve(requireContext(), C0904R.attr.materialTimePickerTheme);
        if (resolve == null) {
            return 0;
        }
        return resolve.data;
