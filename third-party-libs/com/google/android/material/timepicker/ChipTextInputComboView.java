...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        Chip chip = (Chip) from.inflate(C0904R.layout.material_time_chip, (ViewGroup) this, false);
        this.chip = chip;
        chip.setAccessibilityClassName("android.view.View");
        TextInputLayout textInputLayout = (TextInputLayout) from.inflate(C0904R.layout.material_time_input, (ViewGroup) this, false);
        ...
        this.label = (TextView) findViewById(C0904R.id.material_label);
