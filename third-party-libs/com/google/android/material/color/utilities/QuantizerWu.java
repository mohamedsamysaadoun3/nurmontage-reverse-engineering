...
public final class QuantizerWu implements Quantizer {
    ...
    double variance(Box box) {
        ...
        return (((((((this.moments[getIndex(box.f230r1, box.f228g1, box.f226b1)] - this.moments[getIndex(box.f230r1, box.f228g1, box.f225b0)]) - this.moments[getIndex(box.f230r1, box.f227g0, box.f226b1)]) + this.moments[getIndex(box.f230r1, box.f227g0, box.f225b0)]) - this.moments[getIndex(box.f229r0, box.f228g1, box.f226b1)]) + this.moments[getIndex(box.f229r0, box.f228g1, box.f225b0)]) + this.moments[getIndex(box.f229r0, box.f227g0, box.f226b1)]) - this.moments[getIndex(box.f229r0, box.f227g0, box.f225b0)]) - ((((volume * volume) + (volume2 * volume2)) + (volume3 * volume3)) / volume(box, this.weights));
    }
    ...
    Boolean cut(Box box, Box box2) {
        ...
        MaximizeResult maximize = maximize(box, Direction.RED, box.f229r0 + 1, box.f230r1, volume, volume2, volume3, volume4);
        MaximizeResult maximize2 = maximize(box, Direction.GREEN, box.f227g0 + 1, box.f228g1, volume, volume2, volume3, volume4);
        MaximizeResult maximize3 = maximize(box, Direction.BLUE, box.f225b0 + 1, box.f226b1, volume, volume2, volume3, volume4);
        ...
        box2.f230r1 = box.f230r1;
        box2.f228g1 = box.f228g1;
        box2.f226b1 = box.f226b1;
        int i = C09771.f224x8739cebf[direction.ordinal()];
        if (i == 1) {
            box.f230r1 = maximize.cutLocation;
            box2.f229r0 = box.f230r1;
            box2.f227g0 = box.f227g0;
            box2.f225b0 = box.f225b0;
        } else if (i == 2) {
            box.f228g1 = maximize2.cutLocation;
            box2.f229r0 = box.f229r0;
            box2.f227g0 = box.f228g1;
            box2.f225b0 = box.f225b0;
        } else if (i == 3) {
            box.f226b1 = maximize3.cutLocation;
            box2.f229r0 = box.f229r0;
            box2.f227g0 = box.f227g0;
            box2.f225b0 = box.f226b1;
        }
        box.vol = (box.f230r1 - box.f229r0) * (box.f228g1 - box.f227g0) * (box.f226b1 - box.f225b0);
        box2.vol = (box2.f230r1 - box2.f229r0) * (box2.f228g1 - box2.f227g0) * (box2.f226b1 - box2.f225b0);
        return true;
    }
    ...
    static /* synthetic */ class C09771 {
        ...
        static final /* synthetic */ int[] f224x8739cebf;
        ...
        static {
            ...
            try {
                f224x8739cebf[Direction.GREEN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f224x8739cebf[Direction.BLUE.ordinal()] = 3;
    ...
    static int volume(Box box, int[] iArr) {
        return ((((((iArr[getIndex(box.f230r1, box.f228g1, box.f226b1)] - iArr[getIndex(box.f230r1, box.f228g1, box.f225b0)]) - iArr[getIndex(box.f230r1, box.f227g0, box.f226b1)]) + iArr[getIndex(box.f230r1, box.f227g0, box.f225b0)]) - iArr[getIndex(box.f229r0, box.f228g1, box.f226b1)]) + iArr[getIndex(box.f229r0, box.f228g1, box.f225b0)]) + iArr[getIndex(box.f229r0, box.f227g0, box.f226b1)]) - iArr[getIndex(box.f229r0, box.f227g0, box.f225b0)];
    }

    static int bottom(Box box, Direction direction, int[] iArr) {
        int i;
        int i2;
        int i3 = C09771.f224x8739cebf[direction.ordinal()];
        if (i3 == 1) {
            i = (-iArr[getIndex(box.f229r0, box.f228g1, box.f226b1)]) + iArr[getIndex(box.f229r0, box.f228g1, box.f225b0)] + iArr[getIndex(box.f229r0, box.f227g0, box.f226b1)];
            i2 = iArr[getIndex(box.f229r0, box.f227g0, box.f225b0)];
        } else if (i3 == 2) {
            i = (-iArr[getIndex(box.f230r1, box.f227g0, box.f226b1)]) + iArr[getIndex(box.f230r1, box.f227g0, box.f225b0)] + iArr[getIndex(box.f229r0, box.f227g0, box.f226b1)];
            i2 = iArr[getIndex(box.f229r0, box.f227g0, box.f225b0)];
        } else if (i3 == 3) {
            i = (-iArr[getIndex(box.f230r1, box.f228g1, box.f225b0)]) + iArr[getIndex(box.f230r1, box.f227g0, box.f225b0)] + iArr[getIndex(box.f229r0, box.f228g1, box.f225b0)];
            i2 = iArr[getIndex(box.f229r0, box.f227g0, box.f225b0)];
        } else {
    ...
    static int top(Box box, Direction direction, int i, int[] iArr) {
        int i2;
        int i3;
        int i4 = C09771.f224x8739cebf[direction.ordinal()];
        if (i4 == 1) {
            i2 = (iArr[getIndex(i, box.f228g1, box.f226b1)] - iArr[getIndex(i, box.f228g1, box.f225b0)]) - iArr[getIndex(i, box.f227g0, box.f226b1)];
            i3 = iArr[getIndex(i, box.f227g0, box.f225b0)];
        } else if (i4 == 2) {
            i2 = (iArr[getIndex(box.f230r1, i, box.f226b1)] - iArr[getIndex(box.f230r1, i, box.f225b0)]) - iArr[getIndex(box.f229r0, i, box.f226b1)];
            i3 = iArr[getIndex(box.f229r0, i, box.f225b0)];
        } else if (i4 == 3) {
            i2 = (iArr[getIndex(box.f230r1, box.f228g1, i)] - iArr[getIndex(box.f230r1, box.f227g0, i)]) - iArr[getIndex(box.f229r0, box.f228g1, i)];
            i3 = iArr[getIndex(box.f229r0, box.f227g0, i)];
        } else {
            throw new IllegalArgumentException("unexpected direction " + direction);
        }
        return i2 + i3;
