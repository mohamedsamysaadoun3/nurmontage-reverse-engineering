...
public final class DynamicColor {
    ...
    static double ensureToneDelta(double d, double d2, DynamicScheme dynamicScheme, Function<DynamicScheme, ToneDeltaConstraint> function, Function<DynamicColor, Double> function2) {
        ...
        int i = C09761.f223x2c744fd[apply.keepAwayPolarity.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C09761 {
        ...
        static final /* synthetic */ int[] f223x2c744fd;
        ...
        static {
            ...
            try {
                f223x2c744fd[TonePolarity.LIGHTER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f223x2c744fd[TonePolarity.NO_PREFERENCE.ordinal()] = 3;
