...
public class SearchBar extends Toolbar {
    ...
    private static final int DEF_STYLE_RES = C0904R.style.Widget_Material3_SearchBar;
    ...
    /* synthetic */ void m883lambda$new$0$comgoogleandroidmaterialsearchSearchBar(boolean z) {
    ...
    public SearchBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0904R.attr.materialSearchBarStyle);
    }
    ...
    */
    public SearchBar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.search.SearchBar$$ExternalSyntheticLambda1
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                SearchBar.this.m883lambda$new$0$comgoogleandroidmaterialsearchSearchBar(z);
            }
        };
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0904R.styleable.SearchBar, i, i2, new int[0]);
        ShapeAppearanceModel build = ShapeAppearanceModel.builder(context2, attributeSet, i, i2).build();
        int color = obtainStyledAttributes.getColor(C0904R.styleable.SearchBar_backgroundTint, 0);
        float dimension = obtainStyledAttributes.getDimension(C0904R.styleable.SearchBar_elevation, 0.0f);
        this.defaultMarginsEnabled = obtainStyledAttributes.getBoolean(C0904R.styleable.SearchBar_defaultMarginsEnabled, true);
        this.defaultScrollFlagsEnabled = obtainStyledAttributes.getBoolean(C0904R.styleable.SearchBar_defaultScrollFlagsEnabled, true);
        boolean z = obtainStyledAttributes.getBoolean(C0904R.styleable.SearchBar_hideNavigationIcon, false);
        this.forceDefaultNavigationOnClickListener = obtainStyledAttributes.getBoolean(C0904R.styleable.SearchBar_forceDefaultNavigationOnClickListener, false);
        this.tintNavigationIcon = obtainStyledAttributes.getBoolean(C0904R.styleable.SearchBar_tintNavigationIcon, true);
        if (obtainStyledAttributes.hasValue(C0904R.styleable.SearchBar_navigationIconTint)) {
            this.navigationIconTint = Integer.valueOf(obtainStyledAttributes.getColor(C0904R.styleable.SearchBar_navigationIconTint, -1));
        }
        int resourceId = obtainStyledAttributes.getResourceId(C0904R.styleable.SearchBar_android_textAppearance, -1);
        String string = obtainStyledAttributes.getString(C0904R.styleable.SearchBar_android_text);
        String string2 = obtainStyledAttributes.getString(C0904R.styleable.SearchBar_android_hint);
        float dimension2 = obtainStyledAttributes.getDimension(C0904R.styleable.SearchBar_strokeWidth, -1.0f);
        int color2 = obtainStyledAttributes.getColor(C0904R.styleable.SearchBar_strokeColor, 0);
        ...
        setClickable(true);
        setFocusable(true);
        LayoutInflater.from(context2).inflate(C0904R.layout.mtrl_search_bar, this);
        this.layoutInflated = true;
        this.textView = (TextView) findViewById(C0904R.id.open_search_bar_text_view);
    ...
    private void initTextView(int i, String str, String str2) {
        ...
        if (getNavigationIcon() == null) {
            MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams(), getResources().getDimensionPixelSize(C0904R.dimen.m3_searchbar_text_margin_start_no_navigation_icon));
        }
    }
    ...
    private void initBackground(ShapeAppearanceModel shapeAppearanceModel, int i, float f, float f2, int i2) {
        ...
        int color = MaterialColors.getColor(this, C0904R.attr.colorControlHighlight);
    ...
    private Drawable maybeTintNavigationIcon(Drawable drawable) {
        ...
        if (num != null) {
            ...
            if (drawable == this.defaultNavigationIcon) {
                i = C0904R.attr.colorOnSurfaceVariant;
            } else {
                i = C0904R.attr.colorOnSurface;
            }
    ...
    private void setDefaultMargins() {
        if (this.defaultMarginsEnabled && (getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0904R.dimen.m3_searchbar_margin_horizontal);
    ...
    protected int getDefaultMarginVerticalResource() {
        return C0904R.dimen.m3_searchbar_margin_vertical;
    }

    protected int getDefaultNavigationIconResource() {
        return C0904R.drawable.ic_search_black_24;
    }
