...
public class MaterialToolbar extends Toolbar {
    private static final int DEF_STYLE_RES = C0904R.style.Widget_MaterialComponents_Toolbar;
    ...
    public MaterialToolbar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0904R.attr.toolbarStyle);
    }
    ...
    */
    public MaterialToolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0904R.styleable.MaterialToolbar, i, i2, new int[0]);
        if (obtainStyledAttributes.hasValue(C0904R.styleable.MaterialToolbar_navigationIconTint)) {
            setNavigationIconTint(obtainStyledAttributes.getColor(C0904R.styleable.MaterialToolbar_navigationIconTint, -1));
        }
        this.titleCentered = obtainStyledAttributes.getBoolean(C0904R.styleable.MaterialToolbar_titleCentered, false);
        this.subtitleCentered = obtainStyledAttributes.getBoolean(C0904R.styleable.MaterialToolbar_subtitleCentered, false);
        int i3 = obtainStyledAttributes.getInt(C0904R.styleable.MaterialToolbar_logoScaleType, -1);
        if (i3 >= 0) {
        ...
        if (obtainStyledAttributes.hasValue(C0904R.styleable.MaterialToolbar_logoAdjustViewBounds)) {
            this.logoAdjustViewBounds = Boolean.valueOf(obtainStyledAttributes.getBoolean(C0904R.styleable.MaterialToolbar_logoAdjustViewBounds, false));
        }
