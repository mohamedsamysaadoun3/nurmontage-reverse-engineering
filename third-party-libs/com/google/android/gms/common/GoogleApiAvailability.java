...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (DeviceProperties.isWearable(context)) {
            ...
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                style.addAction(C0897R.drawable.common_full_open_on_phone, resources.getString(C0897R.string.common_open_on_phone), pendingIntent);
            } else {
                style.setContentIntent(pendingIntent);
            }
        } else {
            style.setSmallIcon(android.R.drawable.stat_sys_warning).setTicker(resources.getString(C0897R.string.common_google_play_services_notification_ticker)).setWhen(System.currentTimeMillis()).setContentIntent(pendingIntent).setContentText(zad);
        }
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                String string = context.getResources().getString(C0897R.string.common_google_play_services_notification_channel_name);
    ...
    public final boolean zah(Context context, ConnectionResult connectionResult, int i) {
        ...
        zae(context, connectionResult.getErrorCode(), null, PendingIntent.getActivity(context, 0, GoogleApiActivity.zaa(context, errorResolutionPendingIntent, i, true), zap.zaa | C0366C.BUFFER_FLAG_FIRST_SAMPLE));
        return true;
    }
