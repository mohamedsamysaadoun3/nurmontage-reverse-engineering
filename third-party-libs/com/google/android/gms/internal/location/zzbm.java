...
public final class zzbm {
    public static int zzb(int i, int i2, @NullableDecl String str) {
        if (i < 0 || i > i2) {
            throw new IndexOutOfBoundsException(zzd(i, i2, StreamInformation.KEY_INDEX));
        }
        return i;
    }
    ...
    public static int zza(int i, int i2, @NullableDecl String str) {
        ...
        if (i < 0) {
            zza = zzbn.zza("%s (%s) must not be negative", StreamInformation.KEY_INDEX, Integer.valueOf(i));
        } else {
            if (i2 < 0) {
                StringBuilder sb = new StringBuilder(26);
                sb.append("negative size: ");
            ...
            zza = zzbn.zza("%s (%s) must be less than size (%s)", StreamInformation.KEY_INDEX, Integer.valueOf(i), Integer.valueOf(i2));
        }
