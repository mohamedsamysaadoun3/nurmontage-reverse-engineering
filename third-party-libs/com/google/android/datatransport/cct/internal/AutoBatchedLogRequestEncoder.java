...
public final class AutoBatchedLogRequestEncoder implements Configurator {
    ...
    private static final class BatchedLogRequestEncoder implements ObjectEncoder<BatchedLogRequest> {
        ...
        private static final FieldDescriptor LOGREQUEST_DESCRIPTOR = FieldDescriptor.m568of("logRequest");
    ...
    private static final class LogRequestEncoder implements ObjectEncoder<LogRequest> {
        ...
        private static final FieldDescriptor REQUESTTIMEMS_DESCRIPTOR = FieldDescriptor.m568of("requestTimeMs");
        private static final FieldDescriptor REQUESTUPTIMEMS_DESCRIPTOR = FieldDescriptor.m568of("requestUptimeMs");
        private static final FieldDescriptor CLIENTINFO_DESCRIPTOR = FieldDescriptor.m568of("clientInfo");
        private static final FieldDescriptor LOGSOURCE_DESCRIPTOR = FieldDescriptor.m568of("logSource");
        private static final FieldDescriptor LOGSOURCENAME_DESCRIPTOR = FieldDescriptor.m568of("logSourceName");
        private static final FieldDescriptor LOGEVENT_DESCRIPTOR = FieldDescriptor.m568of("logEvent");
        private static final FieldDescriptor QOSTIER_DESCRIPTOR = FieldDescriptor.m568of("qosTier");
    ...
    private static final class ClientInfoEncoder implements ObjectEncoder<ClientInfo> {
        ...
        private static final FieldDescriptor CLIENTTYPE_DESCRIPTOR = FieldDescriptor.m568of("clientType");
        private static final FieldDescriptor ANDROIDCLIENTINFO_DESCRIPTOR = FieldDescriptor.m568of("androidClientInfo");
    ...
    private static final class AndroidClientInfoEncoder implements ObjectEncoder<AndroidClientInfo> {
        ...
        private static final FieldDescriptor SDKVERSION_DESCRIPTOR = FieldDescriptor.m568of("sdkVersion");
        private static final FieldDescriptor MODEL_DESCRIPTOR = FieldDescriptor.m568of("model");
        private static final FieldDescriptor HARDWARE_DESCRIPTOR = FieldDescriptor.m568of("hardware");
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.m568of("device");
        private static final FieldDescriptor PRODUCT_DESCRIPTOR = FieldDescriptor.m568of("product");
        private static final FieldDescriptor OSBUILD_DESCRIPTOR = FieldDescriptor.m568of("osBuild");
        private static final FieldDescriptor MANUFACTURER_DESCRIPTOR = FieldDescriptor.m568of("manufacturer");
        private static final FieldDescriptor FINGERPRINT_DESCRIPTOR = FieldDescriptor.m568of("fingerprint");
        private static final FieldDescriptor LOCALE_DESCRIPTOR = FieldDescriptor.m568of("locale");
        private static final FieldDescriptor COUNTRY_DESCRIPTOR = FieldDescriptor.m568of("country");
        private static final FieldDescriptor MCCMNC_DESCRIPTOR = FieldDescriptor.m568of("mccMnc");
        private static final FieldDescriptor APPLICATIONBUILD_DESCRIPTOR = FieldDescriptor.m568of("applicationBuild");
    ...
    private static final class LogEventEncoder implements ObjectEncoder<LogEvent> {
        ...
        private static final FieldDescriptor EVENTTIMEMS_DESCRIPTOR = FieldDescriptor.m568of("eventTimeMs");
        private static final FieldDescriptor EVENTCODE_DESCRIPTOR = FieldDescriptor.m568of("eventCode");
        private static final FieldDescriptor EVENTUPTIMEMS_DESCRIPTOR = FieldDescriptor.m568of("eventUptimeMs");
        private static final FieldDescriptor SOURCEEXTENSION_DESCRIPTOR = FieldDescriptor.m568of("sourceExtension");
        private static final FieldDescriptor SOURCEEXTENSIONJSONPROTO3_DESCRIPTOR = FieldDescriptor.m568of("sourceExtensionJsonProto3");
        private static final FieldDescriptor TIMEZONEOFFSETSECONDS_DESCRIPTOR = FieldDescriptor.m568of("timezoneOffsetSeconds");
        private static final FieldDescriptor NETWORKCONNECTIONINFO_DESCRIPTOR = FieldDescriptor.m568of("networkConnectionInfo");
    ...
    private static final class NetworkConnectionInfoEncoder implements ObjectEncoder<NetworkConnectionInfo> {
        ...
        private static final FieldDescriptor NETWORKTYPE_DESCRIPTOR = FieldDescriptor.m568of("networkType");
        private static final FieldDescriptor MOBILESUBTYPE_DESCRIPTOR = FieldDescriptor.m568of("mobileSubtype");
