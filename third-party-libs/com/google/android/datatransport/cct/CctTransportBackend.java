...
final class CctTransportBackend implements TransportBackend {
    ...
    private static int getPackageVersionCode(Context context) {
        try {
            ...
            Logging.m232e(LOG_TAG, "Unable to find version code for package", e);
            return -1;
        }
    }
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        Logging.m233i(LOG_TAG, "Making request to: %s", httpRequest.url);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Logging.m233i(LOG_TAG, "Status Code: %d", Integer.valueOf(responseCode));
                    Logging.m229d(LOG_TAG, "Content-Type: %s", httpURLConnection.getHeaderField("Content-Type"));
                    Logging.m229d(LOG_TAG, "Content-Encoding: %s", httpURLConnection.getHeaderField("Content-Encoding"));
            ...
            e = e;
            Logging.m232e(LOG_TAG, "Couldn't encode request, returning with 400", e);
            return new HttpResponse(400, null, 0L);
        } catch (ConnectException e2) {
            e = e2;
            Logging.m232e(LOG_TAG, "Couldn't open connection, returning with 500", e);
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            ...
            if (httpResponse.code == 200) {
                return BackendResponse.m227ok(httpResponse.nextRequestMillis);
            }
            ...
            Logging.m232e(LOG_TAG, "Could not make request to the backend", e);
            return BackendResponse.transientError();
        }
    }
    ...
    static /* synthetic */ HttpRequest lambda$send$0(HttpRequest httpRequest, HttpResponse httpResponse) {
        ...
        Logging.m229d(LOG_TAG, "Following redirect to: %s", httpResponse.redirectUrl);
