...
public final class Logging {
    ...
    /* renamed from: d */
    public static void m228d(String str, String str2) {
    ...
    /* renamed from: d */
    public static void m229d(String str, String str2, Object obj) {
        String tag = getTag(str);
        if (Log.isLoggable(tag, 3)) {
    ...
    /* renamed from: d */
    public static void m230d(String str, String str2, Object obj, Object obj2) {
        String tag = getTag(str);
        if (Log.isLoggable(tag, 3)) {
    ...
    /* renamed from: d */
    public static void m231d(String str, String str2, Object... objArr) {
        String tag = getTag(str);
        if (Log.isLoggable(tag, 3)) {
    ...
    /* renamed from: i */
    public static void m233i(String str, String str2, Object obj) {
        String tag = getTag(str);
    ...
    /* renamed from: e */
    public static void m232e(String str, String str2, Throwable th) {
        String tag = getTag(str);
    ...
    /* renamed from: w */
    public static void m234w(String str, String str2, Object obj) {
        String tag = getTag(str);
