...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
    ...
    /* renamed from: of */
    public static <E> ImmutableSet<E> m440of() {
        return RegularImmutableSet.EMPTY;
    }

    /* renamed from: of */
    public static <E> ImmutableSet<E> m441of(E e1) {
        return new SingletonImmutableSet(e1);
    }

    /* renamed from: of */
    public static <E> ImmutableSet<E> m442of(E e1, E e2) {
        return construct(2, e1, e2);
    }

    /* renamed from: of */
    public static <E> ImmutableSet<E> m443of(E e1, E e2, E e3) {
        return construct(3, e1, e2, e3);
    }

    /* renamed from: of */
    public static <E> ImmutableSet<E> m444of(E e1, E e2, E e3, E e4) {
        return construct(4, e1, e2, e3, e4);
    }

    /* renamed from: of */
    public static <E> ImmutableSet<E> m445of(E e1, E e2, E e3, E e4, E e5) {
        return construct(5, e1, e2, e3, e4, e5);
    }

    @SafeVarargs
    /* renamed from: of */
    public static <E> ImmutableSet<E> m446of(E e1, E e2, E e3, E e4, E e5, E e6, E... others) {
    ...
    public static <E> ImmutableSet<E> construct(int n, Object... elements) {
        ...
        if (n == 1) {
            return m441of(Objects.requireNonNull(elements[0]));
        }
    ...
    public static <E> ImmutableSet<E> copyOf(E[] elements) {
        ...
        if (length == 1) {
            return m441of((Object) elements[0]);
        }
    ...
    public static class Builder<E> extends ImmutableCollection.ArrayBasedBuilder<E> {
        ...
        public ImmutableSet<E> build() {
            ...
            if (i == 1) {
                return ImmutableSet.m441of(Objects.requireNonNull(this.contents[0]));
            }
            if (this.hashTable == null || ImmutableSet.chooseTableSize(this.size) != this.hashTable.length) {
