...
public final class Multimaps {
                ...
                public Iterator<V> iterator() {
                    return new Iterator<V>() { // from class: com.google.common.collect.Multimaps.MapMultimap.1.1
                        ...
                        public boolean hasNext() {
                            return this.f290i == 0 && C14031.this.this$0.map.containsKey(key);
                        }
                        ...
                        public V next() {
                            ...
                            this.f290i++;
                            return (V) NullnessCasts.uncheckedCastNullableTToT(C14031.this.this$0.map.get(key));
                        }

                        @Override // java.util.Iterator
                        public void remove() {
                            CollectPreconditions.checkRemove(this.f290i == 1);
                            this.f290i = -1;
                            C14031.this.this$0.map.remove(key);
                        }
                    };
                }
    ...
    static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        public Collection<V2> m504x893217c0(@ParametricNullness K key, Collection<V1> values) {
        ...
        Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new Maps.EntryTransformer() { // from class: com.google.common.collect.Multimaps$TransformedEntriesMultimap$$ExternalSyntheticLambda0
                ...
                public final Object transformEntry(Object obj, Object obj2) {
                    return Multimaps.TransformedEntriesMultimap.this.m504x893217c0(obj, (Collection) obj2);
                }
            });
        }
        ...
        public Collection<V2> get(@ParametricNullness final K key) {
            return m504x893217c0(key, this.fromMultimap.get(key));
        }
        ...
        public Collection<V2> removeAll(@CheckForNull Object key) {
            return m504x893217c0(key, this.fromMultimap.removeAll(key));
        }
    ...
    private static final class TransformedEntriesListMultimap<K, V1, V2> extends TransformedEntriesMultimap<K, V1, V2> implements ListMultimap<K, V2> {
        ...
        /* bridge */ /* synthetic */ Collection m504x893217c0(@ParametricNullness Object key, Collection values) {
            return m504x893217c0((TransformedEntriesListMultimap<K, V1, V2>) key, values);
        }
        ...
        @Override // com.google.common.collect.Multimaps.TransformedEntriesMultimap
        /* renamed from: transform */
        List<V2> m504x893217c0(@ParametricNullness K key, Collection<V1> values) {
        ...
        public List<V2> get(@ParametricNullness K key) {
            return m504x893217c0((TransformedEntriesListMultimap<K, V1, V2>) key, (Collection) this.fromMultimap.get(key));
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.google.common.collect.Multimaps.TransformedEntriesMultimap, com.google.common.collect.Multimap, com.google.common.collect.ListMultimap
        public List<V2> removeAll(@CheckForNull Object key) {
            return m504x893217c0((TransformedEntriesListMultimap<K, V1, V2>) key, (Collection) this.fromMultimap.removeAll(key));
        }
        ...
        class EntrySet extends Maps.EntrySet<K, Collection<V>> {
            ...
            public Iterator<Map.Entry<K, Collection<V>>> iterator() {
                return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), new com.google.common.base.Function() { // from class: com.google.common.collect.Multimaps$AsMap$EntrySet$$ExternalSyntheticLambda0
                    @Override // com.google.common.base.Function
                    public final Object apply(Object obj) {
                        return Multimaps.AsMap.EntrySet.this.m503xda360ac8(obj);
                    }
                });
            }

            /* renamed from: lambda$iterator$0$com-google-common-collect-Multimaps$AsMap$EntrySet */
            /* synthetic */ Collection m503xda360ac8(Object obj) {
