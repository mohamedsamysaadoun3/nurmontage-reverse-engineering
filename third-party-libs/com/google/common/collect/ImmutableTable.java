...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m501of() {
        return (ImmutableTable<R, C, V>) SparseImmutableTable.EMPTY;
    }

    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m502of(R rowKey, C columnKey, V value) {
    ...
    public ImmutableMap<R, V> column(C columnKey) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) columnMap().get(columnKey), ImmutableMap.m412of());
    }
    ...
    public ImmutableMap<C, V> row(R rowKey) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) rowMap().get(rowKey), ImmutableMap.m412of());
    }
    ...
    static final class SerializedForm implements Serializable {
        ...
        Object readResolve() {
            ...
            int i = 0;
            if (objArr.length == 1) {
                return ImmutableTable.m502of(this.rowKeys[0], this.columnKeys[0], objArr[0]);
            }
