...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m393of());
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m394of(Range.all()));
    ...
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m438of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m439of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m394of(range));
    }
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        if (this.ranges.size() == 1 && this.ranges.get(0).equals(Range.all())) {
            ImmutableRangeSet<C> m438of = m438of();
            this.complement = m438of;
            return m438of;
        }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> domain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m488of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (build.isEmpty()) {
                return ImmutableRangeSet.m438of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m394of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
