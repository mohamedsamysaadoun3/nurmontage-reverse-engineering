...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    private long aggregateBelowRange(Aggregate aggr, @CheckForNull AvlNode<E> node) {
        ...
        if (compare == 0) {
            int i = C14574.$SwitchMap$com$google$common$collect$BoundType[this.range.getLowerBoundType().ordinal()];
            if (i != 1) {
                if (i != 2) {
    ...
    private long aggregateAboveRange(Aggregate aggr, @CheckForNull AvlNode<E> node) {
        ...
        if (compare == 0) {
            int i = C14574.$SwitchMap$com$google$common$collect$BoundType[this.range.getUpperBoundType().ordinal()];
            if (i != 1) {
                if (i != 2) {
                    throw new AssertionError();
                }
