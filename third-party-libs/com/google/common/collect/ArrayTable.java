...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    @CheckForNull
    /* renamed from: at */
    public V m377at(int rowIndex, int columnIndex) {
    ...
    public V get(@CheckForNull Object rowKey, @CheckForNull Object columnKey) {
        ...
        return m377at(num.intValue(), num2.intValue());
    }
    ...
    public Table.Cell<R, C, V> getCell(final int index) {
        return new Tables.AbstractCell<R, C, V>(this, index) { // from class: com.google.common.collect.ArrayTable.2
            ...
            @CheckForNull
            public V getValue() {
                return (V) this.this$0.m377at(this.rowIndex, this.columnIndex);
            }
        };
    }
    ...
    public V getValue(int index) {
        return m377at(index / this.columnList.size(), index % this.columnList.size());
    }
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        @CheckForNull
        V getValue(int i) {
            return (V) ArrayTable.this.m377at(i, this.columnIndex);
        }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        @CheckForNull
        V getValue(int i) {
            return (V) ArrayTable.this.m377at(this.rowIndex, i);
        }
