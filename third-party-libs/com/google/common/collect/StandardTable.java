    ...
    private class Column extends Maps.ViewCachingAbstractMap<R, V> {
        ...
        private class EntrySet extends Sets.ImprovedAbstractSet<Map.Entry<R, V>> {
            ...
            public boolean retainAll(Collection<?> c) {
                return Column.this.removeFromColumnIf(Predicates.not(Predicates.m367in(c)));
            }
        }
        ...
        private class KeySet extends Maps.KeySet<R, V> {
            ...
            public boolean retainAll(final Collection<?> c) {
                return Column.this.removeFromColumnIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m367in(c))));
            }
        }
        ...
        private class Values extends Maps.Values<R, V> {
            ...
            public boolean removeAll(final Collection<?> c) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.m367in(c)));
            }

            @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
            public boolean retainAll(final Collection<?> c) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m367in(c))));
            }
        }
    }
