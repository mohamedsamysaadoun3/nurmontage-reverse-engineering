...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    FluentIterable(Iterable<E> iterable) {
        this.iterableDelegate = Optional.m366of(iterable);
    }

    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo360or((Optional<Iterable<E>>) this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m378of() {
        return from(Collections.emptyList());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m379of(@ParametricNullness E element, E... elements) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m366of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m366of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m366of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m366of(next);
    }
