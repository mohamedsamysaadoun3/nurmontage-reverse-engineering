...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    /* renamed from: C1 */
    private static final int f304C1 = -862048943;

    /* renamed from: C2 */
    private static final int f305C2 = 461845907;
    ...
    public static int mixK1(int k1) {
        return Integer.rotateLeft(k1 * f304C1, 15) * f305C2;
    }
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int nBytes, long update) {
            ...
            this.length += nBytes;
            if (i2 >= 32) {
                this.f306h1 = Murmur3_32HashFunction.mixH1(this.f306h1, Murmur3_32HashFunction.mixK1((int) j2));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            int mixK1 = this.f306h1 ^ Murmur3_32HashFunction.mixK1((int) this.buffer);
            this.f306h1 = mixK1;
