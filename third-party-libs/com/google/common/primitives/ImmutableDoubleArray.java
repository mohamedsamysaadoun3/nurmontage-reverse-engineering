...
public final class ImmutableDoubleArray implements Serializable {
    ...
    /* renamed from: of */
    public static ImmutableDoubleArray m528of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m529of(double e0) {
        return new ImmutableDoubleArray(new double[]{e0});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m530of(double e0, double e1) {
        return new ImmutableDoubleArray(new double[]{e0, e1});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m531of(double e0, double e1, double e2) {
        return new ImmutableDoubleArray(new double[]{e0, e1, e2});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m532of(double e0, double e1, double e2, double e3) {
        return new ImmutableDoubleArray(new double[]{e0, e1, e2, e3});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m533of(double e0, double e1, double e2, double e3, double e4) {
        return new ImmutableDoubleArray(new double[]{e0, e1, e2, e3, e4});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m534of(double e0, double e1, double e2, double e3, double e4, double e5) {
        return new ImmutableDoubleArray(new double[]{e0, e1, e2, e3, e4, e5});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m535of(double first, double... rest) {
