...
public final class ImmutableIntArray implements Serializable {
    ...
    /* renamed from: of */
    public static ImmutableIntArray m536of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static ImmutableIntArray m537of(int e0) {
        return new ImmutableIntArray(new int[]{e0});
    }

    /* renamed from: of */
    public static ImmutableIntArray m538of(int e0, int e1) {
        return new ImmutableIntArray(new int[]{e0, e1});
    }

    /* renamed from: of */
    public static ImmutableIntArray m539of(int e0, int e1, int e2) {
        return new ImmutableIntArray(new int[]{e0, e1, e2});
    }

    /* renamed from: of */
    public static ImmutableIntArray m540of(int e0, int e1, int e2, int e3) {
        return new ImmutableIntArray(new int[]{e0, e1, e2, e3});
    }

    /* renamed from: of */
    public static ImmutableIntArray m541of(int e0, int e1, int e2, int e3, int e4) {
        return new ImmutableIntArray(new int[]{e0, e1, e2, e3, e4});
    }

    /* renamed from: of */
    public static ImmutableIntArray m542of(int e0, int e1, int e2, int e3, int e4, int e5) {
        return new ImmutableIntArray(new int[]{e0, e1, e2, e3, e4, e5});
    }

    /* renamed from: of */
    public static ImmutableIntArray m543of(int first, int... rest) {
