...
public abstract class LinearTransformation {
    ...
    public static final class LinearTransformationBuilder {
        ...
        /* renamed from: x1 */
        private final double f335x1;

        /* renamed from: y1 */
        private final double f336y1;
        ...
        public LinearTransformation and(double x2, double y2) {
            ...
            double d = this.f335x1;
            if (x2 == d) {
                Preconditions.checkArgument(y2 != this.f336y1);
                return new VerticalLinearTransformation(this.f335x1);
            }
            return withSlope((y2 - this.f336y1) / (x2 - d));
        }
        ...
        public LinearTransformation withSlope(double slope) {
            ...
            if (DoubleUtils.isFinite(slope)) {
                return new RegularLinearTransformation(slope, this.f336y1 - (this.f335x1 * slope));
            }
            return new VerticalLinearTransformation(this.f335x1);
        }
    }
    ...
    private static final class VerticalLinearTransformation extends LinearTransformation {
        ...
        public String toString() {
            return String.format("x = %g", Double.valueOf(this.f337x));
        }

        private LinearTransformation createInverse() {
            return new RegularLinearTransformation(0.0d, this.f337x, this);
        }
    }
