...
public final class LongMath {
    ...
    static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, Ascii.DLE, Ascii.DLE, Ascii.DLE, Ascii.f260SI, Ascii.f260SI, Ascii.f260SI, Ascii.f260SI, Ascii.f261SO, Ascii.f261SO, Ascii.f261SO, Ascii.f251CR, Ascii.f251CR, Ascii.f251CR, Ascii.f253FF, Ascii.f253FF, Ascii.f253FF, Ascii.f253FF, Ascii.f264VT, Ascii.f264VT, Ascii.f264VT, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    static final long[] powersOf10 = {1, 10, 100, 1000, Renderer.DEFAULT_DURATION_TO_PROGRESS_US, SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US, 1000000, 10000000, 100000000, C0366C.NANOS_PER_SECOND, 10000000000L, 100000000000L, MediaPeriodQueue.INITIAL_RENDERER_POSITION_OFFSET_US, 10000000000000L, 100000000000000L, 1000000000000000L, 10000000000000000L, 100000000000000000L, 1000000000000000000L};
    ...
    public static int log2(long x, RoundingMode mode) {
        MathPreconditions.checkPositive("x", x);
        switch (C15581.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
            case 1:
    ...
    public static long sqrt(long j, RoundingMode roundingMode) {
        ...
        long j2 = sqrt * sqrt;
        switch (C15581.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    private enum MillerRabinTester {
        ...
        /* synthetic */ MillerRabinTester(C15581 c15581) {
            this();
        }
    ...
    public static double roundToDouble(long x, RoundingMode mode) {
        ...
        switch (C15581.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
            ...
            case 8:
                ...
                int i = C15581.$SwitchMap$java$math$RoundingMode[mode.ordinal()];
                if (i == 6) {
                    return x >= 0 ? d2 : d;
                }
                if (i == 7) {
