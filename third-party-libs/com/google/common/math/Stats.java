...
public final class Stats implements Serializable {
    ...
    /* renamed from: of */
    public static Stats m522of(Iterable<? extends Number> values) {
    ...
    /* renamed from: of */
    public static Stats m523of(Iterator<? extends Number> values) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
        statsAccumulator.addAll(values);
        return statsAccumulator.snapshot();
    }
    ...
    /* renamed from: of */
    public static Stats m524of(double... values) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
        statsAccumulator.addAll(values);
        return statsAccumulator.snapshot();
    }
    ...
    /* renamed from: of */
    public static Stats m525of(int... values) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
        statsAccumulator.addAll(values);
        return statsAccumulator.snapshot();
    }
    ...
    /* renamed from: of */
    public static Stats m526of(long... values) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
        statsAccumulator.addAll(values);
        return statsAccumulator.snapshot();
    }
