...
public abstract class ByteSource {
    ...
    private final class SlicedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            if (sizeIfKnown.isPresent()) {
                ...
                return Optional.m366of(Long.valueOf(Math.min(this.length, longValue - Math.min(this.offset, longValue))));
            }
            return Optional.absent();
        }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        @Override // com.google.common.p004io.ByteSource
        public Optional<Long> sizeIfKnown() {
            return Optional.m366of(Long.valueOf(this.length));
        }
    ...
    private static final class ConcatenatedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            while (it.hasNext()) {
                ...
                if (j < 0) {
                    return Optional.m366of(Long.MAX_VALUE);
                }
            }
            return Optional.m366of(Long.valueOf(j));
        }
