...
public final class ClassPath {
    ...
    private static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m373on(" ").omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m552of(File file, String resourceName, ClassLoader loader) {
        ...
        private void scanJarFile(JarFile file, ImmutableSet.Builder<ResourceInfo> builder) {
            ...
            while (entries.hasMoreElements()) {
                ...
                if (!nextElement.isDirectory() && !nextElement.getName().equals("META-INF/MANIFEST.MF")) {
                    builder.add((ImmutableSet.Builder<ResourceInfo>) ResourceInfo.m552of(new File(file.getName()), nextElement.getName(), this.classloader));
                }
            }
        }
            ...
            for (File file : listFiles) {
                ...
                if (file.isDirectory()) {
                    ...
                    if (!str.equals("META-INF/MANIFEST.MF")) {
                        builder.add((ImmutableSet.Builder<ResourceInfo>) ResourceInfo.m552of(file, str, this.classloader));
                    }
                }
            }
        }
    ...
    static ImmutableList<URL> parseJavaClassPath() {
        ...
        for (String str : Splitter.m373on(StandardSystemProperty.PATH_SEPARATOR.value()).split(StandardSystemProperty.JAVA_CLASS_PATH.value())) {
            try {
                try {
