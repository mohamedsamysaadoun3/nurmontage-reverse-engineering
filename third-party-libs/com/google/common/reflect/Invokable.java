...
public abstract class Invokable<T, R> implements AnnotatedElement, Member {
    ...
    public final TypeToken<? extends R> getReturnType() {
        return (TypeToken<? extends R>) TypeToken.m556of(getGenericReturnType());
    }
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        for (int i = 0; i < genericParameterTypes.length; i++) {
            builder.add((ImmutableList.Builder) new Parameter(this, i, TypeToken.m556of(genericParameterTypes[i]), parameterAnnotations[i], objArr[i]));
        }
    ...
    public final ImmutableList<TypeToken<? extends Throwable>> getExceptionTypes() {
        ...
        for (Type type : getGenericExceptionTypes()) {
            builder.add((ImmutableList.Builder) TypeToken.m556of(type));
        }
        return builder.build();
    }

    public final <R1 extends R> Invokable<T, R1> returning(Class<R1> returnType) {
        return returning(TypeToken.m555of((Class) returnType));
    }
    ...
    public TypeToken<T> getOwnerType() {
        return TypeToken.m555of((Class) getDeclaringClass());
    }
