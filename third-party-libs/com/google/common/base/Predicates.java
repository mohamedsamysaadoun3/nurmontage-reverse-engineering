...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m369or(Iterable<? extends Predicate<? super T>> components) {
        return new OrPredicate(defensiveCopy(components));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m370or(Predicate<? super T>... components) {
        return new OrPredicate(defensiveCopy(components));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m368or(Predicate<? super T> first, Predicate<? super T> second) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m367in(Collection<? extends T> target) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        private CompositionPredicate(Predicate<B> p, Function<A, ? extends B> f) {
            this.f268p = (Predicate) Preconditions.checkNotNull(p);
            this.f267f = (Function) Preconditions.checkNotNull(f);
        }
