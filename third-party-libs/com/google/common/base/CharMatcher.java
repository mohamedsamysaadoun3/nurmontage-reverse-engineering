...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m362is(final char match) {
        return new C1230Is(match);
    }
    ...
    public static CharMatcher anyOf(final CharSequence sequence) {
        ...
        if (length == 1) {
            return m362is(sequence.charAt(0));
        }
        if (length == 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo363or(CharMatcher other) {
        return new C1231Or(this, other);
    }
    ...
    private static CharMatcher precomputedPositive(int totalCharacters, BitSet table, String description) {
        ...
        if (totalCharacters == 1) {
            return m362is((char) table.nextSetBit(0));
        }
    ...
    private static final class C1231Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C1231Or(CharMatcher a, CharMatcher b) {
            this.first = (CharMatcher) Preconditions.checkNotNull(a);
            this.second = (CharMatcher) Preconditions.checkNotNull(b);
        }
    ...
    private static final class C1230Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo363or(CharMatcher other) {
            return other.matches(this.match) ? other : super.mo363or(other);
        }
