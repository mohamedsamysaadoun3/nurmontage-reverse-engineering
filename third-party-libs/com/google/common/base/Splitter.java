...
public final class Splitter {
    ...
    /* renamed from: on */
    public static Splitter m371on(char separator) {
        return m372on(CharMatcher.m362is(separator));
    }

    /* renamed from: on */
    public static Splitter m372on(final CharMatcher separatorMatcher) {
    ...
    /* renamed from: on */
    public static Splitter m373on(final String separator) {
        Preconditions.checkArgument(separator.length() != 0, "The separator may not be the empty string.");
        if (separator.length() == 1) {
            return m371on(separator.charAt(0));
        }
    ...
    /* renamed from: on */
    public static Splitter m374on(Pattern separatorPattern) {
    ...
    public Iterable<String> split(final CharSequence sequence) {
        ...
        return new Iterable<String>(this) { // from class: com.google.common.base.Splitter.5
            ...
            public String toString() {
                return Joiner.m365on(", ").appendTo(new StringBuilder().append('['), (Iterable<? extends Object>) this).append(']').toString();
            }
        };
    }
    ...
    public MapSplitter withKeyValueSeparator(String separator) {
        return withKeyValueSeparator(m373on(separator));
    }

    public MapSplitter withKeyValueSeparator(char separator) {
        return withKeyValueSeparator(m371on(separator));
    }
