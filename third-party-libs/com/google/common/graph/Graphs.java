...
public final class Graphs extends GraphsBridgeMethods {
    ...
    static class TransposedGraph<N> extends ForwardingGraph<N> {
        ...
        class C15001 extends IncidentEdgeSet<N> {
            C15001(BaseGraph graph, Object node) {
                super(graph, node);
            }
            ...
            public Iterator<EndpointPair<N>> iterator() {
                return Iterators.transform(TransposedGraph.this.delegate().incidentEdges(this.node).iterator(), new Function() { // from class: com.google.common.graph.Graphs$TransposedGraph$1$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return Graphs.TransposedGraph.C15001.this.m516x5749e417((EndpointPair) obj);
                    }
                });
            }

            /* renamed from: lambda$iterator$0$com-google-common-graph-Graphs$TransposedGraph$1 */
            /* synthetic */ EndpointPair m516x5749e417(EndpointPair endpointPair) {
                return EndpointPair.m513of((Graph<?>) TransposedGraph.this.delegate(), endpointPair.nodeV(), endpointPair.nodeU());
            }
        }

        @Override // com.google.common.graph.ForwardingGraph, com.google.common.graph.AbstractGraph, com.google.common.graph.AbstractBaseGraph, com.google.common.graph.BaseGraph
        public Set<EndpointPair<N>> incidentEdges(N node) {
            return new C15001(this, node);
        }
    ...
    private static class TransposedNetwork<N, E> extends ForwardingNetwork<N, E> {
        ...
        public EndpointPair<N> incidentNodes(E edge) {
            ...
            return EndpointPair.m514of((Network<?, ?>) this.network, (Object) incidentNodes.nodeV(), (Object) incidentNodes.nodeU());
        }
