...
final class DirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    /* renamed from: of */
    static <N, V> DirectedGraphConnections<N, V> m510of(ElementOrder<N> incidentEdgeOrder) {
        ArrayList arrayList;
        int i = C14965.$SwitchMap$com$google$common$graph$ElementOrder$Type[incidentEdgeOrder.type().ordinal()];
        if (i == 1) {
            arrayList = null;
        } else if (i == 2) {
