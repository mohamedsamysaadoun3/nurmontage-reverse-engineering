...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    class C14891 extends AbstractGraph<N> {
        ...
        class AnonymousClass1 extends AbstractSet<EndpointPair<N>> {
            ...
            public Iterator<EndpointPair<N>> iterator() {
                return Iterators.transform(AbstractNetwork.this.edges().iterator(), new Function() { // from class: com.google.common.graph.AbstractNetwork$1$1$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return AbstractNetwork.C14891.AnonymousClass1.this.m890lambda$iterator$0$comgooglecommongraphAbstractNetwork$1$1(obj);
                    }
                });
            }

            /* renamed from: lambda$iterator$0$com-google-common-graph-AbstractNetwork$1$1, reason: not valid java name */
            /* synthetic */ EndpointPair m890lambda$iterator$0$comgooglecommongraphAbstractNetwork$1$1(Object obj) {
            ...
            public boolean contains(@CheckForNull Object obj) {
                ...
                return C14891.this.isOrderingCompatible(endpointPair) && C14891.this.nodes().contains(endpointPair.nodeU()) && C14891.this.successors((C14891) endpointPair.nodeU()).contains(endpointPair.nodeV());
            }
        }
    ...
    public Set<E> adjacentEdges(E e) {
        ...
        return (Set<E>) edgeInvalidatableSet(Sets.difference(Sets.union(incidentEdges(incidentNodes.nodeU()), incidentEdges(incidentNodes.nodeV())), ImmutableSet.m441of((Object) e)), e);
    }
    ...
    protected final <T> Set<T> edgeInvalidatableSet(Set<T> set, final E edge) {
        return InvalidatableSet.m517of((Set) set, (Supplier<Boolean>) new Supplier() { // from class: com.google.common.graph.AbstractNetwork$$ExternalSyntheticLambda4
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return AbstractNetwork.this.m507xa0c212f3(edge);
            }
    ...
    /* renamed from: lambda$edgeInvalidatableSet$0$com-google-common-graph-AbstractNetwork */
    /* synthetic */ Boolean m507xa0c212f3(Object obj) {
        return Boolean.valueOf(edges().contains(obj));
    }

    protected final <T> Set<T> nodeInvalidatableSet(Set<T> set, final N node) {
        return InvalidatableSet.m517of((Set) set, (Supplier<Boolean>) new Supplier() { // from class: com.google.common.graph.AbstractNetwork$$ExternalSyntheticLambda0
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return AbstractNetwork.this.m508xe136d8fa(node);
            }
    ...
    /* renamed from: lambda$nodeInvalidatableSet$2$com-google-common-graph-AbstractNetwork */
    /* synthetic */ Boolean m508xe136d8fa(Object obj) {
    ...
    protected final <T> Set<T> nodePairInvalidatableSet(Set<T> set, final N nodeU, final N nodeV) {
        return InvalidatableSet.m517of((Set) set, (Supplier<Boolean>) new Supplier() { // from class: com.google.common.graph.AbstractNetwork$$ExternalSyntheticLambda2
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return AbstractNetwork.this.m509xa62961f6(nodeU, nodeV);
            }
    ...
    /* renamed from: lambda$nodePairInvalidatableSet$4$com-google-common-graph-AbstractNetwork */
    /* synthetic */ Boolean m509xa62961f6(Object obj, Object obj2) {
