...
final class UndirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    /* renamed from: of */
    static <N, V> UndirectedGraphConnections<N, V> m518of(ElementOrder<N> incidentEdgeOrder) {
        int i = C15151.$SwitchMap$com$google$common$graph$ElementOrder$Type[incidentEdgeOrder.type().ordinal()];
        if (i == 1) {
