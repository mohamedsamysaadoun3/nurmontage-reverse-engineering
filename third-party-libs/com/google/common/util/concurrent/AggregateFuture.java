...
abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
    ...
    final void init() {
        ...
        if (this.allMustSucceed) {
            ...
            while (it.hasNext()) {
                ...
                int i2 = i + 1;
                if (next.isDone()) {
                    m892lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(i, next);
                } else {
                    next.addListener(new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            AggregateFuture.this.m892lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(i, next);
                        }
        ...
        Runnable runnable = new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                AggregateFuture.this.m893lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(immutableCollection);
            }
        };
        ...
        while (it2.hasNext()) {
            ...
            if (next2.isDone()) {
                m893lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(immutableCollection);
            } else {
    ...
    public void m892lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(int index, ListenableFuture<? extends InputT> future) {
        try {
            ...
            m893lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(null);
        }
    }
    ...
    public void m893lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(@CheckForNull ImmutableCollection<? extends Future<? extends InputT>> futuresIfNeedToCollectAtCompletion) {
