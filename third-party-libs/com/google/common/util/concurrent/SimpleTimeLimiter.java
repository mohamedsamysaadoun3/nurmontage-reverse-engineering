...
public final class SimpleTimeLimiter implements TimeLimiter {
    ...
    public <T> T newProxy(T t, Class<T> cls, long j, TimeUnit timeUnit) {
        ...
        return (T) newProxy(cls, new C16561(this, t, j, timeUnit, findInterruptibleMethods(cls)));
    }

    /* renamed from: com.google.common.util.concurrent.SimpleTimeLimiter$1 */
    class C16561 implements InvocationHandler {
        ...
        C16561(final SimpleTimeLimiter this$0, final Object val$target, final long val$timeoutDuration, final TimeUnit val$timeoutUnit, final Set val$interruptibleMethods) {
        ...
        public Object invoke(Object obj, final Method method, @CheckForNull final Object[] args) throws Throwable {
            ...
            return this.this$0.callWithTimeout(new Callable() { // from class: com.google.common.util.concurrent.SimpleTimeLimiter$1$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return SimpleTimeLimiter.C16561.lambda$invoke$0(method, obj2, args);
                }
