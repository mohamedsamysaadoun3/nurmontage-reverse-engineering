...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        boolean casWaiters(AbstractFuture<?> future, @CheckForNull Waiter expect, @CheckForNull Waiter update) {
            return zzea$$ExternalSyntheticBackportWithForwarding0.m282m(UNSAFE, future, WAITERS_OFFSET, expect, update);
        }

        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casListeners(AbstractFuture<?> future, @CheckForNull Listener expect, Listener update) {
            return zzea$$ExternalSyntheticBackportWithForwarding0.m282m(UNSAFE, future, LISTENERS_OFFSET, expect, update);
        }
        ...
        boolean casValue(AbstractFuture<?> future, @CheckForNull Object expect, Object update) {
            return zzea$$ExternalSyntheticBackportWithForwarding0.m282m(UNSAFE, future, VALUE_OFFSET, expect, update);
        }
    }
    ...
    private static final class SafeAtomicHelper extends AtomicHelper {
        ...
        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casWaiters(AbstractFuture<?> future, @CheckForNull Waiter expect, @CheckForNull Waiter update) {
            return C0127xc40028dd.m6m(this.waitersUpdater, future, expect, update);
        }

        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casListeners(AbstractFuture<?> future, @CheckForNull Listener expect, Listener update) {
            return C0127xc40028dd.m6m(this.listenersUpdater, future, expect, update);
        }
        ...
        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casValue(AbstractFuture<?> future, @CheckForNull Object expect, Object update) {
            return C0127xc40028dd.m6m(this.valueUpdater, future, expect, update);
        }
    }
