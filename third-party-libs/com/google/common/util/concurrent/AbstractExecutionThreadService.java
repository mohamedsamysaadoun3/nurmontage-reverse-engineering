...
public abstract class AbstractExecutionThreadService implements Service {
    ...
    private final Service delegate = new C15941();
    ...
    class C15941 extends AbstractService {
        C15941() {
        }
        ...
        protected final void doStart() {
            MoreExecutors.renamingDecorator(AbstractExecutionThreadService.this.executor(), (Supplier<String>) new Supplier() { // from class: com.google.common.util.concurrent.AbstractExecutionThreadService$1$$ExternalSyntheticLambda0
                ...
                public final Object get() {
                    return AbstractExecutionThreadService.C15941.this.m558xa0f821c5();
                }
                ...
                public final void run() {
                    AbstractExecutionThreadService.C15941.this.m559x3d661e24();
                }
            });
        }

        /* renamed from: lambda$doStart$0$com-google-common-util-concurrent-AbstractExecutionThreadService$1 */
        /* synthetic */ String m558xa0f821c5() {
            return AbstractExecutionThreadService.this.serviceName();
        }

        /* renamed from: lambda$doStart$1$com-google-common-util-concurrent-AbstractExecutionThreadService$1 */
        /* synthetic */ void m559x3d661e24() {
            try {
    ...
    protected Executor executor() {
        return new Executor() { // from class: com.google.common.util.concurrent.AbstractExecutionThreadService$$ExternalSyntheticLambda0
            ...
            public final void execute(Runnable runnable) {
                AbstractExecutionThreadService.this.m557xafeb5522(runnable);
            }
        };
    }

    /* renamed from: lambda$executor$0$com-google-common-util-concurrent-AbstractExecutionThreadService */
    /* synthetic */ void m557xafeb5522(Runnable runnable) {
