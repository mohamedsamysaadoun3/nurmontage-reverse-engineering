...
public abstract class AbstractService implements Service {
    ...
    public final Service stopAsync() {
        if (this.monitor.enterIf(this.isStoppable)) {
            try {
                ...
                switch (C16106.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()]) {
                    case 1:
    ...
    protected final void notifyFailed(Throwable cause) {
        ...
        try {
            Service.State state = state();
            int i = C16106.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()];
            if (i != 1) {
                if (i == 2 || i == 3 || i == 4) {
    ...
    private void enqueueTerminatedEvent(final Service.State from) {
        switch (C16106.$SwitchMap$com$google$common$util$concurrent$Service$State[from.ordinal()]) {
            case 1:
