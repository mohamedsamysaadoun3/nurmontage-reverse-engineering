...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.m371on(FilenameUtils.EXTENSION_SEPARATOR);
    private static final Joiner DOT_JOINER = Joiner.m364on(FilenameUtils.EXTENSION_SEPARATOR);
    ...
    static {
        ...
        CharMatcher mo363or = CharMatcher.inRange('a', 'z').mo363or(CharMatcher.inRange('A', 'Z'));
        LETTER_MATCHER = mo363or;
        PART_CHAR_MATCHER = inRange.mo363or(mo363or).mo363or(anyOf);
    }
    ...
    private int registrySuffixIndex() {
        ...
        int findSuffixOfType = findSuffixOfType(Optional.m366of(PublicSuffixType.REGISTRY));
