...
public final class MediaType {
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m407of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(StandardCharsets.UTF_8.name()));
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m365on("; ").withKeyValueSeparator("=");

    private static MediaType createConstant(String type, String subtype) {
        MediaType addKnownType = addKnownType(new MediaType(type, subtype, ImmutableListMultimap.m406of()));
    ...
    private static MediaType createConstantUtf8(String type, String subtype) {
        ...
        addKnownType.parsedCharset = Optional.m366of(StandardCharsets.UTF_8);
        return addKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                String next = it.next();
                if (str == null) {
                    optional = Optional.m366of(Charset.forName(next));
                    str = next;
    ...
    public MediaType withParameter(String attribute, String value) {
        return withParameters(attribute, ImmutableSet.m441of(value));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType withParameter = withParameter(CHARSET_ATTRIBUTE, charset.name());
        withParameter.parsedCharset = Optional.m366of(charset);
    ...
    /* renamed from: is */
    public boolean m527is(MediaType mediaTypeRange) {
    ...
    public static MediaType create(String type, String subtype) {
        MediaType create = create(type, subtype, ImmutableListMultimap.m406of());
