...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m371on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m371on('=').trimResults();
    ...
    CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C12581.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] == 1) {
                newBuilder.weakKeys();
            } else {
        ...
        if (this.valueStrength != null) {
            int i = C12581.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.valueStrength.ordinal()];
            if (i == 1) {
