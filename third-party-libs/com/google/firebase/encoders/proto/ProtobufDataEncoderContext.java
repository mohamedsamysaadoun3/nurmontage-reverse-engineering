...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    static /* synthetic */ class C16651 {
        ...
        static {
            ...
            try {
                f340x531607dd[Protobuf.IntEncoding.SIGNED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f340x531607dd[Protobuf.IntEncoding.FIXED.ordinal()] = 3;
    ...
    ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        ...
        int i2 = C16651.f340x531607dd[protobuf.intEncoding().ordinal()];
        if (i2 == 1) {
    ...
    ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        ...
        Protobuf protobuf = getProtobuf(fieldDescriptor);
        int i = C16651.f340x531607dd[protobuf.intEncoding().ordinal()];
        if (i == 1) {
            writeVarInt32(protobuf.tag() << 3);
            writeVarInt64(j);
        } else if (i == 2) {
    ...
    public ObjectEncoderContext nested(String str) throws IOException {
        return nested(FieldDescriptor.m568of(str));
    }
