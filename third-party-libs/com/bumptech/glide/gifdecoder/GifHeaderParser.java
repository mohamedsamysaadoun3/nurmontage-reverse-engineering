...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f161ix = readShort();
        this.header.currentFrame.f162iy = readShort();
        this.header.currentFrame.f160iw = readShort();
        this.header.currentFrame.f159ih = readShort();
        int read = read();
