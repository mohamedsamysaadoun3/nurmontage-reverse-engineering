...
public final class RoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f178ID = "com.bumptech.glide.load.resource.bitmap.RoundedCorners";
    ...
    @Override // com.bumptech.glide.load.Key
    public int hashCode() {
        return Util.hashCode(f178ID.hashCode(), Util.hashCode(this.roundingRadius));
    }
