...
public final class GranularRoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f176ID = "com.bumptech.glide.load.resource.bitmap.GranularRoundedCorners";
    ...
    @Override // com.bumptech.glide.load.Key
    public int hashCode() {
        return Util.hashCode(this.bottomLeft, Util.hashCode(this.bottomRight, Util.hashCode(this.topRight, Util.hashCode(f176ID.hashCode(), Util.hashCode(this.topLeft)))));
    }
