...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f156CR = 13;

    /* renamed from: LF */
    private static final byte f157LF = 10;
    private byte[] buf;
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f158in;
        byte[] bArr = this.buf;
