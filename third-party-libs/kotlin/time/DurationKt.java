...
public final class DurationKt {
    ...
    private static final long m3111timesmvk6XK0(int i, long j) {
        return Duration.m3022timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m3110timeskIfJnKk(double d, long j) {
        return Duration.m3021timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m3087getZEROUwyO8pc = Duration.INSTANCE.m3087getZEROUwyO8pc();
        ...
        if (str.charAt(i) == 'P') {
            ...
            while (i2 < length) {
                if (str.charAt(i2) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        long m3020plusLRDsOJo = Duration.m3020plusLRDsOJo(m3087getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "substring(...)");
                        m3087getZEROUwyO8pc = Duration.m3020plusLRDsOJo(m3020plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        m3087getZEROUwyO8pc = Duration.m3020plusLRDsOJo(m3087getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, i, "Infinity", 0, Math.max(length - i, "Infinity".length()), true)) {
                m3087getZEROUwyO8pc = Duration.INSTANCE.m3085getINFINITEUwyO8pc();
            } else {
                boolean z7 = !z4;
                ...
                while (i < length) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m3020plusLRDsOJo2 = Duration.m3020plusLRDsOJo(m3087getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "substring(...)");
                        m3087getZEROUwyO8pc = Duration.m3020plusLRDsOJo(m3020plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m3087getZEROUwyO8pc = Duration.m3020plusLRDsOJo(m3087getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
                    str4 = str6;
        ...
        return z2 ? Duration.m3037unaryMinusUwyO8pc(m3087getZEROUwyO8pc) : m3087getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m2984constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m2984constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m2984constructorimpl((j << 1) + i);
    }
