...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        if (0 > j || j > 2147483647L) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m1878toStringimpl(ULong.m1832constructorimpl(j))));
        }
        return (int) j;
    }
    ...
    */
    ...
    public static final String toHexString(byte b, HexFormat format) {
        ...
        if (number.getIsDigitsOnlyAndNoPadding()) {
            char[] cArr = {str.charAt((b >> 4) & 15), str.charAt(b & Ascii.f260SI)};
