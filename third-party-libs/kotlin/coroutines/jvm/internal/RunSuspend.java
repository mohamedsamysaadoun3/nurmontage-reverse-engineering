...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m2863getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m1657boximpl(result);
