...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo866clone = transition.mo866clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo866clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo866clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo866clone);
    }
    ...
    /* renamed from: go */
    public static void m223go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m224go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo866clone = transition.mo866clone();
        sceneChangeSetup(viewGroup, mo866clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo866clone);
    }
