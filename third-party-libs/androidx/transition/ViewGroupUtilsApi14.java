...
class ViewGroupUtilsApi14 {
    ...
    */
    static void suppressLayout(ViewGroup viewGroup, boolean z) {
        ...
        if (z) {
            ...
            if (layoutTransition3 != null) {
                ...
                if (layoutTransition3 != sEmptyLayoutTransition) {
                    viewGroup.setTag(C0734R.id.transition_layout_save, layoutTransition3);
                }
            }
            ...
            try {
                ...
                if (z3) {
                    try {
                        ...
                        layoutTransition = (LayoutTransition) viewGroup.getTag(C0734R.id.transition_layout_save);
        ...
        layoutTransition = (LayoutTransition) viewGroup.getTag(C0734R.id.transition_layout_save);
        if (layoutTransition == null) {
            viewGroup.setTag(C0734R.id.transition_layout_save, null);
