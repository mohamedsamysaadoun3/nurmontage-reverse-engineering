...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0030R.styleable.ActivityChooserView, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0030R.styleable.ActivityChooserView, attributeSet, obtainStyledAttributes, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C0030R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0030R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0030R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View findViewById = findViewById(C0030R.id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0030R.id.default_activity_button);
        ...
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(C0030R.id.image);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0030R.id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) frameLayout2.findViewById(C0030R.id.image);
    ...
    void showPopupUnchecked(int i) {
        ...
        listPopupWindow.getListView().setContentDescription(getContext().getString(C0030R.string.abc_activitychooserview_choose_application));
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ...
                    View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0030R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    inflate.setId(1);
                    ((TextView) inflate.findViewById(C0030R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0030R.string.abc_activity_chooser_view_see_all));
                    return inflate;
                }
                throw new IllegalArgumentException();
            }
            if (view == null || view.getId() != C0030R.id.list_item) {
                view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0030R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
            }
            PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
            ImageView imageView = (ImageView) view.findViewById(C0030R.id.icon);
            ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
            imageView.setImageDrawable(resolveInfo.loadIcon(packageManager));
            ((TextView) view.findViewById(C0030R.id.title)).setText(resolveInfo.loadLabel(packageManager));
