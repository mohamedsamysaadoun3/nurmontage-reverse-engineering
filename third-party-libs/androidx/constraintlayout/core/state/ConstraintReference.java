...
public class ConstraintReference implements Reference {
    ...
    public ConstraintReference bias(float f) {
        ...
        int i = C01381.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[this.mLast.ordinal()];
        if (i != 17) {
            if (i != 18) {
                switch (i) {
                }
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        int i = C01381.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()];
        switch (C01381.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
            case 1:
