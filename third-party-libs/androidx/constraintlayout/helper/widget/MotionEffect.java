...
public class MotionEffect extends MotionHelper {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0172R.styleable.MotionEffect);
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == C0172R.styleable.MotionEffect_motionEffect_start) {
                ...
                } else if (index == C0172R.styleable.MotionEffect_motionEffect_end) {
