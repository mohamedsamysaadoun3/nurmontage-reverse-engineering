...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintBaseline_toTopOf, BASELINE_TO_TOP);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintBaseline_toBottomOf, BASELINE_TO_BOTTOM);
        ...
        mapToConstant.append(C0172R.styleable.Constraint_guidelineUseRtl, GUIDELINE_USE_RTL);
        ...
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintLeft_creator, UNUSED);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintTop_creator, UNUSED);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintRight_creator, UNUSED);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintBottom_creator, UNUSED);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintBaseline_creator, UNUSED);
        ...
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintWidth, LAYOUT_CONSTRAINT_WIDTH);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintHeight, LAYOUT_CONSTRAINT_HEIGHT);
        ...
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintWidth_max, WIDTH_MAX);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintHeight_max, HEIGHT_MAX);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintWidth_min, WIDTH_MIN);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintHeight_min, HEIGHT_MIN);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintCircle, 61);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintCircleRadius, CIRCLE_RADIUS);
        ...
        mapToConstant.append(C0172R.styleable.Constraint_motionStagger, MOTION_STAGGER);
        mapToConstant.append(C0172R.styleable.Constraint_android_id, 38);
        mapToConstant.append(C0172R.styleable.Constraint_motionProgress, PROGRESS);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintWidth_percent, WIDTH_PERCENT);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintHeight_percent, HEIGHT_PERCENT);
        mapToConstant.append(C0172R.styleable.Constraint_layout_wrapBehaviorInParent, LAYOUT_WRAP_BEHAVIOR);
        mapToConstant.append(C0172R.styleable.Constraint_chainUseRtl, 71);
        mapToConstant.append(C0172R.styleable.Constraint_barrierDirection, BARRIER_DIRECTION);
        mapToConstant.append(C0172R.styleable.Constraint_barrierMargin, BARRIER_MARGIN);
        mapToConstant.append(C0172R.styleable.Constraint_constraint_referenced_ids, CONSTRAINT_REFERENCED_IDS);
        ...
        mapToConstant.append(C0172R.styleable.Constraint_layout_constraintTag, CONSTRAINT_TAG);
        mapToConstant.append(C0172R.styleable.Constraint_visibilityMode, 78);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constrainedWidth, CONSTRAINED_WIDTH);
        mapToConstant.append(C0172R.styleable.Constraint_layout_constrainedHeight, CONSTRAINED_HEIGHT);
        mapToConstant.append(C0172R.styleable.Constraint_polarRelativeTo, ANIMATE_CIRCLE_ANGLE_TO);
        mapToConstant.append(C0172R.styleable.Constraint_transformPivotTarget, TRANSFORM_PIVOT_TARGET);
        mapToConstant.append(C0172R.styleable.Constraint_quantizeMotionSteps, QUANTIZE_MOTION_STEPS);
        mapToConstant.append(C0172R.styleable.Constraint_quantizeMotionPhase, QUANTIZE_MOTION_PHASE);
        mapToConstant.append(C0172R.styleable.Constraint_quantizeMotionInterpolator, QUANTIZE_MOTION_INTERPOLATOR);
        ...
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintLeft_creator, UNUSED);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintTop_creator, UNUSED);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintRight_creator, UNUSED);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintBottom_creator, UNUSED);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintBaseline_creator, UNUSED);
        ...
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintWidth, LAYOUT_CONSTRAINT_WIDTH);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintHeight, LAYOUT_CONSTRAINT_HEIGHT);
        ...
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintWidth_max, WIDTH_MAX);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintHeight_max, HEIGHT_MAX);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintWidth_min, WIDTH_MIN);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintHeight_min, HEIGHT_MIN);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintCircleRadius, CIRCLE_RADIUS);
        ...
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_motionStagger, MOTION_STAGGER);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_android_id, 38);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_motionTarget, MOTION_TARGET);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_motionProgress, PROGRESS);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintWidth_percent, WIDTH_PERCENT);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintHeight_percent, HEIGHT_PERCENT);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_chainUseRtl, 71);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_barrierDirection, BARRIER_DIRECTION);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_barrierMargin, BARRIER_MARGIN);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_constraint_referenced_ids, CONSTRAINT_REFERENCED_IDS);
        ...
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constraintTag, CONSTRAINT_TAG);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_visibilityMode, 78);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constrainedWidth, CONSTRAINED_WIDTH);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_constrainedHeight, CONSTRAINED_HEIGHT);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_polarRelativeTo, ANIMATE_CIRCLE_ANGLE_TO);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_transformPivotTarget, TRANSFORM_PIVOT_TARGET);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_quantizeMotionSteps, QUANTIZE_MOTION_STEPS);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_quantizeMotionPhase, QUANTIZE_MOTION_PHASE);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_quantizeMotionInterpolator, QUANTIZE_MOTION_INTERPOLATOR);
        overrideMapToConstant.append(C0172R.styleable.ConstraintOverride_layout_wrapBehaviorInParent, LAYOUT_WRAP_BEHAVIOR);
    }
    ...
    */
    ...
    public static class Layout {
        ...
        static {
            ...
            mapToConstant.append(C0172R.styleable.Layout_guidelineUseRtl, 90);
            ...
            mapToConstant.append(C0172R.styleable.Layout_layout_constraintLeft_creator, UNUSED);
            mapToConstant.append(C0172R.styleable.Layout_layout_constraintTop_creator, UNUSED);
            mapToConstant.append(C0172R.styleable.Layout_layout_constraintRight_creator, UNUSED);
            mapToConstant.append(C0172R.styleable.Layout_layout_constraintBottom_creator, UNUSED);
            mapToConstant.append(C0172R.styleable.Layout_layout_constraintBaseline_creator, UNUSED);
            ...
            mapToConstant.append(C0172R.styleable.Layout_layout_wrapBehaviorInParent, 76);
            mapToConstant.append(C0172R.styleable.Layout_layout_constraintCircle, 61);
            mapToConstant.append(C0172R.styleable.Layout_layout_constraintCircleRadius, CIRCLE_RADIUS);
            mapToConstant.append(C0172R.styleable.Layout_layout_constraintCircleAngle, 63);
            mapToConstant.append(C0172R.styleable.Layout_layout_constraintWidth_percent, WIDTH_PERCENT);
            mapToConstant.append(C0172R.styleable.Layout_layout_constraintHeight_percent, HEIGHT_PERCENT);
            mapToConstant.append(C0172R.styleable.Layout_chainUseRtl, 71);
            mapToConstant.append(C0172R.styleable.Layout_barrierDirection, BARRIER_DIRECTION);
            mapToConstant.append(C0172R.styleable.Layout_barrierMargin, BARRIER_MARGIN);
            mapToConstant.append(C0172R.styleable.Layout_constraint_referenced_ids, CONSTRAINT_REFERENCED_IDS);
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0172R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Transform {
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0172R.styleable.Transform);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class PropertySet {
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0172R.styleable.PropertySet);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == C0172R.styleable.PropertySet_android_alpha) {
                    this.alpha = obtainStyledAttributes.getFloat(index, this.alpha);
                } else if (index == C0172R.styleable.PropertySet_android_visibility) {
                    this.visibility = obtainStyledAttributes.getInt(index, this.visibility);
                    this.visibility = ConstraintSet.VISIBILITY_FLAGS[this.visibility];
                } else if (index == C0172R.styleable.PropertySet_visibilityMode) {
                    this.mVisibilityMode = obtainStyledAttributes.getInt(index, this.mVisibilityMode);
                } else if (index == C0172R.styleable.PropertySet_motionProgress) {
    ...
    public static class Motion {
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0172R.styleable.Motion);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer num : set.mConstraints.keySet()) {
            Constraint constraint = set.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m766clone());
            }
        }
    }
    ...
    */
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attrs, boolean override) {
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, override ? C0172R.styleable.ConstraintOverride : C0172R.styleable.Constraint);
    ...
    public static Constraint buildDelta(Context context, XmlPullParser parser) {
        ...
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(asAttributeSet, C0172R.styleable.ConstraintOverride);
    ...
    private void populateConstraint(Context ctx, Constraint c, TypedArray a, boolean override) {
        ...
        for (int i = 0; i < indexCount; i++) {
            int index = a.getIndex(i);
            if (index != C0172R.styleable.Constraint_android_id && C0172R.styleable.Constraint_android_layout_marginStart != index && C0172R.styleable.Constraint_android_layout_marginEnd != index) {
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0172R.id.class.getField(trim).getInt(null);
