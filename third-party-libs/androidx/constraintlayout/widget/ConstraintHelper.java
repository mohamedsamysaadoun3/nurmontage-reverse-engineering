...
public abstract class ConstraintHelper extends View {
    ...
    protected void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0172R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    String string = obtainStyledAttributes.getString(index);
                    this.mReferenceIds = string;
                    setIds(string);
                } else if (index == C0172R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    private int findId(String referenceId) {
        ...
        if (i == 0) {
            try {
                i = C0172R.id.class.getField(referenceId).getInt(null);
