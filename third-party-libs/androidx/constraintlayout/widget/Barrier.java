    ...
    protected void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0172R.styleable.ConstraintLayout_Layout_barrierDirection) {
                    setType(obtainStyledAttributes.getInt(index, 0));
                } else if (index == C0172R.styleable.ConstraintLayout_Layout_barrierAllowsGoneWidgets) {
                    this.mBarrier.setAllowsGoneWidget(obtainStyledAttributes.getBoolean(index, true));
                } else if (index == C0172R.styleable.ConstraintLayout_Layout_barrierMargin) {
