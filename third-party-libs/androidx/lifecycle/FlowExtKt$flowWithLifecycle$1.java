...
@Metadata(m667d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u008a@"}, m668d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/channels/ProducerScope;"}, m669k = 3, m670mv = {1, 8, 0}, m672xi = 48)
@DebugMetadata(m684c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1", m685f = "FlowExt.kt", m686i = {0}, m687l = {91}, m688m = "invokeSuspend", m689n = {"$this$callbackFlow"}, m690s = {"L$0"})
...
final class FlowExtKt$flowWithLifecycle$1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
    ...
    /* compiled from: FlowExt.kt */
    @Metadata(m667d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m668d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/CoroutineScope;"}, m669k = 3, m670mv = {1, 8, 0}, m672xi = 48)
    @DebugMetadata(m684c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1$1", m685f = "FlowExt.kt", m686i = {}, m687l = {92}, m688m = "invokeSuspend", m689n = {}, m690s = {})
    ...
    static final class C03401 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03401(Flow<? extends T> flow, ProducerScope<? super T> producerScope, Continuation<? super C03401> continuation) {
            super(2, continuation);
            this.$this_flowWithLifecycle = flow;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C03401(this.$this_flowWithLifecycle, this.$$this$callbackFlow, continuation);
        }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (RepeatOnLifecycleKt.repeatOnLifecycle(this.$lifecycle, this.$minActiveState, new C03401(this.$this_flowWithLifecycle, producerScope2, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
