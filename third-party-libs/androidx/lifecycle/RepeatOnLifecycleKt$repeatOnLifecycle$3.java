...
@Metadata(m667d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m668d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m669k = 3, m670mv = {1, 8, 0}, m672xi = 48)
@DebugMetadata(m684c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3", m685f = "RepeatOnLifecycle.kt", m686i = {}, m687l = {84}, m688m = "invokeSuspend", m689n = {}, m690s = {})
...
final class RepeatOnLifecycleKt$repeatOnLifecycle$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* compiled from: RepeatOnLifecycle.kt */
    @Metadata(m667d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m668d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m669k = 3, m670mv = {1, 8, 0}, m672xi = 48)
    @DebugMetadata(m684c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1", m685f = "RepeatOnLifecycle.kt", m686i = {0, 0}, m687l = {166}, m688m = "invokeSuspend", m689n = {"launchedJob", "observer"}, m690s = {"L$0", "L$1"})
    ...
    static final class C03421 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03421(Lifecycle lifecycle, Lifecycle.State state, CoroutineScope coroutineScope, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C03421> continuation) {
            super(2, continuation);
            this.$this_repeatOnLifecycle = lifecycle;
            this.$state = state;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C03421(this.$this_repeatOnLifecycle, this.$state, this.$$this$coroutineScope, this.$block, continuation);
        }
                    ...
                    objectRef4.element = new LifecycleEventObserver() { // from class: androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1
                        ...
                        public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                            ...
                            if (event == Lifecycle.Event.this) {
                                ...
                                launch$default = BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C03431(Mutex$default, function2, null), 3, null);
                            ...
                            if (event == Lifecycle.Event.ON_DESTROY) {
                                ...
                                cancellableContinuation.resumeWith(Result.m1658constructorimpl(Unit.INSTANCE));
                            }
                        }

                        /* compiled from: RepeatOnLifecycle.kt */
                        @Metadata(m667d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m668d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m669k = 3, m670mv = {1, 8, 0}, m672xi = 48)
                        @DebugMetadata(m684c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1", m685f = "RepeatOnLifecycle.kt", m686i = {0, 1}, m687l = {171, 110}, m688m = "invokeSuspend", m689n = {"$this$withLock_u24default$iv", "$this$withLock_u24default$iv"}, m690s = {"L$0", "L$0"})
                        ...
                        static final class C03431 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            ...
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            C03431(Mutex mutex, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C03431> continuation) {
                                super(2, continuation);
                                this.$mutex = mutex;
                                this.$block = function2;
                            }
                            ...
                            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                return new C03431(this.$mutex, this.$block, continuation);
                            }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C03421(this.$this_repeatOnLifecycle, this.$state, coroutineScope, this.$block, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
