...
public final class AdPlaybackState {
    ...
    public static final AdPlaybackState NONE = new AdPlaybackState(null, new AdGroup[0], 0, C0366C.TIME_UNSET, 0);
    ...
    public static final class AdGroup {
        ...
        private static long[] copyDurationsUsWithSpaceForAdCount(long[] jArr, int i) {
            ...
            Arrays.fill(copyOf, length, max, C0366C.TIME_UNSET);
            return copyOf;
        }
    ...
    public AdPlaybackState(Object obj, long... jArr) {
        this(obj, createEmptyAdGroups(jArr), 0L, C0366C.TIME_UNSET, 0);
    }
    ...
    public int getAdGroupIndexAfterPositionUs(long j, long j2) {
        ...
        if (j2 == C0366C.TIME_UNSET || getAdGroup(i).timeUs <= j2) {
            return i;
        }
        return -1;
    }
    ...
    private boolean isPositionBeforeAdGroup(long j, long j2, int i) {
        ...
        return j3 == Long.MIN_VALUE ? j2 == C0366C.TIME_UNSET || adGroup.isLivePostrollPlaceholder() || j < j2 : j < j3;
    }
