...
public final class MediaItem {
    ...
    public static final class Builder {
        ...
        public Builder setSubtitles(List<Subtitle> list) {
            this.subtitleConfigurations = list != null ? ImmutableList.copyOf((Collection) list) : ImmutableList.m393of();
            return this;
        }
    ...
    public static final class DrmConfiguration {
        ...
        public static final class Builder {
            ...
            @Deprecated
            private Builder() {
                this.licenseRequestHeaders = ImmutableMap.m412of();
                this.playClearContentWithoutKey = true;
                this.forcedSessionTrackTypes = ImmutableList.m393of();
            }
            ...
            public Builder setForceSessionsForAudioAndVideoTracks(boolean z) {
                ImmutableList m393of;
                if (z) {
                    m393of = ImmutableList.m395of(2, 1);
                } else {
                    m393of = ImmutableList.m393of();
                }
                setForcedSessionTrackTypes(m393of);
                return this;
            }
    ...
    public static final class LocalConfiguration {
        ...
        public static LocalConfiguration fromBundle(Bundle bundle) {
            ...
            if (parcelableArrayList2 == null) {
                fromBundleList2 = ImmutableList.m393of();
            } else {
            ...
            return new LocalConfiguration((Uri) Assertions.checkNotNull((Uri) bundle.getParcelable(FIELD_URI)), bundle.getString(FIELD_MIME_TYPE), fromBundle, fromBundle2, immutableList, bundle.getString(FIELD_CUSTOM_CACHE_KEY), fromBundleList2, null, bundle.getLong(FIELD_IMAGE_DURATION_MS, C0366C.TIME_UNSET));
        }
    }
    ...
    public static final class LiveConfiguration {
        ...
        public static final class Builder {
            ...
            public Builder() {
                this.targetOffsetMs = C0366C.TIME_UNSET;
                this.minOffsetMs = C0366C.TIME_UNSET;
                this.maxOffsetMs = C0366C.TIME_UNSET;
    ...
    public static class SubtitleConfiguration {
        ...
        public static final class Builder {
            ...
            private Builder(SubtitleConfiguration subtitleConfiguration) {
                ...
                this.f97id = subtitleConfiguration.f96id;
            }
