...
public abstract class Timeline {
    ...
    public static final class Window {
        ...
        public static Window fromBundle(Bundle bundle) {
            ...
            long j = bundle.getLong(FIELD_PRESENTATION_START_TIME_MS, C0366C.TIME_UNSET);
            long j2 = bundle.getLong(FIELD_WINDOW_START_TIME_MS, C0366C.TIME_UNSET);
            long j3 = bundle.getLong(FIELD_ELAPSED_REALTIME_EPOCH_OFFSET_MS, C0366C.TIME_UNSET);
            ...
            long j5 = bundle.getLong(FIELD_DURATION_US, C0366C.TIME_UNSET);
    ...
    public static final class Period {
        ...
        public long getAdDurationUs(int i, int i2) {
            ...
            return adGroup.count != -1 ? adGroup.durationsUs[i2] : C0366C.TIME_UNSET;
        }
        ...
        public boolean equals(Object obj) {
            ...
            return Objects.equals(this.f98id, period.f98id) && Objects.equals(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Objects.equals(this.adPlaybackState, period.adPlaybackState);
        }

        public int hashCode() {
            Object obj = this.f98id;
        ...
        public static Period fromBundle(Bundle bundle) {
            ...
            long j = bundle.getLong(FIELD_DURATION_US, C0366C.TIME_UNSET);
    ...
    public final Timeline copyWithSingleWindow(int i) {
        ...
        return new RemotableTimeline(ImmutableList.m394of(window), builder.build(), new int[]{0});
    }
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i, Period period, boolean z) {
            ...
            period.set(period2.f98id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
