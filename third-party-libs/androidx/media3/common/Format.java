...
public final class Format {
    ...
    public static final class Builder {
        ...
        public Builder() {
            this.labels = ImmutableList.m393of();
    ...
    private Format(Builder builder) {
        ...
        if (!builder.labels.isEmpty() || builder.label == null) {
            ...
            this.labels = ImmutableList.m394of(new Label(normalizeLanguageCode, builder.label));
            this.label = builder.label;
        }
    ...
    public String toString() {
        return "Format(" + this.f94id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + ", " + this.colorInfo + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    public static String toLogString(Format format) {
        ...
        Joiner m364on = Joiner.m364on(',');
        StringBuilder sb = new StringBuilder();
        sb.append("id=").append(format.f94id).append(", mimeType=").append(format.sampleMimeType);
        ...
        if (format.drmInitData != null) {
            ...
            for (int i = 0; i < format.drmInitData.schemeDataCount; i++) {
                ...
                if (uuid.equals(C0366C.COMMON_PSSH_UUID)) {
                    linkedHashSet.add(C0366C.CENC_TYPE_cenc);
                } else if (uuid.equals(C0366C.CLEARKEY_UUID)) {
                    linkedHashSet.add("clearkey");
                } else if (uuid.equals(C0366C.PLAYREADY_UUID)) {
                    linkedHashSet.add("playready");
                } else if (uuid.equals(C0366C.WIDEVINE_UUID)) {
                    linkedHashSet.add("widevine");
                } else if (uuid.equals(C0366C.UUID_NIL)) {
            ...
            sb.append(", drm=[");
            m364on.appendTo(sb, (Iterable<? extends Object>) linkedHashSet);
            sb.append(']');
        }
        ...
        if (!format.labels.isEmpty()) {
            sb.append(", labels=[");
            m364on.appendTo(sb, (Iterable<? extends Object>) Lists.transform(format.labels, new Function() { // from class: androidx.media3.common.Format$$ExternalSyntheticLambda2
        ...
        if (format.selectionFlags != 0) {
            ...
            m364on.appendTo(sb, (Iterable<? extends Object>) Util.getSelectionFlagStrings(format.selectionFlags));
            sb.append("]");
        }
        if (format.roleFlags != 0) {
            sb.append(", roleFlags=[");
            m364on.appendTo(sb, (Iterable<? extends Object>) Util.getRoleFlagStrings(format.roleFlags));
            sb.append("]");
        }
    ...
    public Bundle toBundle() {
        ...
        bundle.putString(FIELD_ID, this.f94id);
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        builder.setId((String) defaultIfNull(string, format.f94id)).setLabel((String) defaultIfNull(bundle.getString(FIELD_LABEL), format.label));
