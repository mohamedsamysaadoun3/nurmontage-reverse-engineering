...
public final class GlUtil {
    ...
    public static int createExternalTexture() throws GlException {
        ...
        bindTexture(36197, generateTexture, C0366C.TEXTURE_MIN_FILTER_LINEAR);
    ...
    private static int createTextureUninitialized(int i, int i2, int i3, int i4) throws GlException {
        ...
        int generateTexture = generateTexture();
        bindTexture(3553, generateTexture, C0366C.TEXTURE_MIN_FILTER_LINEAR);
    ...
    public static void setTexture(int i, Bitmap bitmap) throws GlException {
        ...
        bindTexture(3553, i, C0366C.TEXTURE_MIN_FILTER_LINEAR);
    ...
    public static void blitFrameBuffer(int i, GlRect glRect, int i2, GlRect glRect2) throws GlException {
        ...
        checkGlError();
        GLES30.glBlitFramebuffer(glRect.left, glRect.bottom, glRect.right, glRect.top, glRect2.left, glRect2.bottom, glRect2.right, glRect2.top, 16384, C0366C.TEXTURE_MIN_FILTER_LINEAR);
        checkGlError();
        GLES20.glBindFramebuffer(36160, iArr[0]);
        checkGlError();
    }
