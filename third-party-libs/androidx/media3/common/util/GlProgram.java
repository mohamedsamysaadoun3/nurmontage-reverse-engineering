...
public final class GlProgram {
    ...
    private static final class Uniform {
        ...
        private int texMinFilter = C0366C.TEXTURE_MIN_FILTER_LINEAR;
        ...
        public void bind(boolean z) throws GlUtil.GlException {
            ...
            GlUtil.checkGlError();
            int i2 = this.type;
            GlUtil.bindTexture(i2 == 35678 ? 3553 : 36197, this.texIdValue, (i2 == 35678 || !z) ? C0366C.TEXTURE_MIN_FILTER_LINEAR : 9728);
            if (this.type == 35678) {
