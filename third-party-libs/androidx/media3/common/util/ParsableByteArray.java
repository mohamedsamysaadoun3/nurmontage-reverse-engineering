...
public final class ParsableByteArray {
    ...
    /* renamed from: LF */
    private static final char[] f101LF = {'\n'};
    private static final ImmutableSet<Charset> SUPPORTED_CHARSETS_FOR_READLINE = ImmutableSet.m445of(StandardCharsets.US_ASCII, StandardCharsets.UTF_8, StandardCharsets.UTF_16, StandardCharsets.UTF_16BE, StandardCharsets.UTF_16LE);
    ...
    private void skipLineTerminator(Charset charset) {
        if (readCharacterIfInList(charset, CR_AND_LF) == '\r') {
            readCharacterIfInList(charset, f101LF);
        }
    }
    ...
    private int peekCodePointAndSize(Charset charset) {
        ...
        if (charset.equals(StandardCharsets.US_ASCII)) {
            ...
            if (peekUtf8CodeUnitSize == 1) {
                ...
                i2 = decodeUtf8CodeUnit(0, bArr2[i4] & Ascii.f260SI, bArr2[i4 + 1], bArr2[i4 + 2]);
            } else {
    ...
    private static int decodeUtf8CodeUnit(int i, int i2, int i3, int i4) {
        byte b = (byte) i3;
        return Ints.fromBytes((byte) 0, UnsignedBytes.checkedCast(((i & 7) << 2) | ((i2 & 48) >> 4)), UnsignedBytes.checkedCast(((((byte) i2) & Ascii.f260SI) << 4) | ((b & 60) >> 2)), UnsignedBytes.checkedCast(((b & 3) << 6) | (((byte) i4) & 63)));
    }
}
