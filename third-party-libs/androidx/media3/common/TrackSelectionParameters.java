...
public class TrackSelectionParameters {
    ...
    /* renamed from: FIELD_USE_PREFERRED_TEXT_LANGUAGES_AND_ROLE_FLAGS_FROM_CAPTIONING_MANAGER */
    private static final String f100x8acfe161;
    ...
    public static class Builder {
        ...
        public Builder() {
            ...
            this.preferredVideoMimeTypes = ImmutableList.m393of();
            this.preferredVideoLanguages = ImmutableList.m393of();
            this.preferredVideoRoleFlags = 0;
            this.preferredAudioLanguages = ImmutableList.m393of();
            this.preferredAudioRoleFlags = 0;
            this.maxAudioChannelCount = Integer.MAX_VALUE;
            this.maxAudioBitrate = Integer.MAX_VALUE;
            this.preferredAudioMimeTypes = ImmutableList.m393of();
            this.audioOffloadPreferences = AudioOffloadPreferences.DEFAULT;
            this.preferredTextLanguages = ImmutableList.m393of();
        ...
        protected Builder(Bundle bundle) {
            ...
            this.usePreferredTextLanguagesAndRoleFlagsFromCaptioningManager = this.preferredTextLanguages.isEmpty() && this.preferredTextRoleFlags == 0 && bundle.getBoolean(TrackSelectionParameters.f100x8acfe161, TrackSelectionParameters.DEFAULT.usePreferredTextLanguagesAndRoleFlagsFromCaptioningManager);
    ...
    static {
        ...
        f100x8acfe161 = Util.intToStringMaxRadix(34);
    }
    ...
    public Bundle toBundle() {
        ...
        bundle.putBoolean(f100x8acfe161, this.usePreferredTextLanguagesAndRoleFlagsFromCaptioningManager);
