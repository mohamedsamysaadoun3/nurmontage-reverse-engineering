...
public final class TrackGroup {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((527 + this.f99id.hashCode()) * 31) + Arrays.hashCode(this.formats);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f99id.equals(trackGroup.f99id) && Arrays.equals(this.formats, trackGroup.formats);
    }

    public String toString() {
        return this.f99id + ": " + Arrays.toString(this.formats);
    }
    ...
    public Bundle toBundle() {
        ...
        bundle.putString(FIELD_ID, this.f99id);
        return bundle;
    }
    ...
    private static String normalizeLanguage(String str) {
        return (str == null || str.equals(C0366C.LANGUAGE_UNDETERMINED)) ? "" : str;
    }

    private static void logErrorMessage(String str, String str2, String str3, int i) {
        Log.m58e(TAG, "", new IllegalStateException("Different " + str + " combined in one TrackGroup: '" + str2 + "' (track 0) and '" + str3 + "' (track " + i + ")"));
    }
}
