...
public class MatroskaExtractor implements Extractor {
    ...
    MatroskaExtractor(EbmlReader ebmlReader, int i, SubtitleParser.Factory factory) {
        ...
        this.timecodeScale = C0366C.TIME_UNSET;
        this.durationTimecode = C0366C.TIME_UNSET;
        this.durationUs = C0366C.TIME_UNSET;
        this.cuesContentPosition = -1L;
        this.seekPositionAfterBuildingCues = -1L;
        this.clusterTimecodeUs = C0366C.TIME_UNSET;
    ...
    protected void endMasterElement(int i) throws ParserException {
        ...
        if (i == ID_CONTENT_ENCODING) {
            ...
            if (this.currentTrack.hasContentEncryption) {
                ...
                this.currentTrack.drmInitData = new DrmInitData(new DrmInitData.SchemeData(C0366C.UUID_NIL, MimeTypes.VIDEO_WEBM, this.currentTrack.cryptoData.encryptionKey));
                return;
            }
            return;
        }
        ...
        if (i == 357149030) {
            if (this.timecodeScale == C0366C.TIME_UNSET) {
    ...
    */
    protected void binaryElement(int i, int i2, ExtractorInput extractorInput) throws IOException {
        ...
        if (this.blockState == 0) {
            ...
            this.blockDurationUs = C0366C.TIME_UNSET;
            this.blockState = 1;
    ...
    */
        ...
        if (track.trueHdSampleRechunker != null) {
            ...
            if (CODEC_ID_SUBRIP.equals(track.codecId) || CODEC_ID_ASS.equals(track.codecId) || CODEC_ID_SSA.equals(track.codecId) || CODEC_ID_VTT.equals(track.codecId)) {
                if (this.blockSampleCount > 1) {
                    Log.m61w(TAG, "Skipping subtitle sample in laced block.");
                } else if (this.blockDurationUs == C0366C.TIME_UNSET) {
                    Log.m61w(TAG, "Skipping subtitle sample with no duration.");
                } else {
    ...
    private SeekMap buildSeekMap(LongArray longArray, LongArray longArray2) {
        int i;
        if (this.segmentContentPosition == -1 || this.durationUs == C0366C.TIME_UNSET || longArray == null || longArray.size() == 0 || longArray2 == null || longArray2.size() != longArray.size()) {
        ...
        if (i5 < i) {
            Log.m61w(TAG, "Discarding trailing cue points with timestamps greater than total duration");
            int i6 = i5 + 1;
        ...
        */
            ...
            switch (c) {
                ...
                case 2:
                    ...
                    if (parseMsAcmCodecPrivate(new ParsableByteArray(getCodecPrivate(this.codecId)))) {
                        ...
                        if (i7 == 0) {
                            Log.m61w(MatroskaExtractor.TAG, "Unsupported PCM bit depth: " + this.audioBitDepth + ". Setting mimeType to audio/x-unknown");
                        } else {
                            singletonList = null;
                            str = null;
                            i3 = -1;
                        ...
                        Log.m61w(MatroskaExtractor.TAG, "Non-PCM MS/ACM is unsupported. Setting mimeType to audio/x-unknown");
                    }
                    singletonList = null;
                    str = null;
                ...
                case '\b':
                    ...
                    singletonList = ImmutableList.m394of(bArr2);
                ...
                case '\n':
                    ...
                    return;
                case 11:
                    singletonList = ImmutableList.m394of(getCodecPrivate(this.codecId));
                    str = null;
                ...
                case 16:
                    ...
                    singletonList = bArr3 == null ? null : ImmutableList.m394of(bArr3);
                ...
                case 18:
                    ...
                    singletonList = bArr4 == null ? null : ImmutableList.m394of(bArr4);
                ...
                case 22:
                    if (this.audioBitDepth != 32) {
                        Log.m61w(MatroskaExtractor.TAG, "Unsupported floating point PCM bit depth: " + this.audioBitDepth + ". Setting mimeType to audio/x-unknown");
                        singletonList = null;
                        str = null;
                        str5 = MimeTypes.AUDIO_UNKNOWN;
                        i2 = 0;
                ...
                case 23:
                    ...
                    if (i12 == 8) {
                        ...
                        i7 = C0366C.ENCODING_PCM_24BIT_BIG_ENDIAN;
                    } else {
                        if (i12 != 32) {
                            Log.m61w(MatroskaExtractor.TAG, "Unsupported big endian PCM bit depth: " + this.audioBitDepth + ". Setting mimeType to audio/x-unknown");
                            singletonList = null;
                            str = null;
                            str5 = MimeTypes.AUDIO_UNKNOWN;
                            i2 = 0;
                        ...
                        i7 = C0366C.ENCODING_PCM_32BIT_BIG_ENDIAN;
                    }
                    singletonList = null;
                    str = null;
                    i2 = 0;
                ...
                case 24:
                    i7 = Util.getPcmEncoding(this.audioBitDepth);
                    if (i7 == 0) {
                        Log.m61w(MatroskaExtractor.TAG, "Unsupported little endian PCM bit depth: " + this.audioBitDepth + ". Setting mimeType to audio/x-unknown");
                        singletonList = null;
                        str = null;
                        str5 = MimeTypes.AUDIO_UNKNOWN;
                        i2 = 0;
                ...
                case 25:
                case 26:
                    singletonList = ImmutableList.m395of(MatroskaExtractor.SSA_DIALOGUE_FORMAT, getCodecPrivate(this.codecId));
                    str = null;
        ...
        private static Pair<String, List<byte[]>> parseFourCcPrivate(ParsableByteArray parsableByteArray) throws ParserException {
            try {
                ...
                Log.m61w(MatroskaExtractor.TAG, "Unknown FourCC. Setting mimeType to video/x-unknown");
