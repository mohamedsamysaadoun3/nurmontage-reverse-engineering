...
public final class DvbParser implements SubtitleParser {
    ...
    private static final byte[] defaultMap2To4 = {0, 7, 8, Ascii.f260SI};
    ...
    private CuesWithTiming parse(ParsableBitArray parsableBitArray) {
        ...
        if (pageComposition == null) {
            return new CuesWithTiming(ImmutableList.m393of(), C0366C.TIME_UNSET, C0366C.TIME_UNSET);
        }
        ...
        return new CuesWithTiming(arrayList, C0366C.TIME_UNSET, C0366C.TIME_UNSET);
    }
    ...
    private static void parseSubtitlingSegment(ParsableBitArray parsableBitArray, SubtitleService subtitleService) {
        ...
        if (readBits3 * 8 > parsableBitArray.bitsLeft()) {
            Log.m61w(TAG, "Data field length exceeds limit");
        ...
        switch (readBits) {
            ...
            case 17:
                ...
                if (readBits2 == subtitleService.subtitlePageId && pageComposition2 != null) {
                    ...
                    if (pageComposition2.state == 0 && (regionComposition = subtitleService.regions.get(parseRegionComposition.f128id)) != null) {
                        parseRegionComposition.mergeFrom(regionComposition);
                    }
                    subtitleService.regions.put(parseRegionComposition.f128id, parseRegionComposition);
                    break;
                }
                break;
            case 18:
                if (readBits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.cluts.put(parseClutDefinition.f126id, parseClutDefinition);
                    break;
                    ...
                    subtitleService.ancillaryCluts.put(parseClutDefinition2.f126id, parseClutDefinition2);
                    break;
                }
                break;
            case 19:
                if (readBits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.objects.put(parseObjectData.f127id, parseObjectData);
                    break;
                } else if (readBits2 == subtitleService.ancillaryPageId) {
                    ObjectData parseObjectData2 = parseObjectData(parsableBitArray);
                    subtitleService.ancillaryObjects.put(parseObjectData2.f127id, parseObjectData2);
                    break;
                }
                break;
            case 20:
