...
public final class SubripParser implements SubtitleParser {
    ...
    public void parse(byte[] bArr, int i, int i2, SubtitleParser.OutputOptions outputOptions, Consumer<CuesWithTiming> consumer) {
        ...
        ArrayList arrayList = (outputOptions.startTimeUs == C0366C.TIME_UNSET || !outputOptions.outputAllCues) ? null : new ArrayList();
        while (true) {
            ...
            if (!readLine2.isEmpty()) {
                try {
                    ...
                    str = str4;
                    consumer2 = consumer4;
                    Log.m61w(str, "Skipping invalid index: " + readLine2);
                }
                if (readLine == null) {
                    Log.m61w(str4, "Unexpected end");
                    break;
                }
                ...
                if (matcher.matches()) {
                    ...
                    if (outputOptions.startTimeUs == C0366C.TIME_UNSET || parseTimecode2 >= outputOptions.startTimeUs) {
                        consumer3 = consumer;
                        consumer3.accept(new CuesWithTiming(ImmutableList.m394of(buildCue(fromHtml, str3)), parseTimecode, parseTimecode2 - parseTimecode));
                    } else {
                        if (arrayList != null) {
                            arrayList.add(new CuesWithTiming(ImmutableList.m394of(buildCue(fromHtml, str3)), parseTimecode, parseTimecode2 - parseTimecode));
                        }
                        consumer3 = consumer;
                    }
                    consumer4 = consumer3;
                    ...
                    consumer2 = consumer4;
                    str = str5;
                    Log.m61w(str, "Skipping invalid timing: " + readLine);
                    consumer4 = consumer2;
                    str4 = str;
                }
            }
