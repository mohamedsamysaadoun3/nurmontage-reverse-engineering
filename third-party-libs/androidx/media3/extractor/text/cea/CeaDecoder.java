...
abstract class CeaDecoder implements SubtitleDecoder {
    ...
    public CeaDecoder() {
        ...
        this.outputStartTimeUs = C0366C.TIME_UNSET;
    }
    ...
    public void queueInputBuffer(SubtitleInputBuffer subtitleInputBuffer) throws SubtitleDecoderException {
        ...
        if (!ceaInputBuffer.isEndOfStream() && ceaInputBuffer.timeUs != Long.MIN_VALUE && this.outputStartTimeUs != C0366C.TIME_UNSET && ceaInputBuffer.timeUs < this.outputStartTimeUs) {
