...
public class SubtitleExtractor implements Extractor {
    ...
    public SubtitleExtractor(SubtitleParser subtitleParser, Format format) {
        ...
        this.seekTimeUs = C0366C.TIME_UNSET;
    }
    ...
    public void init(ExtractorOutput extractorOutput) {
        ...
        if (format != null) {
            ...
            extractorOutput.seekMap(new IndexSeekMap(new long[]{0}, new long[]{0}, C0366C.TIME_UNSET));
        }
        this.state = 1;
    }
        ...
        try {
            ...
            this.subtitleParser.parse(this.subtitleData, 0, this.bytesRead, allCues, new Consumer() { // from class: androidx.media3.extractor.text.SubtitleExtractor$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    SubtitleExtractor.this.m210xdbba10ad((CuesWithTiming) obj);
                }
            });
    ...
    /* renamed from: lambda$parseAndWriteToOutput$0$androidx-media3-extractor-text-SubtitleExtractor */
    /* synthetic */ void m210xdbba10ad(CuesWithTiming cuesWithTiming) {
        ...
        if (this.seekTimeUs == C0366C.TIME_UNSET || cuesWithTiming.endTimeUs >= this.seekTimeUs) {
    ...
    private void writeToOutput() {
        long j = this.seekTimeUs;
        for (int binarySearchFloor = j == C0366C.TIME_UNSET ? 0 : Util.binarySearchFloor(this.timestamps, j, true, true); binarySearchFloor < this.samples.size(); binarySearchFloor++) {
