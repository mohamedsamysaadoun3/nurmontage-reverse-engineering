...
public final class FlvExtractor implements Extractor {
    ...
    */
    private boolean readTagData(ExtractorInput extractorInput) throws IOException {
        ...
        if (i == 8 && this.audioReader != null) {
            ...
            if (!this.outputFirstSample && z) {
                ...
                this.mediaTagTimestampOffsetUs = this.metadataReader.getDurationUs() != C0366C.TIME_UNSET ? -this.tagTimestampUs : 0L;
            }
    ...
    private void ensureReadyForMediaOutput() {
        ...
        this.extractorOutput.seekMap(new SeekMap.Unseekable(C0366C.TIME_UNSET));
        this.outputSeekMap = true;
    }
    ...
    private long getCurrentTimestampUs() {
        ...
        if (this.metadataReader.getDurationUs() == C0366C.TIME_UNSET) {
            return 0L;
        }
