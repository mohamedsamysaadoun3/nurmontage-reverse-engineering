...
public final class H262Reader implements ElementaryStreamReader {
    ...
    H262Reader(UserDataReader userDataReader, String str) {
        ...
        this.sampleTimeUs = C0366C.TIME_UNSET;
    }
                    ...
                    if (j2 != C0366C.TIME_UNSET) {
                        ...
                        if (this.startedFirstSample || this.sampleHasPicture) {
                            ...
                            if (j == C0366C.TIME_UNSET) {
                                ...
                                j = j3 != C0366C.TIME_UNSET ? j3 + this.frameDurationUs : -9223372036854775807L;
                            }
                            this.sampleTimeUs = j;
    ...
    */
    private static Pair<Format, Long> parseCsdBuffer(CsdBuffer csdBuffer, String str, String str2) {
        ...
        byte b = copyOf[5];
        int i4 = (i3 << 4) | ((b & 255) >> 4);
        int i5 = ((b & Ascii.f260SI) << 8) | (copyOf[6] & 255);
