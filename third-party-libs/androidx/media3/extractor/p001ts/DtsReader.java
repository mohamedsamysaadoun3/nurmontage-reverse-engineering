...
public final class DtsReader implements ElementaryStreamReader {
    ...
    private int state = 0;
    private long timeUs = C0366C.TIME_UNSET;
    ...
    @Override // androidx.media3.extractor.p001ts.ElementaryStreamReader
            ...
            switch (this.state) {
                ...
                case 6:
                    ...
                    if (i4 == this.sampleSize) {
                        Assertions.checkState(this.timeUs != C0366C.TIME_UNSET);
    ...
    private void parseExtensionSubstreamHeader() throws ParserException {
        ...
        this.sampleDurationUs = parseDtsHdHeader.frameDurationUs == C0366C.TIME_UNSET ? 0L : parseDtsHdHeader.frameDurationUs;
    }
    ...
    private void parseUhdHeader() throws ParserException {
        ...
        this.sampleDurationUs = parseDtsUhdHeader.frameDurationUs == C0366C.TIME_UNSET ? 0L : parseDtsUhdHeader.frameDurationUs;
    }
