...
public final class H263Reader implements ElementaryStreamReader {
    ...
    H263Reader(UserDataReader userDataReader, String str) {
        ...
        this.pesTimeUs = C0366C.TIME_UNSET;
    ...
    private static Format parseCsdBuffer(CsdBuffer csdBuffer, int i, String str, String str2) {
        ...
        if (readBits == 15) {
            ...
            if (readBits3 == 0) {
                Log.m61w(TAG, "Invalid aspect ratio");
            } else {
        ...
        if (parsableBitArray.readBits(2) != 0) {
            Log.m61w(TAG, "Unhandled video object layer shape");
        }
        parsableBitArray.skipBit();
        ...
        if (parsableBitArray.readBit()) {
            if (readBits4 == 0) {
                Log.m61w(TAG, "Invalid vop_increment_time_resolution");
            } else {
                int i2 = 0;
                ...
                if (i3 != 1) {
                    if (i3 != 2) {
                        if (i3 != 3) {
                            ...
                            Log.m61w(H263Reader.TAG, "Unexpected start code value");
                            reset();
                        } else {
    ...
    private static final class SampleReader {
        ...
        public void onDataEnd(long j, int i, boolean z) {
            Assertions.checkState(this.sampleTimeUs != C0366C.TIME_UNSET);
