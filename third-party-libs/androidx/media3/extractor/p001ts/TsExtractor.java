    ...
    */
    ...
    public void seek(long j, long j2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            boolean z = timestampAdjuster.getTimestampOffsetUs() == C0366C.TIME_UNSET;
            if (!z) {
                long firstSampleTimestampUs = timestampAdjuster.getFirstSampleTimestampUs();
                z = (firstSampleTimestampUs == C0366C.TIME_UNSET || firstSampleTimestampUs == 0 || firstSampleTimestampUs == j2) ? false : true;
            }
            if (z) {
    ...
    private void maybeOutputSeekMap(long j) {
        ...
        if (this.durationReader.getDurationUs() != C0366C.TIME_UNSET) {
    ...
    private class PatReader implements SectionPayloadReader {
        ...
        @Override // androidx.media3.extractor.p001ts.SectionPayloadReader
