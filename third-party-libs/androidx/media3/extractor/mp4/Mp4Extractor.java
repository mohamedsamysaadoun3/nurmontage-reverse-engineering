...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    public boolean sniff(ExtractorInput extractorInput) throws IOException {
        ...
        this.lastSniffFailures = sniffUnfragmented != null ? ImmutableList.m394of(sniffUnfragmented) : ImmutableList.m393of();
    ...
    */
    ...
    private void processMoovAtom(Mp4Box.ContainerBox containerBox) throws ParserException {
        ...
        List<TrackSampleTable> parseTraks = BoxParser.parseTraks(containerBox, gaplessInfoHolder, C0366C.TIME_UNSET, null, (this.flags & 1) != 0, z, new Function() { // from class: androidx.media3.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda1
        ...
        while (i2 < parseTraks.size()) {
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                long j3 = track.durationUs != C0366C.TIME_UNSET ? track.durationUs : trackSampleTable.durationUs;
    ...
    private void processUnparsedAtom(long j) {
        if (this.atomType == 1836086884) {
            int i = this.atomHeaderBytesRead;
            this.motionPhotoMetadata = new MotionPhotoMetadata(0L, j, C0366C.TIME_UNSET, j + i, this.atomSize - i);
        }
    }
