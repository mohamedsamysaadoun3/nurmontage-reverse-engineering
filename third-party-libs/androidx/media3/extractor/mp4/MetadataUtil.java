...
final class MetadataUtil {
    ...
    public static Metadata.Entry parseIlstElement(ParsableByteArray parsableByteArray) {
        ...
        try {
            ...
            Log.m55d(TAG, "Skipped unknown metadata entry: " + Mp4Box.getBoxTypeString(readInt));
    ...
    private static TextInformationFrame parseTextAttribute(int i, String str, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385) {
            ...
            return new TextInformationFrame(str, (String) null, ImmutableList.m394of(parsableByteArray.readNullTerminatedString(readInt - 16)));
        }
        Log.m61w(TAG, "Failed to parse text attribute: " + Mp4Box.getBoxTypeString(i));
        return null;
    }
    ...
    private static CommentFrame parseCommentAttribute(int i, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385) {
            ...
            return new CommentFrame(C0366C.LANGUAGE_UNDETERMINED, readNullTerminatedString, readNullTerminatedString);
        }
        Log.m61w(TAG, "Failed to parse comment attribute: " + Mp4Box.getBoxTypeString(i));
        return null;
    }
    ...
    private static Id3Frame parseIntegerAttribute(int i, String str, ParsableByteArray parsableByteArray, boolean z, boolean z2) {
        ...
        if (parseIntegerAttribute < 0) {
            Log.m61w(TAG, "Failed to parse uint8 attribute: " + Mp4Box.getBoxTypeString(i));
            return null;
        }
        if (z) {
            return new TextInformationFrame(str, (String) null, ImmutableList.m394of(Integer.toString(parseIntegerAttribute)));
        }
        return new CommentFrame(C0366C.LANGUAGE_UNDETERMINED, str, Integer.toString(parseIntegerAttribute));
    }
    ...
    private static int parseIntegerAttribute(ParsableByteArray parsableByteArray) {
        ...
        Log.m61w(TAG, "Failed to parse data atom to int");
        return -1;
    }
    ...
    private static TextInformationFrame parseIndexAndCountAttribute(int i, String str, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385 && readInt >= 22) {
            ...
            if (readUnsignedShort > 0) {
                ...
                return new TextInformationFrame(str, (String) null, ImmutableList.m394of(str2));
            }
        }
        Log.m61w(TAG, "Failed to parse index/count attribute: " + Mp4Box.getBoxTypeString(i));
        return null;
    }
    ...
    private static TextInformationFrame parseStandardGenreAttribute(ParsableByteArray parsableByteArray) {
        ...
        if (resolveV1Genre != null) {
            return new TextInformationFrame("TCON", (String) null, ImmutableList.m394of(resolveV1Genre));
        }
        Log.m61w(TAG, "Failed to parse standard genre code");
        return null;
    }
    ...
    private static ApicFrame parseCoverArt(ParsableByteArray parsableByteArray) {
        ...
        int readInt = parsableByteArray.readInt();
        if (parsableByteArray.readInt() != 1684108385) {
            Log.m61w(TAG, "Failed to parse cover art attribute");
            return null;
        }
        ...
        if (str == null) {
            Log.m61w(TAG, "Unrecognized cover art flags: " + parseFullBoxFlags);
            return null;
        }
