...
public final class TrackEncryptionBox {
    ...
    private static int schemeToCryptoMode(String str) {
        ...
        switch (str.hashCode()) {
            case 3046605:
                if (str.equals(C0366C.CENC_TYPE_cbc1)) {
                    c = 0;
                    break;
                }
                break;
            case 3046671:
                if (str.equals(C0366C.CENC_TYPE_cbcs)) {
                    c = 1;
                    break;
                }
                break;
            case 3049879:
                if (str.equals(C0366C.CENC_TYPE_cenc)) {
                    c = 2;
                    break;
                }
                break;
            case 3049895:
                if (str.equals(C0366C.CENC_TYPE_cens)) {
                    c = 3;
                    break;
                }
                break;
        ...
        switch (c) {
            ...
            case 1:
                return 2;
            default:
                Log.m61w(TAG, "Unsupported protection scheme type '" + str + "'. Assuming AES-CTR crypto mode.");
            case 2:
            case 3:
                return 1;
        }
