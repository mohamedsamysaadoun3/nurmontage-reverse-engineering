...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, BandwidthMeter bandwidthMeter) {
        this(trackGroup, iArr, 0, bandwidthMeter, Renderer.DEFAULT_DURATION_TO_PROGRESS_US, 25000L, 25000L, DEFAULT_MAX_WIDTH_TO_DISCARD, DEFAULT_MAX_HEIGHT_TO_DISCARD, 0.7f, 0.75f, ImmutableList.m393of(), Clock.DEFAULT);
    }
    ...
    protected AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, int i, BandwidthMeter bandwidthMeter, long j, long j2, long j3, int i2, int i3, float f, float f2, List<AdaptationCheckpoint> list, Clock clock) {
        ...
        long j4;
        if (j3 < j) {
            Log.m61w(TAG, "Adjusting minDurationToRetainAfterDiscardMs to be at least minDurationForQualityIncreaseMs");
        ...
        this.reason = 0;
        this.lastBufferEvaluationMs = C0366C.TIME_UNSET;
    ...
    protected boolean shouldEvaluateQueueSize(long j, List<? extends MediaChunk> list) {
        ...
        return j2 == C0366C.TIME_UNSET || j - j2 >= 1000 || !(list.isEmpty() || ((MediaChunk) Iterables.getLast(list)).equals(this.lastBufferEvaluationMediaChunk));
    }
    ...
    private long getLastChunkDurationUs(List<? extends MediaChunk> list) {
        ...
        return (mediaChunk.startTimeUs == C0366C.TIME_UNSET || mediaChunk.endTimeUs == C0366C.TIME_UNSET) ? C0366C.TIME_UNSET : mediaChunk.endTimeUs - mediaChunk.startTimeUs;
    }
    ...
    private long getTotalAllocatableBandwidth(long j) {
        ...
        if (timeToFirstByteEstimateUs == C0366C.TIME_UNSET || j == C0366C.TIME_UNSET) {
    ...
    public static ImmutableList<ImmutableList<AdaptationCheckpoint>> getAdaptationCheckpoints(ExoTrackSelection.Definition[] definitionArr) {
        ...
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            ...
            builder2.add((ImmutableList.Builder) (builder3 == null ? ImmutableList.m393of() : builder3.build()));
        }
