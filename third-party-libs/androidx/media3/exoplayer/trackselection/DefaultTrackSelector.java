...
public class DefaultTrackSelector extends MappingTrackSelector implements RendererCapabilities.Listener {
    ...
    public static final class Parameters extends TrackSelectionParameters {
        ...
        private static final String f113xaec1bc6e;
        ...
        public static final class Builder extends TrackSelectionParameters.Builder {
            ...
            private Builder(Bundle bundle) {
                ...
                setAllowInvalidateSelectionsOnRendererCapabilitiesChange(bundle.getBoolean(Parameters.f113xaec1bc6e, parameters.allowInvalidateSelectionsOnRendererCapabilitiesChange));
                this.selectionOverrides = new SparseArray<>();
        ...
        static {
            ...
            f113xaec1bc6e = Util.intToStringMaxRadix(1017);
        ...
        public Bundle toBundle() {
            ...
            bundle.putBoolean(f113xaec1bc6e, this.allowInvalidateSelectionsOnRendererCapabilitiesChange);
    ...
    private DefaultTrackSelector(TrackSelectionParameters trackSelectionParameters, ExoTrackSelection.Factory factory, Context context) {
        ...
        if (this.parameters.constrainAudioChannelCountToDeviceCapabilities && context == null) {
            Log.m61w(TAG, AUDIO_CHANNEL_COUNT_CONSTRAINTS_WARN_MESSAGE);
        }
    }
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda6
            ...
            public final List create(int i2, TrackGroup trackGroup, int[] iArr3) {
                return DefaultTrackSelector.this.m187x86684b84(parameters, z, iArr2, i2, trackGroup, iArr3);
            }
    ...
    /* renamed from: lambda$selectAudioTrack$3$androidx-media3-exoplayer-trackselection-DefaultTrackSelector */
    /* synthetic */ List m187x86684b84(final Parameters parameters, boolean z, int[] iArr, int i, TrackGroup trackGroup, int[] iArr2) {
        return AudioTrackInfo.createForTrackGroup(i, trackGroup, parameters, iArr2, z, new Predicate() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda3
            ...
            public final boolean apply(Object obj) {
                return DefaultTrackSelector.this.m186x92d8c743(parameters, (Format) obj);
            }
        }, iArr[i]);
    }
    ...
    public boolean m186x92d8c743(Format format, Parameters parameters) {
        Boolean bool;
        SpatializerWrapperV32 spatializerWrapperV32;
                    ...
                    while (i5 < trackGroup.length) {
                        ...
                        if (zArr[i5] || selectionEligibility == 0) {
                            ...
                            if (selectionEligibility == 1) {
                                randomAccess = ImmutableList.m394of(t);
                                i2 = rendererCount;
                            } else {
                                ArrayList arrayList2 = new ArrayList();
                                arrayList2.add(t);
    ...
    protected static String normalizeUndeterminedLanguageToNull(String str) {
        if (TextUtils.isEmpty(str) || TextUtils.equals(str, C0366C.LANGUAGE_UNDETERMINED)) {
            return null;
        }
        return str;
    }
    ...
    static final class TextTrackInfo extends TrackInfo<TextTrackInfo> implements Comparable<TextTrackInfo> {
        ...
        public TextTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, String str, String str2) {
            ...
            if (str2 != null) {
                immutableList = ImmutableList.m394of(str2);
            } else if (parameters.preferredTextLanguages.isEmpty()) {
                immutableList = ImmutableList.m394of("");
            } else {
