...
final class ReplacingCuesResolver implements CuesResolver {
    ...
    public boolean addCues(CuesWithTiming cuesWithTiming, long j) {
        Assertions.checkArgument(cuesWithTiming.startTimeUs != C0366C.TIME_UNSET);
        boolean z = cuesWithTiming.startTimeUs <= j && (cuesWithTiming.endTimeUs == C0366C.TIME_UNSET || j < cuesWithTiming.endTimeUs);
    ...
    public ImmutableList<Cue> getCuesAtTimeUs(long j) {
        ...
        if (cuesWithTiming.endTimeUs == C0366C.TIME_UNSET || j < cuesWithTiming.endTimeUs) {
    ...
    public void discardCuesBeforeTimeUs(long j) {
        ...
        CuesWithTiming cuesWithTiming = this.cuesWithTimingList.get(indexOfCuesStartingAfter - 1);
        if (cuesWithTiming.endTimeUs == C0366C.TIME_UNSET || cuesWithTiming.endTimeUs >= j) {
    ...
    public long getPreviousCueChangeTimeUs(long j) {
        ...
        if (cuesWithTiming2.endTimeUs == C0366C.TIME_UNSET || j < cuesWithTiming2.endTimeUs) {
    ...
    public long getNextCueChangeTimeUs(long j) {
        ...
        for (int i = 1; i < this.cuesWithTimingList.size(); i++) {
            ...
            if (j < cuesWithTiming.startTimeUs) {
                ...
                if (cuesWithTiming2.endTimeUs != C0366C.TIME_UNSET && cuesWithTiming2.endTimeUs > j && cuesWithTiming2.endTimeUs < cuesWithTiming.startTimeUs) {
                    return cuesWithTiming2.endTimeUs;
                }
                return cuesWithTiming.startTimeUs;
            }
        ...
        if (cuesWithTiming3.endTimeUs == C0366C.TIME_UNSET || j >= cuesWithTiming3.endTimeUs) {
            return Long.MIN_VALUE;
        }
