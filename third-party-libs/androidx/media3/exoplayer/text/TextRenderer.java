...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    public TextRenderer(TextOutput textOutput, Looper looper, SubtitleDecoderFactory subtitleDecoderFactory) {
        ...
        this.finalStreamEndPositionUs = C0366C.TIME_UNSET;
        this.lastRendererPositionUs = C0366C.TIME_UNSET;
    ...
    private void clearOutput() {
        updateOutput(new CueGroup(ImmutableList.m393of(), getPresentationTimeUs(this.lastRendererPositionUs)));
    }
    ...
    private void handleDecoderError(SubtitleDecoderException subtitleDecoderException) {
        Log.m58e(TAG, "Subtitle decoding failed. streamFormat=" + this.streamFormat, subtitleDecoderException);
        clearOutput();
        replaceSubtitleDecoder();
    }
