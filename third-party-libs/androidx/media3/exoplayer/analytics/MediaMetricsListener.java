...
public final class MediaMetricsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    private void maybeReportPlaybackError(long j) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: androidx.media3.exoplayer.analytics.MediaMetricsListener$$ExternalSyntheticLambda2
            ...
            public final void run() {
                MediaMetricsListener.this.m106xdf4bfb0e(build);
            }
        });
    ...
    /* renamed from: lambda$maybeReportPlaybackError$0$androidx-media3-exoplayer-analytics-MediaMetricsListener */
    /* synthetic */ void m106xdf4bfb0e(PlaybackErrorEvent playbackErrorEvent) {
    ...
    private void maybeReportNetworkChange(long j) {
        ...
        if (networkType != this.currentNetworkType) {
            ...
            this.backgroundExecutor.execute(new Runnable() { // from class: androidx.media3.exoplayer.analytics.MediaMetricsListener$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    MediaMetricsListener.this.m105xe45a00bc(build);
                }
            });
        }
    }

    /* renamed from: lambda$maybeReportNetworkChange$1$androidx-media3-exoplayer-analytics-MediaMetricsListener */
    /* synthetic */ void m105xe45a00bc(NetworkEvent networkEvent) {
    ...
    private void maybeReportPlaybackStateChange(Player player, AnalyticsListener.Events events, long j) {
        ...
        if (this.currentPlaybackState != resolveNewPlaybackState) {
            ...
            this.backgroundExecutor.execute(new Runnable() { // from class: androidx.media3.exoplayer.analytics.MediaMetricsListener$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    MediaMetricsListener.this.m107x6c41e093(build);
                }
            });
        }
    }

    /* renamed from: lambda$maybeReportPlaybackStateChange$2$androidx-media3-exoplayer-analytics-MediaMetricsListener */
    /* synthetic */ void m107x6c41e093(PlaybackStateEvent playbackStateEvent) {
    ...
    private void reportTrackChangeEvent(int i, long j, Format format, int i2) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: androidx.media3.exoplayer.analytics.MediaMetricsListener$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                MediaMetricsListener.this.m108x86fc0269(build);
            }
        });
    }

    /* renamed from: lambda$reportTrackChangeEvent$3$androidx-media3-exoplayer-analytics-MediaMetricsListener */
    /* synthetic */ void m108x86fc0269(TrackChangeEvent trackChangeEvent) {
    ...
    private void maybeUpdateTimelineMetadata(Timeline timeline, MediaSource.MediaPeriodId mediaPeriodId) {
        ...
        if (this.window.durationUs != C0366C.TIME_UNSET && !this.window.isPlaceholder && !this.window.isDynamic && !this.window.isLive()) {
    ...
    private void finishCurrentSession() {
        ...
        if (builder != null && this.reportedEventsForCurrentSession) {
            ...
            this.backgroundExecutor.execute(new Runnable() { // from class: androidx.media3.exoplayer.analytics.MediaMetricsListener$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    MediaMetricsListener.this.m104x9548dab(build);
                }
            });
        }
    ...
    /* renamed from: lambda$finishCurrentSession$4$androidx-media3-exoplayer-analytics-MediaMetricsListener */
    /* synthetic */ void m104x9548dab(PlaybackMetrics playbackMetrics) {
    ...
    private static int getDrmType(DrmInitData drmInitData) {
        for (int i = 0; i < drmInitData.schemeDataCount; i++) {
            ...
            if (uuid.equals(C0366C.WIDEVINE_UUID)) {
                return 3;
            }
            if (uuid.equals(C0366C.PLAYREADY_UUID)) {
                return 2;
            }
            if (uuid.equals(C0366C.CLEARKEY_UUID)) {
                return 6;
            }
        }
        return 1;
