...
class DefaultDrmSession implements DrmSession {
    ...
    public void acquire(DrmSessionEventListener.EventDispatcher eventDispatcher) {
        ...
        if (this.referenceCount < 0) {
            Log.m57e(TAG, "Session reference count less than zero: " + this.referenceCount);
    ...
    public void release(DrmSessionEventListener.EventDispatcher eventDispatcher) {
        ...
        if (i <= 0) {
            Log.m57e(TAG, "release() called on a session that's already fully released.");
            return;
        }
        int i2 = i - 1;
    ...
    */
    ...
    private void doLicense(boolean z) {
        ...
        if (this.state == 4 || restoreKeys()) {
            ...
            if (this.mode == 0 && licenseDurationRemainingSec <= 60) {
                Log.m55d(TAG, "Offline license has expired or will expire soon. Remaining seconds: " + licenseDurationRemainingSec);
                postKeyRequest(bArr, 2, z);
    ...
    private long getLicenseDurationRemainingSec() {
        if (!C0366C.WIDEVINE_UUID.equals(this.uuid)) {
    ...
    private void onError(final Throwable th, int i) {
        ...
        Log.m58e(TAG, "DRM session error", th);
    ...
    private class RequestHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            try {
                ...
                Log.m62w(DefaultDrmSession.TAG, "Key/provisioning request produced an unexpected exception. Not retrying.", e2);
                th = e2;
            }
