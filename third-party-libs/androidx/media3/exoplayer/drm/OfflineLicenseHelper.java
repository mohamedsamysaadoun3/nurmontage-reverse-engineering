...
public final class OfflineLicenseHelper {
    ...
    public static OfflineLicenseHelper newWidevineInstance(MediaItem.DrmConfiguration drmConfiguration, DataSource.Factory factory, DrmSessionEventListener.EventDispatcher eventDispatcher) {
        Assertions.checkArgument(drmConfiguration.scheme.equals(C0366C.WIDEVINE_UUID));
        ...
        try {
            ...
            this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.drm.OfflineLicenseHelper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    OfflineLicenseHelper.this.m136xc6195285(create, acquireFirstSessionOnHandlerThread);
                }
            });
            try {
                try {
    ...
    /* renamed from: lambda$getLicenseDurationRemainingSec$0$androidx-media3-exoplayer-drm-OfflineLicenseHelper */
    /* synthetic */ void m136xc6195285(SettableFuture settableFuture, DrmSession drmSession) {
        try {
    ...
    private byte[] acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread(int i, byte[] bArr, Format format) throws DrmSession.DrmSessionException {
        ...
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.drm.OfflineLicenseHelper$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                OfflineLicenseHelper.this.m135x4ec00c9e(create, acquireFirstSessionOnHandlerThread);
            }
        });
        try {
            try {
    ...
    /* renamed from: lambda$acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread$1$androidx-media3-exoplayer-drm-OfflineLicenseHelper */
    /* synthetic */ void m135x4ec00c9e(SettableFuture settableFuture, DrmSession drmSession) {
        try {
    ...
    private DrmSession acquireFirstSessionOnHandlerThread(final int i, final byte[] bArr, final Format format) throws DrmSession.DrmSessionException {
        ...
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.drm.OfflineLicenseHelper$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                OfflineLicenseHelper.this.m133xf4292904(i, bArr, create, format);
            }
        });
        try {
            ...
            this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.drm.OfflineLicenseHelper$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    OfflineLicenseHelper.this.m134x2201c363(drmSession, create2);
                }
            });
            try {
                if (create2.get() == 0) {
    ...
    /* renamed from: lambda$acquireFirstSessionOnHandlerThread$2$androidx-media3-exoplayer-drm-OfflineLicenseHelper */
    /* synthetic */ void m133xf4292904(int i, byte[] bArr, SettableFuture settableFuture, Format format) {
        try {
    ...
    /* renamed from: lambda$acquireFirstSessionOnHandlerThread$3$androidx-media3-exoplayer-drm-OfflineLicenseHelper */
    /* synthetic */ void m134x2201c363(DrmSession drmSession, SettableFuture settableFuture) {
        try {
    ...
    private void releaseManagerOnHandlerThread() {
        ...
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.drm.OfflineLicenseHelper$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                OfflineLicenseHelper.this.m137xf255d686(create);
            }
        });
        try {
            create.get();
    ...
    /* renamed from: lambda$releaseManagerOnHandlerThread$4$androidx-media3-exoplayer-drm-OfflineLicenseHelper */
    /* synthetic */ void m137xf255d686(SettableFuture settableFuture) {
        try {
            this.drmSessionManager.release();
