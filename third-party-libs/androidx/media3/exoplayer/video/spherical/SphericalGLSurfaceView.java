...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    protected void onDetachedFromWindow() {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.video.spherical.SphericalGLSurfaceView$$ExternalSyntheticLambda0
            ...
            public final void run() {
                SphericalGLSurfaceView.this.m207x99583d2c();
            }
        });
    }

    /* renamed from: lambda$onDetachedFromWindow$0$androidx-media3-exoplayer-video-spherical-SphericalGLSurfaceView */
    /* synthetic */ void m207x99583d2c() {
    ...
    public void onSurfaceTextureAvailable(final SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.video.spherical.SphericalGLSurfaceView$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                SphericalGLSurfaceView.this.m208x24c550f4(surfaceTexture);
            }
        });
    }

    /* renamed from: lambda$onSurfaceTextureAvailable$1$androidx-media3-exoplayer-video-spherical-SphericalGLSurfaceView */
    /* synthetic */ void m208x24c550f4(SurfaceTexture surfaceTexture) {
