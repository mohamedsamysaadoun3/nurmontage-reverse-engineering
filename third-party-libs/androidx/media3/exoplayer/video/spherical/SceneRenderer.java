...
final class SceneRenderer implements VideoFrameMetadataListener, CameraMotionListener {
    ...
    public SurfaceTexture init() {
        try {
            ...
            Log.m58e(TAG, "Failed to initialize the renderer", e);
        }
        ...
        surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: androidx.media3.exoplayer.video.spherical.SceneRenderer$$ExternalSyntheticLambda0
            ...
            public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                SceneRenderer.this.m206x200ab998(surfaceTexture2);
            }
        });
        return this.surfaceTexture;
    }

    /* renamed from: lambda$init$0$androidx-media3-exoplayer-video-spherical-SceneRenderer */
    /* synthetic */ void m206x200ab998(SurfaceTexture surfaceTexture) {
    ...
    public void drawFrame(float[] fArr, boolean z) {
        ...
        try {
            ...
            Log.m58e(TAG, "Failed to draw a frame", e);
        }
        if (this.frameAvailable.compareAndSet(true, false)) {
            ...
            try {
                ...
                Log.m58e(TAG, "Failed to draw a frame", e2);
            }
