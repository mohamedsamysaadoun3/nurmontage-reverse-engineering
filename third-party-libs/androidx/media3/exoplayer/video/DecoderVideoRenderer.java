...
public abstract class DecoderVideoRenderer extends BaseRenderer {
    ...
    public void render(long j, long j2) throws ExoPlaybackException {
        ...
        if (this.decoder != null) {
            try {
                ...
                Log.m58e(TAG, "Video codec error", e);
    ...
    private boolean processOutputBuffer(long j, long j2) throws ExoPlaybackException, DecoderException {
        if (this.initialPositionUs == C0366C.TIME_UNSET) {
    ...
    private void setJoiningDeadlineMs() {
        this.joiningDeadlineMs = this.allowedJoiningTimeMs > 0 ? SystemClock.elapsedRealtime() + this.allowedJoiningTimeMs : C0366C.TIME_UNSET;
    }
