...
public final class PlaceholderSurface extends Surface {
    ...
    private static int getSecureMode(Context context) {
        try {
            ...
            Log.m57e(TAG, "Failed to determine secure mode due to GL error: " + e.getMessage());
            return 0;
        }
    }
        ...
        public boolean handleMessage(Message message) {
            ...
            try {
                ...
                try {
                    ...
                    Log.m58e(PlaceholderSurface.TAG, "Failed to initialize placeholder surface", e);
                    this.initException = new IllegalStateException(e);
                    synchronized (this) {
                        notify();
                    }
                } catch (Error e2) {
                    Log.m58e(PlaceholderSurface.TAG, "Failed to initialize placeholder surface", e2);
                    this.initError = e2;
                    synchronized (this) {
                        notify();
                    }
                } catch (RuntimeException e3) {
                    Log.m58e(PlaceholderSurface.TAG, "Failed to initialize placeholder surface", e3);
