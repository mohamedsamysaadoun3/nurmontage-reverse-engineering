...
public final class MediaCodecUtil {
    ...
    public static void warmDecoderInfoCache(String str, boolean z, boolean z2) {
        try {
            ...
            Log.m58e(TAG, "Codec warming failed", e);
        }
    }
        ...
        try {
            ...
            while (i2 < codecCount) {
                ...
                if (!isAlias(codecInfoAt)) {
                    ...
                    if (isCodecUsableDecoder(codecInfoAt, name, secureDecodersExplicit, str5) && (codecMimeType = getCodecMimeType(codecInfoAt, name, str5)) != null) {
                        try {
                            ...
                            if ((codecKey.tunneling || !isFeatureRequired) && (!codecKey.tunneling || isFeatureSupported)) {
                                ...
                                if ((codecKey.secure || !isFeatureRequired2) && (!codecKey.secure || isFeatureSupported2)) {
                                    boolean isHardwareAccelerated = isHardwareAccelerated(codecInfoAt, str5);
                                    boolean isSoftwareOnly = isSoftwareOnly(codecInfoAt, str5);
                                    boolean isVendor = isVendor(codecInfoAt);
                                    try {
                                        if (!secureDecodersExplicit || codecKey.secure != isFeatureSupported2) {
                                            if (!secureDecodersExplicit) {
                                                try {
                                                    ...
                                                    str3 = name;
                                                    str2 = str3;
                                                    Log.m57e(TAG, "Failed to query codec " + str2 + " (" + str + ")");
                                                    throw e;
                                                }
                                            }
                                            str = codecMimeType;
                                            ...
                                            if (!z && isFeatureSupported2) {
                                                try {
                                                    str4 = name;
                                                    try {
                                                        arrayList.add(MediaCodecInfo.newInstance(str4 + ".secure", str5, str, capabilitiesForType, isHardwareAccelerated, isSoftwareOnly, isVendor, false, true));
                                                        return arrayList;
                                                    } catch (Exception e2) {
                                                        e = e2;
                                                        str2 = str4;
                                        ...
                                        arrayList.add(MediaCodecInfo.newInstance(name, str5, codecMimeType, capabilitiesForType, isHardwareAccelerated, isSoftwareOnly, isVendor, false, false));
                                        i2 = i + 1;
                                        secureDecodersExplicit = z;
                                    } catch (Exception e4) {
                                        e = e4;
