...
public abstract class DecoderAudioRenderer<T extends Decoder<DecoderInputBuffer, ? extends SimpleDecoderOutputBuffer, ? extends DecoderException>> extends BaseRenderer implements MediaClock {
    ...
    public DecoderAudioRenderer(Handler handler, AudioRendererEventListener audioRendererEventListener, AudioSink audioSink) {
        ...
        setOutputStreamOffsetUs(C0366C.TIME_UNSET);
        ...
        this.nextBufferToWritePresentationTimeUs = C0366C.TIME_UNSET;
    }

    @Override // androidx.media3.exoplayer.Renderer
    public long getDurationToProgressUs(long j, long j2) {
        boolean z = this.nextBufferToWritePresentationTimeUs != C0366C.TIME_UNSET;
        if (!this.isStarted) {
        ...
        if (!z || audioTrackBufferSizeUs == C0366C.TIME_UNSET) {
            return Renderer.DEFAULT_DURATION_TO_PROGRESS_US;
        }
    ...
    public void render(long j, long j2) throws ExoPlaybackException {
        ...
        if (this.decoder != null) {
            try {
                ...
                Log.m58e(TAG, "Audio codec error", e3);
    ...
    private boolean feedInputBuffer() throws DecoderException, ExoPlaybackException {
        ...
        if (!this.firstStreamSampleRead) {
            ...
            this.inputBuffer.addFlag(C0366C.BUFFER_FLAG_FIRST_SAMPLE);
        }
    ...
    protected void onStreamChanged(Format[] formatArr, long j, long j2, MediaSource.MediaPeriodId mediaPeriodId) throws ExoPlaybackException {
        ...
        if (this.outputStreamOffsetUs == C0366C.TIME_UNSET) {
            setOutputStreamOffsetUs(j2);
            return;
        }
        int i = this.pendingOutputStreamOffsetCount;
        if (i == this.pendingOutputStreamOffsetsUs.length) {
            Log.m61w(TAG, "Too many stream changes, so dropping offset: " + this.pendingOutputStreamOffsetsUs[this.pendingOutputStreamOffsetCount - 1]);
        } else {
    ...
    private void maybeInitDecoder() throws ExoPlaybackException {
        ...
        try {
            ...
            Log.m58e(TAG, "Audio codec error", e);
    ...
    private final class AudioSinkListener implements AudioSink.Listener {
        ...
        public void onAudioSinkError(Exception exc) {
            Log.m58e(DecoderAudioRenderer.TAG, "Audio sink error", exc);
