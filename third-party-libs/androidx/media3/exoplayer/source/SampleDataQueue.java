...
class SampleDataQueue {
    ...
    private static AllocationNode readEncryptionData(AllocationNode allocationNode, DecoderInputBuffer decoderInputBuffer, SampleQueue.SampleExtrasHolder sampleExtrasHolder, ParsableByteArray parsableByteArray) {
        ...
        if (cryptoInfo.f103iv == null) {
            cryptoInfo.f103iv = new byte[16];
        } else {
            Arrays.fill(cryptoInfo.f103iv, (byte) 0);
        }
        AllocationNode readData2 = readData(readData, j2, cryptoInfo.f103iv, i2);
        long j3 = j2 + i2;
        if (z) {
        ...
        cryptoInfo.set(i3, iArr2, iArr4, cryptoData.encryptionKey, cryptoInfo.f103iv, cryptoData.cryptoMode, cryptoData.encryptedBlocks, cryptoData.clearBlocks);
