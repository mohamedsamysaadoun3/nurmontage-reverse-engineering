...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    protected void prepareSourceInternal(TransferListener transferListener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$$ExternalSyntheticLambda0
            ...
            public final void run() {
                AdsMediaSource.this.m159x9f9466de(componentListener);
            }
        });
    }

    /* renamed from: lambda$prepareSourceInternal$0$androidx-media3-exoplayer-source-ads-AdsMediaSource */
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        MediaSource.MediaPeriodId mediaPeriodId = maskingMediaPeriod.f109id;
    ...
    protected void releaseSourceInternal() {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                AdsMediaSource.this.m160x4d6cb35f(componentListener);
            }
        });
    }

    /* renamed from: lambda$releaseSourceInternal$1$androidx-media3-exoplayer-source-ads-AdsMediaSource */
    ...
    public void m146x28f9175(MediaSource.MediaPeriodId mediaPeriodId, MediaSource mediaSource, final Timeline timeline) {
        if (mediaPeriodId.isAd()) {
            ...
            this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    AdsMediaSource.this.m158xbe1bc96f(timeline);
                }
            });
    ...
    /* renamed from: lambda$onChildSourceInfoRefreshed$2$androidx-media3-exoplayer-source-ads-AdsMediaSource */
    /* synthetic */ void m158xbe1bc96f(Timeline timeline) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (i2 < adMediaSourceHolderArr2.length) {
                    ...
                    jArr[i][i2] = adMediaSourceHolder == null ? C0366C.TIME_UNSET : adMediaSourceHolder.getDurationUs();
                    i2++;
                }
            }
            i++;
    ...
    final class ComponentListener implements AdsLoader.EventListener {
        ...
        public void onAdPlaybackState(final AdPlaybackState adPlaybackState) {
            ...
            this.playerHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$ComponentListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    AdsMediaSource.ComponentListener.this.m163x6396e000(adPlaybackState);
                }
            });
        }

        /* renamed from: lambda$onAdPlaybackState$0$androidx-media3-exoplayer-source-ads-AdsMediaSource$ComponentListener */
    ...
    final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        ...
        public void onPrepareComplete(final MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    AdsMediaSource.AdPrepareListener.this.m161x672fc1f4(mediaPeriodId);
                }
            });
        }

        /* renamed from: lambda$onPrepareComplete$0$androidx-media3-exoplayer-source-ads-AdsMediaSource$AdPrepareListener */
        ...
        public void onPrepareError(final MediaSource.MediaPeriodId mediaPeriodId, final IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    AdsMediaSource.AdPrepareListener.this.m162xa9898f8e(mediaPeriodId, iOException);
                }
            });
        }

        /* renamed from: lambda$onPrepareError$1$androidx-media3-exoplayer-source-ads-AdsMediaSource$AdPrepareListener */
    ...
    private final class AdMediaSourceHolder {
        ...
        /* renamed from: id */
        private final MediaSource.MediaPeriodId f111id;
        ...
        public void initializeWithMediaSource(MediaSource mediaSource, MediaItem mediaItem) {
            ...
            AdsMediaSource.this.prepareChildSource(this.f111id, mediaSource);
        }
        ...
        public void handleSourceInfoRefresh(Timeline timeline) {
            ...
            if (this.timeline == null) {
                ...
                for (int i = 0; i < this.activeMediaPeriods.size(); i++) {
                    MaskingMediaPeriod maskingMediaPeriod = this.activeMediaPeriods.get(i);
                    maskingMediaPeriod.createPeriod(new MediaSource.MediaPeriodId(uidOfPeriod, maskingMediaPeriod.f109id.windowSequenceNumber));
                }
            }
        ...
        public long getDurationUs() {
            Timeline timeline = this.timeline;
            return timeline == null ? C0366C.TIME_UNSET : timeline.getPeriod(0, AdsMediaSource.this.period).getDurationUs();
        }
        ...
        public void release() {
            if (hasMediaSource()) {
                AdsMediaSource.this.releaseChildSource(this.f111id);
            }
        }
