...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    private ImmutableMap<Object, AdPlaybackState> adPlaybackStates = ImmutableMap.m412of();
            ...
            if (handler == null) {
                ...
                handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.ServerSideAdInsertionMediaSource$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ServerSideAdInsertionMediaSource.this.m164x8b1696bf(immutableMap, timeline);
                    }
                });
            }
        }
    ...
    /* renamed from: lambda$setAdPlaybackStates$0$androidx-media3-exoplayer-source-ads-ServerSideAdInsertionMediaSource */
    ...
    private static final class SharedMediaPeriod implements MediaPeriod.Callback {
        ...
        public MediaPeriodImpl getMediaPeriodForEvent(MediaLoadData mediaLoadData) {
            if (mediaLoadData == null || mediaLoadData.mediaStartTimeMs == C0366C.TIME_UNSET) {
                return null;
            }
        ...
        public long readDiscontinuity(MediaPeriodImpl mediaPeriodImpl) {
            ...
            return readDiscontinuity == C0366C.TIME_UNSET ? C0366C.TIME_UNSET : ServerSideAdInsertionUtil.getMediaPeriodPositionUs(readDiscontinuity, mediaPeriodImpl.mediaPeriodId, this.adPlaybackState);
        }
            ...
            loop0: while (true) {
                ...
                if (exoTrackSelection != null) {
                    ...
                    for (int i2 = 0; i2 < trackGroup.length; i2++) {
                        ...
                        if (format.equals(mediaLoadData.trackFormat) || (z && format.f94id != null && format.f94id.equals(mediaLoadData.trackFormat.f94id))) {
                            break loop0;
                        }
                    }
                }
    ...
    private static final class ServerSideAdInsertionTimeline extends ForwardingTimeline {
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            ...
            } else if (adPlaybackState.contentDurationUs != C0366C.TIME_UNSET) {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            period.set(period.f98id, period.uid, period.windowIndex, j2, j3, adPlaybackState, period.isPlaceholder);
            return period;
        }
    }
