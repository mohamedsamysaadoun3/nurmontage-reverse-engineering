...
public final class PreloadMediaSource extends WrappingMediaSource {
    ...
    public void preload(final long j) {
        this.preloadHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.preload.PreloadMediaSource$$ExternalSyntheticLambda3
            ...
            public final void run() {
                PreloadMediaSource.this.m182xf99e9a56(j);
            }
        });
    }

    /* renamed from: lambda$preload$0$androidx-media3-exoplayer-source-preload-PreloadMediaSource */
    /* synthetic */ void m182xf99e9a56(long j) {
    ...
    public void clear() {
        Util.postOrRun(this.preloadHandler, new Runnable() { // from class: androidx.media3.exoplayer.source.preload.PreloadMediaSource$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                PreloadMediaSource.this.m180xcf4780db();
            }
        });
    }

    /* renamed from: lambda$clear$1$androidx-media3-exoplayer-source-preload-PreloadMediaSource */
    /* synthetic */ void m180xcf4780db() {
    ...
    protected void onChildSourceInfoRefreshed(final Timeline timeline) {
        ...
        this.preloadHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.preload.PreloadMediaSource$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                PreloadMediaSource.this.m181xd674fafd(timeline);
            }
        });
    }

    /* renamed from: lambda$onChildSourceInfoRefreshed$2$androidx-media3-exoplayer-source-preload-PreloadMediaSource */
    /* synthetic */ void m181xd674fafd(Timeline timeline) {
    ...
    public void releasePreloadMediaSource() {
        this.releaseHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.preload.PreloadMediaSource$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                PreloadMediaSource.this.m183xd9831bcd();
            }
        });
    }

    /* renamed from: lambda$releasePreloadMediaSource$3$androidx-media3-exoplayer-source-preload-PreloadMediaSource */
    /* synthetic */ void m183xd9831bcd() {
    ...
    class PreloadMediaPeriodCallback implements MediaPeriod.Callback {
        ...
        public void onPrepared(final MediaPeriod mediaPeriod) {
            ...
            PreloadMediaSource.this.preloadHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.preload.PreloadMediaSource$PreloadMediaPeriodCallback$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    PreloadMediaSource.PreloadMediaPeriodCallback.this.m185x5a2a8722(mediaPeriod);
                }
            });
        }

        /* renamed from: lambda$onPrepared$0$androidx-media3-exoplayer-source-preload-PreloadMediaSource$PreloadMediaPeriodCallback */
        /* synthetic */ void m185x5a2a8722(MediaPeriod mediaPeriod) {
            ...
            try {
                ...
                Log.m58e(PreloadMediaSource.TAG, "Failed to select tracks", e);
        ...
        public void onContinueLoadingRequested(final MediaPeriod mediaPeriod) {
            PreloadMediaSource.this.preloadHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.preload.PreloadMediaSource$PreloadMediaPeriodCallback$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    PreloadMediaSource.PreloadMediaPeriodCallback.this.m184xba37e565(mediaPeriod);
                }
            });
        }

        /* renamed from: lambda$onContinueLoadingRequested$1$androidx-media3-exoplayer-source-preload-PreloadMediaSource$PreloadMediaPeriodCallback */
        /* synthetic */ void m184xba37e565(MediaPeriod mediaPeriod) {
            if (PreloadMediaSource.this.isUsedByPlayer()) {
                return;
            }
            PreloadMediaPeriod preloadMediaPeriod = (PreloadMediaPeriod) mediaPeriod;
