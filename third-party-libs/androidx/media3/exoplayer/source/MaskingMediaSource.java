...
public final class MaskingMediaSource extends WrappingMediaSource {
    ...
    */
    protected void onChildSourceInfoRefreshed(Timeline timeline) {
        ...
        if (this.isPrepared) {
            ...
            if (maskingMediaPeriod3 != null) {
                ...
                this.timeline.getPeriodByUid(this.unpreparedMaskingMediaPeriod.f109id.periodUid, this.period);
                ...
                if (positionInWindowUs != this.timeline.getWindow(0, this.window).getDefaultPositionUs()) {
                    ...
                    if (maskingMediaPeriod != null && setPreparePositionOverrideToUnpreparedMaskingPeriod(longValue)) {
                        copyWithPeriodUid = maskingMediaPeriod.f109id.copyWithPeriodUid(getInternalPeriodUid(maskingMediaPeriod.f109id.periodUid));
                        this.hasRealTimeline = true;
    ...
    private boolean setPreparePositionOverrideToUnpreparedMaskingPeriod(long j) {
        ...
        int indexOfPeriod = this.timeline.getIndexOfPeriod(maskingMediaPeriod.f109id.periodUid);
        if (indexOfPeriod == -1) {
            return false;
        }
    ...
    public static final class PlaceholderTimeline extends Timeline {
        ...
        @Override // androidx.media3.common.Timeline
        public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            window.set(Timeline.Window.SINGLE_WINDOW_UID, this.mediaItem, null, C0366C.TIME_UNSET, C0366C.TIME_UNSET, C0366C.TIME_UNSET, false, true, null, 0L, C0366C.TIME_UNSET, 0, 0, 0L);
        ...
        @Override // androidx.media3.common.Timeline
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            period.set(z ? 0 : null, z ? MaskingTimeline.MASKING_EXTERNAL_PERIOD_UID : null, 0, C0366C.TIME_UNSET, 0L, AdPlaybackState.NONE, true);
            return period;
        }
