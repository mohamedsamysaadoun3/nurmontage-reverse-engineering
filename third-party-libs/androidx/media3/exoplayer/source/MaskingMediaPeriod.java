...
public final class MaskingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    /* renamed from: id */
    public final MediaSource.MediaPeriodId f109id;
    private PrepareListener listener;
    private MediaPeriod mediaPeriod;
    private MediaSource mediaSource;
    private boolean notifiedPrepareError;
    private long preparePositionOverrideUs = C0366C.TIME_UNSET;
    ...
    public void maybeThrowPrepareError() throws IOException {
        try {
            ...
            prepareListener.onPrepareError(this.f109id, e);
        }
    }
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        long j3 = (j2 == C0366C.TIME_UNSET || j != this.preparePositionUs) ? j : j2;
        this.preparePositionOverrideUs = C0366C.TIME_UNSET;
    ...
    public void onPrepared(MediaPeriod mediaPeriod) {
        ...
        PrepareListener prepareListener = this.listener;
        if (prepareListener != null) {
            prepareListener.onPrepareComplete(this.f109id);
        }
    }

    private long getPreparePositionWithOverride(long j) {
        long j2 = this.preparePositionOverrideUs;
        return j2 != C0366C.TIME_UNSET ? j2 : j;
    }
}
