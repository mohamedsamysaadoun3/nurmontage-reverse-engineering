...
public final class ConcatenatingMediaSource2 extends CompositeMediaSource<Integer> {
    ...
    public static final class Builder {
        ...
        public Builder add(MediaItem mediaItem) {
            return add(mediaItem, C0366C.TIME_UNSET);
        }

        public Builder add(MediaItem mediaItem, long j) {
            Assertions.checkNotNull(mediaItem);
            if (j == C0366C.TIME_UNSET && mediaItem.clippingConfiguration.endPositionMs != Long.MIN_VALUE) {
        ...
        public Builder add(MediaSource mediaSource) {
            return add(mediaSource, C0366C.TIME_UNSET);
        }

        public Builder add(MediaSource mediaSource, long j) {
            Assertions.checkNotNull(mediaSource);
            Assertions.checkState(((mediaSource instanceof ProgressiveMediaSource) && j == C0366C.TIME_UNSET) ? false : true, "Progressive media source must define an initial placeholder duration.");
    ...
    public void m146x28f9175(Integer num, MediaSource mediaSource, Timeline timeline) {
        scheduleTimelineUpdate();
    }
    ...
    public long getMediaTimeForChildMediaTime(Integer num, long j, MediaSource.MediaPeriodId mediaPeriodId) {
        Long l;
        return (j == C0366C.TIME_UNSET || mediaPeriodId == null || mediaPeriodId.isAd() || (l = this.mediaSourceHolders.get(num.intValue()).periodTimeOffsetsByUid.get(mediaPeriodId.periodUid)) == null) ? j : j + Util.usToMs(l.longValue());
    }
    ...
    private ConcatenatedTimeline maybeCreateConcatenatedTimeline() {
        ...
        while (i2 < size) {
            ...
            while (i4 < timeline2.getWindowCount()) {
                ...
                if (j5 == C0366C.TIME_UNSET) {
                    if (mediaSourceHolder.initialPlaceholderDurationUs == C0366C.TIME_UNSET) {
                        return null;
                    }
                ...
                while (i5 <= window.lastPeriodIndex) {
                    ...
                    if (i5 != window.firstPeriodIndex || ((mediaSourceHolder.index == 0 && i4 == 0) || j6 == C0366C.TIME_UNSET)) {
                        obj2 = obj;
                        timeline = timeline2;
                        j = 0;
                    } else {
    ...
    private static final class ConcatenatedTimeline extends Timeline {
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            return window.set(Timeline.Window.SINGLE_WINDOW_UID, this.mediaItem, this.manifest, C0366C.TIME_UNSET, C0366C.TIME_UNSET, C0366C.TIME_UNSET, this.isSeekable, this.isDynamic, null, this.defaultPositionUs, this.durationUs, 0, getPeriodCount() - 1, -this.periodOffsetsInWindowUs.get(0).longValue());
        }
