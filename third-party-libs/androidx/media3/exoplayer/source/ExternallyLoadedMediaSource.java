...
public final class ExternallyLoadedMediaSource extends BaseMediaSource {
    ...
    public boolean canUpdateMediaItem(MediaItem mediaItem) {
        ...
        return localConfiguration != null && localConfiguration.uri.equals(localConfiguration2.uri) && Objects.equals(localConfiguration.mimeType, localConfiguration2.mimeType) && (localConfiguration.imageDurationMs == C0366C.TIME_UNSET || Util.msToUs(localConfiguration.imageDurationMs) == this.timelineDurationUs);
    }
