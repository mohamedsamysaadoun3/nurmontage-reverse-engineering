...
public final class ClippingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public ClippingMediaPeriod(MediaPeriod mediaPeriod, boolean z, long j, long j2) {
        ...
        this.pendingInitialDiscontinuityPositionUs = z ? j : C0366C.TIME_UNSET;
        this.startUs = j;
        this.endUs = j2;
    }
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        this.pendingInitialDiscontinuityPositionUs = (isPendingInitialDiscontinuity() && shouldKeepInitialDiscontinuity(selectTracks, j, exoTrackSelectionArr)) ? enforceClippingRange : C0366C.TIME_UNSET;
    ...
    public long readDiscontinuity() {
        if (isPendingInitialDiscontinuity()) {
            ...
            this.pendingInitialDiscontinuityPositionUs = C0366C.TIME_UNSET;
            long readDiscontinuity = readDiscontinuity();
            return readDiscontinuity != C0366C.TIME_UNSET ? readDiscontinuity : j;
        }
        long readDiscontinuity2 = this.mediaPeriod.readDiscontinuity();
        return readDiscontinuity2 == C0366C.TIME_UNSET ? C0366C.TIME_UNSET : enforceClippingRange(readDiscontinuity2, this.startUs, this.endUs);
    }
    ...
    boolean isPendingInitialDiscontinuity() {
        return this.pendingInitialDiscontinuityPositionUs != C0366C.TIME_UNSET;
    }
