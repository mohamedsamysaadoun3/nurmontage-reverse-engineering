...
public final class Loader implements LoaderErrorThrower {
    ...
    static {
        ...
        RETRY = createRetryAction(false, C0366C.TIME_UNSET);
        RETRY_RESET_ERROR_COUNT = createRetryAction(true, C0366C.TIME_UNSET);
    ...
    private final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                Log.m58e(TAG, "OutOfMemory error loading stream", e2);
                obtainMessage(3, new UnexpectedLoaderException(e2)).sendToTarget();
            } catch (Error e3) {
                if (!this.released) {
                    Log.m58e(TAG, "Unexpected error loading stream", e3);
                ...
                Log.m58e(TAG, "Unexpected exception loading stream", e4);
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 2) {
                try {
                    ...
                    Log.m58e(TAG, "Unexpected exception handling load completed", e);
            ...
            if (onLoadError.type != 3) {
                if (onLoadError.type != 2) {
                    ...
                    if (onLoadError.retryDelayMillis != C0366C.TIME_UNSET) {
