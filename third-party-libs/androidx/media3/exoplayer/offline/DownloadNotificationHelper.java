...
import androidx.media3.exoplayer.C0443R;
...
public final class DownloadNotificationHelper {
    ...
    */
    public Notification buildProgressNotification(Context context, int i, PendingIntent pendingIntent, String str, List<Download> list, int i2) {
        ...
        if (z4) {
            i4 = C0443R.string.exo_download_downloading;
        } else {
            if (z5 && i2 != 0) {
                if ((i2 & 2) != 0) {
                    i5 = C0443R.string.exo_download_paused_for_wifi;
                } else if ((i2 & 1) != 0) {
                    i5 = C0443R.string.exo_download_paused_for_network;
                } else {
                    i5 = C0443R.string.exo_download_paused;
                }
                i3 = i5;
                z = false;
                if (z) {
            ...
            if (z7) {
                i4 = C0443R.string.exo_download_removing;
            } else {
                i3 = 0;
                z = true;
                if (z) {
    ...
    public Notification buildDownloadCompletedNotification(Context context, int i, PendingIntent pendingIntent, String str) {
        return buildEndStateNotification(context, i, pendingIntent, str, C0443R.string.exo_download_completed);
    }

    public Notification buildDownloadFailedNotification(Context context, int i, PendingIntent pendingIntent, String str) {
        return buildEndStateNotification(context, i, pendingIntent, str, C0443R.string.exo_download_failed);
    }
