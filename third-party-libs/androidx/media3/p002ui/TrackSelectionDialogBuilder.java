...
public final class TrackSelectionDialogBuilder {
    ...
    public TrackSelectionDialogBuilder(Context context, CharSequence charSequence, List<Tracks.Group> list, DialogCallback dialogCallback) {
        ...
        this.overrides = ImmutableMap.m412of();
    }
    ...
    public TrackSelectionDialogBuilder setOverride(TrackSelectionOverride trackSelectionOverride) {
        Map<TrackGroup, TrackSelectionOverride> m413of;
        if (trackSelectionOverride == null) {
            m413of = Collections.emptyMap();
        } else {
            m413of = ImmutableMap.m413of(trackSelectionOverride.mediaTrackGroup, trackSelectionOverride);
        }
        return setOverrides(m413of);
    }
    ...
    private Dialog buildForPlatform() {
        ...
        View inflate = LayoutInflater.from(builder.getContext()).inflate(C0628R.layout.exo_track_selection_dialog, (ViewGroup) null);
    ...
    private Dialog buildForAndroidX() {
        try {
            ...
            View inflate = LayoutInflater.from((Context) cls.getMethod("getContext", new Class[0]).invoke(newInstance, new Object[0])).inflate(C0628R.layout.exo_track_selection_dialog, (ViewGroup) null);
            ...
            cls.getMethod("setPositiveButton", Integer.TYPE, DialogInterface.OnClickListener.class).invoke(newInstance, Integer.valueOf(R.string.ok), upDialogView);
    ...
    private DialogInterface.OnClickListener setUpDialogView(View view) {
        final TrackSelectionView trackSelectionView = (TrackSelectionView) view.findViewById(C0628R.id.exo_track_selection_view);
        ...
        return new DialogInterface.OnClickListener() { // from class: androidx.media3.ui.TrackSelectionDialogBuilder$$ExternalSyntheticLambda0
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                TrackSelectionDialogBuilder.this.m218xc121951d(trackSelectionView, dialogInterface, i);
            }
        };
    }

    /* renamed from: lambda$setUpDialogView$1$androidx-media3-ui-TrackSelectionDialogBuilder */
    /* synthetic */ void m218xc121951d(TrackSelectionView trackSelectionView, DialogInterface dialogInterface, int i) {
