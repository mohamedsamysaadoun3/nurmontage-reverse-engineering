...
public class PlayerNotificationManager {
    ...
    public static class Builder {
        ...
        public Builder(Context context, int i, String str) {
            ...
            this.smallIconResourceId = C0628R.drawable.exo_notification_small_icon;
            this.playActionIconResourceId = C0628R.drawable.exo_notification_play;
            this.pauseActionIconResourceId = C0628R.drawable.exo_notification_pause;
            this.stopActionIconResourceId = C0628R.drawable.exo_notification_stop;
            this.rewindActionIconResourceId = C0628R.drawable.exo_notification_rewind;
            this.fastForwardActionIconResourceId = C0628R.drawable.exo_notification_fastforward;
            this.previousActionIconResourceId = C0628R.drawable.exo_notification_previous;
            this.nextActionIconResourceId = C0628R.drawable.exo_notification_next;
        }
    ...
    */
    ...
    private static Map<String, NotificationCompat.Action> createPlaybackActions(Context context, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        hashMap.put(ACTION_PLAY, new NotificationCompat.Action(i2, context.getString(C0628R.string.exo_controls_play_description), createBroadcastIntent(ACTION_PLAY, context, i)));
        hashMap.put(ACTION_PAUSE, new NotificationCompat.Action(i3, context.getString(C0628R.string.exo_controls_pause_description), createBroadcastIntent(ACTION_PAUSE, context, i)));
        hashMap.put(ACTION_STOP, new NotificationCompat.Action(i4, context.getString(C0628R.string.exo_controls_stop_description), createBroadcastIntent(ACTION_STOP, context, i)));
        hashMap.put(ACTION_REWIND, new NotificationCompat.Action(i5, context.getString(C0628R.string.exo_controls_rewind_description), createBroadcastIntent(ACTION_REWIND, context, i)));
        hashMap.put(ACTION_FAST_FORWARD, new NotificationCompat.Action(i6, context.getString(C0628R.string.exo_controls_fastforward_description), createBroadcastIntent(ACTION_FAST_FORWARD, context, i)));
        hashMap.put(ACTION_PREVIOUS, new NotificationCompat.Action(i7, context.getString(C0628R.string.exo_controls_previous_description), createBroadcastIntent(ACTION_PREVIOUS, context, i)));
        hashMap.put(ACTION_NEXT, new NotificationCompat.Action(i8, context.getString(C0628R.string.exo_controls_next_description), createBroadcastIntent(ACTION_NEXT, context, i)));
        return hashMap;
    }
