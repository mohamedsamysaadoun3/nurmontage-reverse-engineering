...
public class TrackSelectionView extends LinearLayout {
    ...
    public TrackSelectionView(Context context, AttributeSet attributeSet, int i) {
        ...
        checkedTextView.setText(C0628R.string.exo_track_selection_none);
        checkedTextView.setEnabled(false);
        checkedTextView.setFocusable(true);
        checkedTextView.setOnClickListener(componentListener);
        checkedTextView.setVisibility(8);
        addView(checkedTextView);
        addView(from.inflate(C0628R.layout.exo_list_divider, (ViewGroup) this, false));
        CheckedTextView checkedTextView2 = (CheckedTextView) from.inflate(R.layout.simple_list_item_single_choice, (ViewGroup) this, false);
        this.defaultView = checkedTextView2;
        checkedTextView2.setBackgroundResource(resourceId);
        checkedTextView2.setText(C0628R.string.exo_track_selection_auto);
    ...
    private void updateViews() {
        ...
        for (int i = 0; i < this.trackGroups.size(); i++) {
            ...
            for (int i4 = 0; i4 < i2; i4++) {
                if (i4 == 0) {
                    addView(this.inflater.inflate(C0628R.layout.exo_list_divider, (ViewGroup) this, false));
                }
    ...
    private void onTrackViewClicked(View view) {
        ...
        if (trackSelectionOverride == null) {
            ...
            this.overrides.put(mediaTrackGroup, new TrackSelectionOverride(mediaTrackGroup, ImmutableList.m394of(Integer.valueOf(i))));
            return;
        }
