...
final class PlayerControlViewLayoutManager {
    ...
    public PlayerControlViewLayoutManager(final PlayerControlView playerControlView) {
        ...
        this.controlsBackground = playerControlView.findViewById(C0628R.id.exo_controls_background);
        this.centerControls = (ViewGroup) playerControlView.findViewById(C0628R.id.exo_center_controls);
        this.minimalControls = (ViewGroup) playerControlView.findViewById(C0628R.id.exo_minimal_controls);
        ViewGroup viewGroup = (ViewGroup) playerControlView.findViewById(C0628R.id.exo_bottom_bar);
        this.bottomBar = viewGroup;
        this.timeView = (ViewGroup) playerControlView.findViewById(C0628R.id.exo_time);
        View findViewById = playerControlView.findViewById(C0628R.id.exo_progress);
        this.timeBar = findViewById;
        this.basicControls = (ViewGroup) playerControlView.findViewById(C0628R.id.exo_basic_controls);
        this.extraControls = (ViewGroup) playerControlView.findViewById(C0628R.id.exo_extra_controls);
        this.extraControlsScrollView = (ViewGroup) playerControlView.findViewById(C0628R.id.exo_extra_controls_scroll_view);
        View findViewById2 = playerControlView.findViewById(C0628R.id.exo_overflow_show);
        this.overflowShowButton = findViewById2;
        View findViewById3 = playerControlView.findViewById(C0628R.id.exo_overflow_hide);
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                PlayerControlViewLayoutManager.this.m844lambda$new$0$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                PlayerControlViewLayoutManager.this.m845lambda$new$1$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        ...
        float dimension = resources.getDimension(C0628R.dimen.exo_styled_bottom_bar_height) - resources.getDimension(C0628R.dimen.exo_styled_progress_bar_height);
        float dimension2 = resources.getDimension(C0628R.dimen.exo_styled_bottom_bar_height);
        ...
        ofFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda6
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                PlayerControlViewLayoutManager.this.m846lambda$new$2$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        ...
        ofFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda7
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                PlayerControlViewLayoutManager.this.m847lambda$new$3$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
    ...
    /* synthetic */ void m844lambda$new$0$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
    ...
    /* synthetic */ void m845lambda$new$1$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        View view = this.controlsBackground;
        if (view != null) {
            view.setAlpha(floatValue);
    ...
    /* synthetic */ void m846lambda$new$2$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
    ...
    /* synthetic */ void m847lambda$new$3$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
        animateOverflow(((Float) valueAnimator.getAnimatedValue()).floatValue());
    }
    ...
    public void onOverflowButtonClick(View view) {
        resetHideCallbacks();
        if (view.getId() == C0628R.id.exo_overflow_show) {
            this.overflowShowAnimator.start();
        } else if (view.getId() == C0628R.id.exo_overflow_hide) {
    ...
    public void updateLayoutForSizeChange() {
        ...
        if (this.timeBar != null) {
            int dimensionPixelSize = this.playerControlView.getResources().getDimensionPixelSize(C0628R.dimen.exo_styled_progress_margin_bottom);
    ...
    private boolean shouldHideInMinimalMode(View view) {
        int id = view.getId();
        return id == C0628R.id.exo_bottom_bar || id == C0628R.id.exo_prev || id == C0628R.id.exo_next || id == C0628R.id.exo_rew || id == C0628R.id.exo_rew_with_amount || id == C0628R.id.exo_ffwd || id == C0628R.id.exo_ffwd_with_amount;
    }
