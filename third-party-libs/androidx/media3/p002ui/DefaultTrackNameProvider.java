...
public class DefaultTrackNameProvider implements TrackNameProvider {
    ...
    @Override // androidx.media3.p002ui.TrackNameProvider
    public String getTrackName(Format format) {
        ...
        if (str == null || str.trim().isEmpty()) {
            return this.resources.getString(C0628R.string.exo_track_unknown);
        }
        return this.resources.getString(C0628R.string.exo_track_unknown_name, str);
    }
    ...
    private String buildResolutionString(Format format) {
        ...
        return this.resources.getString(C0628R.string.exo_track_resolution, Integer.valueOf(i), Integer.valueOf(i2));
    }
    ...
    private String buildBitrateString(Format format) {
        ...
        return this.resources.getString(C0628R.string.exo_track_bitrate, Float.valueOf(i / 1000000.0f));
    }
    ...
    private String buildAudioChannelString(Format format) {
        ...
        if (i == 1) {
            return this.resources.getString(C0628R.string.exo_track_mono);
        }
        if (i == 2) {
            return this.resources.getString(C0628R.string.exo_track_stereo);
        }
        if (i == 6 || i == 7) {
            return this.resources.getString(C0628R.string.exo_track_surround_5_point_1);
        }
        if (i == 8) {
            return this.resources.getString(C0628R.string.exo_track_surround_7_point_1);
        }
        return this.resources.getString(C0628R.string.exo_track_surround);
    }
    ...
    private String buildLanguageString(Format format) {
        String str = format.language;
        if (TextUtils.isEmpty(str) || C0366C.LANGUAGE_UNDETERMINED.equals(str)) {
            return "";
        }
    ...
    private String buildRoleString(Format format) {
        ...
        if ((format.roleFlags & 2) == 0) {
            ...
            str = this.resources.getString(C0628R.string.exo_track_role_alternate);
        }
        if ((format.roleFlags & 4) != 0) {
            str = joinWithSeparator(str, this.resources.getString(C0628R.string.exo_track_role_supplementary));
        }
        if ((format.roleFlags & 8) != 0) {
            str = joinWithSeparator(str, this.resources.getString(C0628R.string.exo_track_role_commentary));
        }
        return (format.roleFlags & 1088) != 0 ? joinWithSeparator(str, this.resources.getString(C0628R.string.exo_track_role_closed_captions)) : str;
    }
    ...
    private String joinWithSeparator(String... strArr) {
        ...
        for (String str2 : strArr) {
            if (!str2.isEmpty()) {
                str = TextUtils.isEmpty(str) ? str2 : this.resources.getString(C0628R.string.exo_item_list, str, str2);
            }
        }
        return str;
    }
