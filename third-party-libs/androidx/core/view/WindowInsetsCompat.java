...
public class WindowInsetsCompat {
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        return new Builder(this).setSystemWindowInsets(Insets.m12of(i, i2, i3, i4)).build();
    }

    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(Rect rect) {
        return new Builder(this).setSystemWindowInsets(Insets.m13of(rect)).build();
    }
        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 2) {
                if (z) {
                    ...
                    return Insets.m12of(Math.max(rootStableInsets.left, stableInsets2.left), 0, Math.max(rootStableInsets.right, stableInsets2.right), Math.max(rootStableInsets.bottom, stableInsets2.bottom));
                }
                ...
                return Insets.m12of(systemWindowInsets.left, 0, systemWindowInsets.right, i2);
            }
            if (i == 8) {
                ...
                if (systemWindowInsets2.bottom > rootStableInsets2.bottom) {
                    return Insets.m12of(0, 0, 0, systemWindowInsets2.bottom);
                }
            ...
            if (i == 128) {
                ...
                if (displayCutout != null) {
                    return Insets.m12of(displayCutout.getSafeInsetLeft(), displayCutout.getSafeInsetTop(), displayCutout.getSafeInsetRight(), displayCutout.getSafeInsetBottom());
                }
                return Insets.NONE;
            }
            return Insets.NONE;
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        return (max == i && max2 == i2 && max3 == i3 && max4 == i4) ? insets : Insets.m12of(max, max2, max3, max4);
    }
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (rect != null && rect2 != null) {
                            WindowInsetsCompat build = new Builder().setStableInsets(Insets.m13of(rect)).setSystemWindowInsets(Insets.m13of(rect2)).build();
