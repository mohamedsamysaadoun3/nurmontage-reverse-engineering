...
public class NotificationCompat {
        ...
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (this.mBuilder.mLargeIcon != null) {
                remoteViews.setViewVisibility(C0176R.id.icon, 0);
                remoteViews.setImageViewBitmap(C0176R.id.icon, createColoredBitmap(this.mBuilder.mLargeIcon, 0));
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0176R.dimen.notification_right_icon_size);
                    remoteViews.setImageViewBitmap(C0176R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize - (resources.getDimensionPixelSize(C0176R.dimen.notification_small_icon_background_padding) * 2), this.mBuilder.getColor()));
                    remoteViews.setViewVisibility(C0176R.id.right_icon, 0);
                }
            } else if (z && this.mBuilder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C0176R.id.icon, 0);
                remoteViews.setImageViewBitmap(C0176R.id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0176R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0176R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C0176R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
            }
            if (this.mBuilder.mContentTitle != null) {
                remoteViews.setTextViewText(C0176R.id.title, this.mBuilder.mContentTitle);
            }
            boolean z5 = true;
            if (this.mBuilder.mContentText != null) {
                remoteViews.setTextViewText(C0176R.id.text, this.mBuilder.mContentText);
                z3 = true;
            } else {
                z3 = false;
            }
            if (this.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0176R.id.info, this.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0176R.id.info, 0);
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C0176R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0176R.id.info, resources.getString(C0176R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0176R.id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0176R.id.info, 0);
            } else {
                remoteViews.setViewVisibility(C0176R.id.info, 8);
                z4 = false;
                if (this.mBuilder.mSubText != null) {
                    remoteViews.setTextViewText(C0176R.id.text, this.mBuilder.mSubText);
                    if (this.mBuilder.mContentText != null) {
                        remoteViews.setTextViewText(C0176R.id.text2, this.mBuilder.mContentText);
                        remoteViews.setViewVisibility(C0176R.id.text2, 0);
                        if (z2) {
                            remoteViews.setTextViewTextSize(C0176R.id.text, 0, resources.getDimensionPixelSize(C0176R.dimen.notification_subtext_size));
                        }
                        remoteViews.setViewPadding(C0176R.id.line1, 0, 0, 0, 0);
                    } else {
                        remoteViews.setViewVisibility(C0176R.id.text2, 8);
                    }
                }
                if (this.mBuilder.getWhenIfShowing() != 0) {
                    z5 = z4;
                } else if (this.mBuilder.mUseChronometer) {
                    remoteViews.setViewVisibility(C0176R.id.chronometer, 0);
                    remoteViews.setLong(C0176R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    remoteViews.setBoolean(C0176R.id.chronometer, "setStarted", true);
                    if (this.mBuilder.mChronometerCountDown) {
                        Api24Impl.setChronometerCountDown(remoteViews, C0176R.id.chronometer, this.mBuilder.mChronometerCountDown);
                    }
                } else {
                    remoteViews.setViewVisibility(C0176R.id.time, 0);
                    remoteViews.setLong(C0176R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                }
                remoteViews.setViewVisibility(C0176R.id.right_side, !z5 ? 0 : 8);
                remoteViews.setViewVisibility(C0176R.id.line3, z3 ? 0 : 8);
                return remoteViews;
            }
            z3 = true;
            z4 = true;
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0176R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0176R.id.notification_main_column);
            remoteViews.addView(C0176R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0176R.id.notification_main_column, 0);
            remoteViews.setViewPadding(C0176R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0176R.id.title, 8);
            remoteViews.setViewVisibility(C0176R.id.text2, 8);
            remoteViews.setViewVisibility(C0176R.id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0176R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0176R.dimen.notification_top_pad_large_text);
    ...
    public static class CallStyle extends Style {
        ...
        private String getDefaultText() {
            int i = this.mCallType;
            if (i == 1) {
                return this.mBuilder.mContext.getResources().getString(C0176R.string.call_notification_incoming_text);
            }
            if (i == 2) {
                return this.mBuilder.mContext.getResources().getString(C0176R.string.call_notification_ongoing_text);
            }
            if (i != 3) {
                return null;
            }
            return this.mBuilder.mContext.getResources().getString(C0176R.string.call_notification_screening_text);
        }

        private Action makeNegativeAction() {
            int i = C0176R.drawable.ic_call_decline_low;
            int i2 = C0176R.drawable.ic_call_decline;
            if (this.mDeclineIntent == null) {
                return makeAction(i2, C0176R.string.call_notification_hang_up_action, this.mDeclineButtonColor, C0176R.color.call_notification_decline_color, this.mHangUpIntent);
            }
            return makeAction(i2, C0176R.string.call_notification_decline_action, this.mDeclineButtonColor, C0176R.color.call_notification_decline_color, this.mDeclineIntent);
        }

        private Action makeAnswerAction() {
            int i;
            int i2 = C0176R.drawable.ic_call_answer_video_low;
            int i3 = C0176R.drawable.ic_call_answer_low;
            int i4 = C0176R.drawable.ic_call_answer_video;
            int i5 = C0176R.drawable.ic_call_answer;
            ...
            int i6 = z ? i4 : i5;
            if (z) {
                i = C0176R.string.call_notification_answer_video_action;
            } else {
                i = C0176R.string.call_notification_answer_action;
            }
            return makeAction(i6, i, this.mAnswerButtonColor, C0176R.color.call_notification_answer_color, this.mAnswerIntent);
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int min;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0176R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0176R.id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0176R.id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            applyStandardTemplate.setViewVisibility(C0176R.id.actions, i);
            applyStandardTemplate.setViewVisibility(C0176R.id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0176R.layout.notification_action_tombstone;
            } else {
                i = C0176R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0176R.id.action_image, createColoredBitmap(iconCompat, C0176R.color.notification_action_color_filter));
            }
            remoteViews.setTextViewText(C0176R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0176R.id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C0176R.id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m767clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m768clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static Bitmap reduceLargeIconSize(Context context, Bitmap bitmap) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0176R.dimen.compat_notification_large_icon_max_width);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C0176R.dimen.compat_notification_large_icon_max_height);
