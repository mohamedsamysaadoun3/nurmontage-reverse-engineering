...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C06741 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem next = C06741.this.mQueue.next();
                while (next != null) {
                    int i = next.what;
                    if (i == 1) {
                        C06741.this.val$callback.updateItemCount(next.arg1, next.arg2);
                    } else if (i == 2) {
                        C06741.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                    } else if (i == 3) {
                        C06741.this.val$callback.removeTile(next.arg1, next.arg2);
                    } else {
                        Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                    }
                    next = C06741.this.mQueue.next();
                }
            }
        };

        C06741(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C06741(mainThreadCallback);
    }

    /* renamed from: androidx.recyclerview.widget.MessageThreadUtil$2 */
    class C06752 implements ThreadUtil.BackgroundCallback<T> {
                ...
                while (true) {
                    ...
                    if (next != null) {
                        ...
                        if (i == 1) {
                            ...
                            C06752.this.val$callback.refresh(next.arg1);
                        } else if (i == 2) {
                            C06752.this.mQueue.removeMessages(2);
                            C06752.this.mQueue.removeMessages(3);
                            C06752.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                        } else if (i == 3) {
                            C06752.this.val$callback.loadTile(next.arg1, next.arg2);
                        } else if (i == 4) {
                            C06752.this.val$callback.recycleTile((TileList.Tile) next.data);
                        } else {
                            Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                        }
                    } else {
        ...
        C06752(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C06752(backgroundCallback);
    }
