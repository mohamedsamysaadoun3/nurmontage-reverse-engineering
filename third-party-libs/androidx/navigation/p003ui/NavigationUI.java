...
public final class NavigationUI {
    ...
    */
    public static final boolean onNavDestinationSelected(MenuItem item, NavController navController) {
        ...
        if (parent.findNode(item.getItemId()) instanceof ActivityNavigator.Destination) {
            restoreState.setEnterAnim(C0640R.anim.nav_default_enter_anim).setExitAnim(C0640R.anim.nav_default_exit_anim).setPopEnterAnim(C0640R.anim.nav_default_pop_enter_anim).setPopExitAnim(C0640R.anim.nav_default_pop_exit_anim);
        } else {
            restoreState.setEnterAnim(C0640R.animator.nav_default_enter_anim).setExitAnim(C0640R.animator.nav_default_exit_anim).setPopEnterAnim(C0640R.animator.nav_default_pop_enter_anim).setPopExitAnim(C0640R.animator.nav_default_pop_exit_anim);
        }
        if ((item.getOrder() & ProfileVerifier.CompilationStatus.f138xf2722a21) == 0) {
    ...
    */
    public static final boolean onNavDestinationSelected(MenuItem item, NavController navController, boolean saveState) {
        ...
        Intrinsics.checkNotNull(parent);
        if (parent.findNode(item.getItemId()) instanceof ActivityNavigator.Destination) {
            launchSingleTop.setEnterAnim(C0640R.anim.nav_default_enter_anim).setExitAnim(C0640R.anim.nav_default_exit_anim).setPopEnterAnim(C0640R.anim.nav_default_pop_enter_anim).setPopExitAnim(C0640R.anim.nav_default_pop_exit_anim);
        } else {
            launchSingleTop.setEnterAnim(C0640R.animator.nav_default_enter_anim).setExitAnim(C0640R.animator.nav_default_exit_anim).setPopEnterAnim(C0640R.animator.nav_default_pop_enter_anim).setPopExitAnim(C0640R.animator.nav_default_pop_exit_anim);
        }
        if ((item.getOrder() & ProfileVerifier.CompilationStatus.f138xf2722a21) == 0) {
