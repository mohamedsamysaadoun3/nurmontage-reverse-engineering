...
@Metadata(m667d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, m668d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;", "Landroid/graphics/Rect;"}, m669k = 3, m670mv = {1, 8, 0}, m672xi = 48)
@DebugMetadata(m684c = "androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1", m685f = "PipHintTracker.kt", m686i = {}, m687l = {85}, m688m = "invokeSuspend", m689n = {}, m690s = {})
        ...
        if (i == 0) {
            ...
            final ?? r3 = new View.OnAttachStateChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$attachStateChangeListener$1
                ...
                public void onViewAttachedToWindow(View v) {
                    ...
                    producerScope2.mo3165trySendJP2dKIU(trackPipAnimationHintView$positionInWindow2);
            ...
            if (Api19Impl.INSTANCE.isAttachedToWindow(this.$view)) {
                ...
                producerScope.mo3165trySendJP2dKIU(trackPipAnimationHintView$positionInWindow);
