...
public abstract class FragmentTransaction {
    ...
    static final class C0328Op {
        ...
        C0328Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0328Op(int i, Fragment fragment, boolean z) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        C0328Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
        ...
        C0328Op(C0328Op c0328Op) {
            this.mCmd = c0328Op.mCmd;
            this.mFragment = c0328Op.mFragment;
            this.mFromExpandedOp = c0328Op.mFromExpandedOp;
            this.mEnterAnim = c0328Op.mEnterAnim;
            this.mExitAnim = c0328Op.mExitAnim;
            this.mPopEnterAnim = c0328Op.mPopEnterAnim;
            this.mPopExitAnim = c0328Op.mPopExitAnim;
            this.mOldMaxState = c0328Op.mOldMaxState;
            this.mCurrentMaxState = c0328Op.mCurrentMaxState;
        }
    }
    ...
    FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction fragmentTransaction) {
        ...
        Iterator<C0328Op> it = fragmentTransaction.mOps.iterator();
        while (it.hasNext()) {
            this.mOps.add(new C0328Op(it.next()));
        }
    ...
    void addOp(C0328Op c0328Op) {
        this.mOps.add(c0328Op);
        c0328Op.mEnterAnim = this.mEnterAnim;
        c0328Op.mExitAnim = this.mExitAnim;
        c0328Op.mPopEnterAnim = this.mPopEnterAnim;
        c0328Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0328Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0328Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0328Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0328Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0328Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0328Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0328Op(10, fragment, state));
        return this;
    }
