...
public final class MetadataItem extends Table {
    ...
    public int m45id() {
        ...
        if (__offset != 0) {
            return this.f91bb.getInt(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public boolean emojiStyle() {
        ...
        return (__offset == 0 || this.f91bb.get(__offset + this.bb_pos) == 0) ? false : true;
    }

    public short sdkAdded() {
        int __offset = __offset(8);
        if (__offset != 0) {
            return this.f91bb.getShort(__offset + this.bb_pos);
        }
        return (short) 0;
    }
    ...
    public int codepoints(int i) {
        ...
        if (__offset != 0) {
            return this.f91bb.getInt(__vector(__offset) + (i * 4));
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector intVector) {
        int __offset = __offset(16);
        if (__offset != 0) {
            return intVector.__assign(__vector(__offset), this.f91bb);
        }
        return null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i) {
            return metadataItem.__assign(MetadataItem.__indirect(__element(i), this.f85bb), this.f85bb);
        }
    }
}
