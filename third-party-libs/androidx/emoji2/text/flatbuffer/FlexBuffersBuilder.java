...
public class FlexBuffersBuilder {
    ...
    public FlexBuffersBuilder(ReadWriteBuf readWriteBuf, int i) {
        ...
        this.keyComparator = new Comparator<Value>() { // from class: androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.1
            ...
            public int compare(Value value, Value value2) {
                ...
                int i3 = value2.key;
                do {
                    b = FlexBuffersBuilder.this.f89bb.get(i2);
                    b2 = FlexBuffersBuilder.this.f89bb.get(i3);
                    if (b == 0) {
                        return b - b2;
                    }
                    i2++;
    ...
    private int putKey(String str) {
        ...
        int writePosition = this.f89bb.writePosition();
        if ((this.flags & 1) != 0) {
            Integer num = this.keyPool.get(str);
            if (num == null) {
                byte[] bytes = str.getBytes(StandardCharsets.UTF_8);
                this.f89bb.put(bytes, 0, bytes.length);
        ...
        this.f89bb.put(bytes2, 0, bytes2.length);
        this.f89bb.put((byte) 0);
        this.keyPool.put(str, Integer.valueOf(writePosition));
        return writePosition;
    }
    ...
    private Value writeBlob(int i, byte[] bArr, int i2, boolean z) {
        ...
        int writePosition = this.f89bb.writePosition();
        this.f89bb.put(bArr, 0, bArr.length);
        if (z) {
            this.f89bb.put((byte) 0);
        }
    ...
    private int align(int i) {
        int i2 = 1 << i;
        int paddingBytes = Value.paddingBytes(this.f89bb.writePosition(), i2);
        while (true) {
    ...
    private void writeInt(long j, int i) {
        if (i == 1) {
            this.f89bb.put((byte) j);
            return;
        }
        if (i == 2) {
            this.f89bb.putShort((short) j);
        } else if (i == 4) {
            this.f89bb.putInt((int) j);
        } else {
            if (i != 8) {
                return;
            }
            this.f89bb.putLong(j);
        }
    }
    ...
    public ByteBuffer finish() {
        int align = align(this.stack.get(0).elemWidth(this.f89bb.writePosition(), 0));
        writeAny(this.stack.get(0), align);
        this.f89bb.put(this.stack.get(0).storedPackedType());
        this.f89bb.put((byte) align);
        this.finished = true;
    ...
    private Value createVector(int i, int i2, int i3, boolean z, boolean z2, Value value) {
        ...
        if (value != null) {
            max = Math.max(max, value.elemWidth(this.f89bb.writePosition(), 0));
            i4 = 3;
        } else {
            i4 = 1;
        }
        ...
        for (int i9 = i2; i9 < this.stack.size(); i9++) {
            i8 = Math.max(i8, this.stack.get(i9).elemWidth(this.f89bb.writePosition(), i9 + i4));
            if (z && i9 == i2) {
        ...
        if (!z) {
            while (i10 < this.stack.size()) {
                this.f89bb.put(this.stack.get(i10).storedPackedType(i8));
                i10++;
            }
        }
        if (value != null) {
    ...
    private void writeOffset(long j, int i) {
        writeInt((int) (this.f89bb.writePosition() - j), i);
    }
    ...
    private void writeDouble(double d, int i) {
        if (i == 4) {
            this.f89bb.putFloat((float) d);
        } else if (i == 8) {
            this.f89bb.putDouble(d);
        }
    }
    ...
    private Value createKeyVector(int i, int i2) {
        ...
        while (i3 < this.stack.size()) {
            i3++;
            max = Math.max(max, Value.elemWidth(4, 0, this.stack.get(i3).key, this.f89bb.writePosition(), i3));
        }
        int align = align(max);
        writeInt(j, align);
        int writePosition = this.f89bb.writePosition();
