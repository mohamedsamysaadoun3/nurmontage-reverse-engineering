...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            this.f86bb = byteBuffer;
            byteBuffer.clear();
            this.f86bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f86bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f86bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f86bb);
        return endVector();
    }
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int capacity = this.f86bb.capacity() - this.vtables[i5];
            int i6 = this.space;
            short s = this.f86bb.getShort(capacity);
            if (s == this.f86bb.getShort(i6)) {
                for (int i7 = 2; i7 < s; i7 += 2) {
                    if (this.f86bb.getShort(capacity + i7) != this.f86bb.getShort(i6 + i7)) {
                        break;
                    }
                }
                i = this.vtables[i5];
        ...
        if (i != 0) {
            int capacity2 = this.f86bb.capacity() - offset;
            this.space = capacity2;
            this.f86bb.putInt(capacity2, i - offset);
        } else {
    ...
    public void required(int i, int i2) {
        int capacity = this.f86bb.capacity() - i;
        if (this.f86bb.getShort((capacity - this.f86bb.getInt(capacity)) + i2) == 0) {
