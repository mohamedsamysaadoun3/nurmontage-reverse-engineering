...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public String asString() {
            if (isString()) {
                int indirect = FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f88bb;
                int i = this.byteWidth;
                return this.f88bb.getString(indirect, (int) FlexBuffers.readUInt(readBuf, indirect - i, i));
            }
            if (isKey()) {
                int indirect2 = FlexBuffers.indirect(this.f88bb, this.end, this.byteWidth);
                int i2 = indirect2;
                while (this.f88bb.get(i2) != 0) {
                    i2++;
                }
                return this.f88bb.getString(indirect2, i2 - indirect2);
            }
            return "";
        }
    ...
    private static abstract class Sized extends Object {
        ...
        Sized(ReadBuf readBuf, int i, int i2) {
            super(readBuf, i, i2);
            this.size = FlexBuffers.readInt(this.f87bb, i - i2, i2);
        }
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer wrap = ByteBuffer.wrap(this.f87bb.data());
        ...
        public byte[] getBytes() {
            ...
            for (int i = 0; i < size; i++) {
                bArr[i] = this.f87bb.get(this.end + i);
            }
            return bArr;
        }

        public byte get(int i) {
            return this.f87bb.get(this.end + i);
        }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            ...
            return this.f87bb.getString(this.end, i - this.end);
        }
    ...
    public static class Map extends Vector {
        ...
        public KeyVector keys() {
            ...
            return new KeyVector(new TypedVector(this.f87bb, FlexBuffers.indirect(this.f87bb, i, this.byteWidth), FlexBuffers.readInt(this.f87bb, i + this.byteWidth, this.byteWidth), 4));
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f87bb, this.end + (i * this.byteWidth), this.byteWidth, Unsigned.byteToUnsignedInt(this.f87bb.get((int) (this.end + (size * this.byteWidth) + j))));
        }
    }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f87bb, this.end + (i * this.byteWidth), this.byteWidth, 1, this.elemType);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int i) {
            ...
            return new Key(this.vec.f87bb, FlexBuffers.indirect(this.vec.f87bb, this.vec.end + (i * this.vec.byteWidth), this.vec.byteWidth), 1);
        }
