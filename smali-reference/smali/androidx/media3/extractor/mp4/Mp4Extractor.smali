...
.method private processMoovAtom(Landroidx/media3/container/Mp4Box$ContainerBox;)V
    ...
    invoke-direct {v5, v14, v9, v1}, Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4Track;-><init>(Landroidx/media3/extractor/mp4/Track;Landroidx/media3/extractor/mp4/TrackSampleTable;Landroidx/media3/extractor/TrackOutput;)V

    move v1, v4

    .line 738
    iget-wide v3, v14, Landroidx/media3/extractor/mp4/Track;->durationUs:J
    ...
    .line 739
    :goto_7
    iget-object v8, v5, Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4Track;->trackOutput:Landroidx/media3/extractor/TrackOutput;

    invoke-interface {v8, v3, v4}, Landroidx/media3/extractor/TrackOutput;->durationUs(J)V
    ...
    .line 745
    iget v3, v9, Landroidx/media3/extractor/mp4/TrackSampleTable;->maximumSize:I
    ...
    .line 752
    :goto_8
    iget-object v4, v14, Landroidx/media3/extractor/mp4/Track;->format:Landroidx/media3/common/Format;
    ...
    .line 753
    invoke-virtual {v4, v3}, Landroidx/media3/common/Format$Builder;->setMaxInputSize(I)Landroidx/media3/common/Format$Builder;

    .line 754
    iget v3, v14, Landroidx/media3/extractor/mp4/Track;->type:I
    ...
    .line 756
    iget v9, v0, Landroidx/media3/extractor/mp4/Mp4Extractor;->flags:I
    ...
    .line 760
    :cond_c
    iget-boolean v9, v0, Landroidx/media3/extractor/mp4/Mp4Extractor;->readingAuxiliaryTracks:Z
    ...
    invoke-virtual {v4, v9}, Landroidx/media3/common/Format$Builder;->setAuxiliaryTrackType(I)Landroidx/media3/common/Format$Builder;

    .line 764
    :cond_d
    invoke-virtual {v4, v3}, Landroidx/media3/common/Format$Builder;->setRoleFlags(I)Landroidx/media3/common/Format$Builder;

    .line 767
    :cond_e
    iget v3, v14, Landroidx/media3/extractor/mp4/Track;->type:I

    invoke-static {v3, v15, v4}, Landroidx/media3/extractor/mp4/MetadataUtil;->setFormatGaplessInfo(ILandroidx/media3/extractor/GaplessInfoHolder;Landroidx/media3/common/Format$Builder;)V

    .line 768
    iget v3, v14, Landroidx/media3/extractor/mp4/Track;->type:I

    iget-object v9, v14, Landroidx/media3/extractor/mp4/Track;->format:Landroidx/media3/common/Format;
    ...
    .line 768
    invoke-static {v3, v11, v4, v9, v8}, Landroidx/media3/extractor/mp4/MetadataUtil;->setFormatMetadata(ILandroidx/media3/common/Metadata;Landroidx/media3/common/Format$Builder;Landroidx/media3/common/Metadata;[Landroidx/media3/common/Metadata;)V

    .line 776
    invoke-virtual {v4, v2}, Landroidx/media3/common/Format$Builder;->setContainerMimeType(Ljava/lang/String;)Landroidx/media3/common/Format$Builder;

    .line 777
    iget-object v3, v5, Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4Track;->trackOutput:Landroidx/media3/extractor/TrackOutput;
