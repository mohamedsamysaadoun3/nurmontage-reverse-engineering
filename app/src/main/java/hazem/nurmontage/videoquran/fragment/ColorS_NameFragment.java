...
public class ColorS_NameFragment extends Fragment {
    ...
    private void setupPresetButtons(View view) {
        ...
        for (final int color2 = 0; color2 < 4; color2++) {
            textViewArr[color2].setOnClickListener(new View.OnClickListener() { // from class: hazem.nurmontage.videoquran.fragment.ColorS_NameFragment$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    ColorS_NameFragment.this.m642x3e82bbb3(textViewArr, color2, ayaTextPresetArr, view2);
                }
            });
        }
