...
public class EntityTrslTimeline extends Entity {
    ...
    public EntityTrslTimeline(TranslationQuranEntity translationQuranEntity, float floatValue, float xPosition, float xPosition22, float xPosition22, float floatValue5) {
        super(floatValue5);
        this.f413h = xPosition22;
