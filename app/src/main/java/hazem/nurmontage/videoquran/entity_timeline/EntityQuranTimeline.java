...
public class EntityQuranTimeline extends Entity {
    ...
    public EntityQuranTimeline(QuranEntity quranEntity, float floatValue, float xPosition, float xPosition22, float xPosition22, float floatValue5) {
        super(floatValue5);
        this.f412h = xPosition22;
